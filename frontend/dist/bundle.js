...
plot(emaValue, title="EMA Line", color=color.from_hex("${Be==="ema50"?ye:we}"), linewidth=2)`,l=`/**
...
`;var Ut=document.createElement("style");Ut.textContent=Dt;document.head.appendChild(Ut);var Aa=Ta(document.getElementById("root"));Aa.render(La(ct));
