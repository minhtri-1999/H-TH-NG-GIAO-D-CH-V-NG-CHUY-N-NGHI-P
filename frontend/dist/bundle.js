import{createRoot as Sa}from"https://esm.sh/react-dom@18.2.0/client";import{createElement as Na}from"https://esm.sh/react@18.2.0";import wa,{useState as c,useEffect as B,useRef as R,useMemo as C}from"https://esm.sh/react@18.2.0";import{Fragment as Le,jsx as e,jsxs as a}from"https://esm.sh/react@18.2.0/jsx-runtime";function ka({timeframe:f}){let Z=R(null);return B(()=>{if(!Z.current)return;Z.current.innerHTML="";let N="60";f==="1"?N="1":f==="5"?N="5":f==="15"?N="15":f==="60"?N="60":f==="1D"?N="D":f==="1W"?N="W":f==="1M"&&(N="M");let V=document.createElement("script");V.src="https://s3.tradingview.com/external-embedding/embed-widget-advanced-chart.js",V.type="text/javascript",V.async=!0,V.innerHTML=JSON.stringify({autosize:!0,symbol:"FOREXCOM:XAUUSD",interval:N,timezone:"Asia/Ho_Chi_Minh",theme:"dark",style:"1",locale:"vi",enable_publishing:!1,allow_symbol_change:!0,calendar:!0,hide_side_toolbar:!1,studies:[{id:"MAExp@tv-basicstudies",inputs:{length:50}},{id:"MAExp@tv-basicstudies",inputs:{length:200}}],support_host:"https://www.tradingview.com"}),Z.current.appendChild(V)},[f]),e("div",{className:"tradingview-widget-container",ref:Z,style:{height:"100%",width:"100%"},children:e("div",{className:"tradingview-widget-container__widget",style:{height:"100%",width:"100%"}})})}function dt(){let[f,Z]=c("5"),[N,V]=c("tradingview"),[n,pt]=c(null),[Pt,ct]=c(!0),[gt,mt]=c(null),[D,Ae]=c("general"),[xt,ut]=c([]),[Ce,Me]=c(!1),[J,Ut]=c("ALL"),[oe,Gt]=c("TODAY"),X=C(()=>{let t=[...xt].sort((l,s)=>s.closeTime-l.closeTime),r=new Date().toLocaleDateString("vi-VN",{timeZone:"Asia/Ho_Chi_Minh",day:"2-digit",month:"2-digit",year:"numeric"}),i=new Date(Date.now()-864e5).toLocaleDateString("vi-VN",{timeZone:"Asia/Ho_Chi_Minh",day:"2-digit",month:"2-digit",year:"numeric"});return oe==="TODAY"?t=t.filter(l=>new Date(l.closeTime).toLocaleDateString("vi-VN",{timeZone:"Asia/Ho_Chi_Minh",day:"2-digit",month:"2-digit",year:"numeric"})===r):oe==="YESTERDAY"&&(t=t.filter(l=>new Date(l.closeTime).toLocaleDateString("vi-VN",{timeZone:"Asia/Ho_Chi_Minh",day:"2-digit",month:"2-digit",year:"numeric"})===i)),J==="ALL"?t:t.filter(l=>l.timeframe.toUpperCase()===J.toUpperCase())},[xt,J,oe]),ne=C(()=>{if(X.length===0)return{winRate:0,netPips:0,totalProfit:0,total:0};let t=X.length,r=X.filter(s=>s.status==="TP1"||s.status==="TP2").length,o=Math.round(r/t*100),i=Number(X.reduce((s,d)=>s+d.pips,0).toFixed(1)),l=Number(X.reduce((s,d)=>s+d.profitUsd,0).toFixed(2));return{winRate:o,netPips:i,totalProfit:l,total:t}},[X]),bt=async(t=!1)=>{t&&Me(!0);try{let r=await fetch("/api/backtest/history");if(r.ok){let o=await r.json();o.success&&o.trades&&ut(o.trades)}}catch(r){console.error("Error fetching backtest history:",r)}finally{t&&Me(!1)}},Wt=async()=>{Me(!0);try{let t=await fetch("/api/backtest/reset",{method:"POST"});if(t.ok){let r=await t.json();r.success&&r.trades&&ut(r.trades)}else alert("L\u1ED7i khi ch\u1EA1y l\u1EA1i backtest t\u1EEB d\u1EEF li\u1EC7u n\u1EBFn.")}catch(t){alert("L\u1ED7i h\u1EC7 th\u1ED1ng: "+t.message)}finally{Me(!1)}},[K,ie]=c(null),[Ft,$t]=c(!0),[Xe,Q]=c("login"),[F,Ke]=c(""),[ee,je]=c(""),[Ie,Ee]=c(""),[ht,k]=c(null),[ft,L]=c(null),[se,ze]=c(0),[le,de]=c(!1),[_e,j]=c(""),[pe,Yt]=c(!0),[ce,Vt]=c(!0),[ue,Xt]=c(50),[be,Kt]=c(200),[he,jt]=c("close"),[fe,_t]=c("close"),[ve,qt]=c("#FFD700"),[ye,Zt]=c("#FF1744"),[te,we]=c(null),[He,Be]=c(null),[ke,Re]=c("pine"),[qe,Ze]=c(50),[Je,Qe]=c("close"),[De,Oe]=c("#FFD700");B(()=>{te==="ema50"?(Ze(ue),Qe(he),Oe(ve)):te==="ema200"&&(Ze(be),Qe(fe),Oe(ye))},[te]);let Jt=()=>{te==="ema50"?(Xt(qe),jt(Je),qt(De)):te==="ema200"&&(Kt(qe),_t(Je),Zt(De)),we(null)},Qt=async()=>{try{let t=await fetch("/api/auth/me");if(t.ok){let r=await t.json();r.authenticated&&r.email?ie({email:r.email}):ie(null)}else ie(null)}catch{ie(null)}finally{$t(!1)}};B(()=>{Qt()},[]),B(()=>{if(K&&(D==="ai"||D==="backtest")){bt(!0);let t=setInterval(()=>{bt(!1)},5e3);return()=>clearInterval(t)}},[D,K]),B(()=>{if(se<=0)return;let t=setInterval(()=>{ze(r=>r-1)},1e3);return()=>clearInterval(t)},[se]);let ea=async t=>{if(t.preventDefault(),!F||!ee){k("Vui l\xF2ng \u0111i\u1EC1n \u0111\u1EA7y \u0111\u1EE7 email v\xE0 m\u1EADt kh\u1EA9u.");return}de(!0),k(null),L(null);try{let r=await fetch("/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:F,password:ee})}),o=await r.json();if(!r.ok){r.status===403&&o.needsVerification?(Q("otp"),ze(300),o.isSimulator&&o.otp?(j(o.otp),L(`\u26A0\uFE0F [CH\u1EBE \u0110\u1ED8 TH\u1EEC NGHI\u1EC6M]: Ch\u01B0a c\u1EA5u h\xECnh Email API. M\xE3 OTP c\u1EE7a b\u1EA1n l\xE0: ${o.otp}`)):(j(""),L(o.error||"T\xE0i kho\u1EA3n ch\u01B0a k\xEDch ho\u1EA1t. M\u1ED9t m\xE3 OTP m\u1EDBi \u0111\xE3 \u0111\u01B0\u1EE3c g\u1EEDi v\u1EC1 email."))):k(o.error||"\u0110\u0103ng nh\u1EADp th\u1EA5t b\u1EA1i.");return}o.success&&(ie({email:o.user.email}),L("\u0110\u0103ng nh\u1EADp th\xE0nh c\xF4ng!"))}catch(r){k("L\u1ED7i k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7: "+r.message)}finally{de(!1)}},ta=async t=>{if(t.preventDefault(),!F||!ee){k("Vui l\xF2ng \u0111i\u1EC1n \u0111\u1EA7y \u0111\u1EE7 email v\xE0 m\u1EADt kh\u1EA9u.");return}if(ee.length<6){k("M\u1EADt kh\u1EA9u ph\u1EA3i ch\u1EE9a \xEDt nh\u1EA5t 6 k\xFD t\u1EF1.");return}de(!0),k(null),L(null);try{let r=await fetch("/api/auth/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:F,password:ee})}),o=await r.json();if(!r.ok){k(o.error||"\u0110\u0103ng k\xFD th\u1EA5t b\u1EA1i.");return}o.success&&(Q("otp"),ze(300),o.isSimulator&&o.otp?(j(o.otp),L(`\u26A0\uFE0F [CH\u1EBE \u0110\u1ED8 TH\u1EEC NGHI\u1EC6M]: Ch\u01B0a c\u1EA5u h\xECnh Email API. M\xE3 OTP c\u1EE7a b\u1EA1n l\xE0: ${o.otp}`)):(j(""),L(o.message||"\u0110\u0103ng k\xFD th\xE0nh c\xF4ng! Vui l\xF2ng nh\u1EADp m\xE3 OTP g\u1EEDi t\u1EDBi email.")))}catch(r){k("L\u1ED7i k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7: "+r.message)}finally{de(!1)}},aa=async t=>{if(t.preventDefault(),!Ie){k("Vui l\xF2ng nh\u1EADp m\xE3 OTP.");return}de(!0),k(null),L(null);try{let r=await fetch("/api/auth/verify-otp",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:F,otp:Ie})}),o=await r.json();if(!r.ok){k(o.error||"X\xE1c th\u1EF1c OTP th\u1EA5t b\u1EA1i.");return}o.success&&(Q("login"),Ee(""),j(""),L("K\xEDch ho\u1EA1t t\xE0i kho\u1EA3n th\xE0nh c\xF4ng! B\xE2y gi\u1EDD b\u1EA1n c\xF3 th\u1EC3 \u0111\u0103ng nh\u1EADp."))}catch(r){k("L\u1ED7i k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7: "+r.message)}finally{de(!1)}},ra=async()=>{if(!(se>0)){k(null),L(null);try{let t=await fetch("/api/auth/resend-otp",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:F})}),r=await t.json();if(!t.ok){k(r.error||"G\u1EEDi l\u1EA1i OTP th\u1EA5t b\u1EA1i.");return}r.success&&(ze(300),r.isSimulator&&r.otp?(j(r.otp),L(`\u26A0\uFE0F [CH\u1EBE \u0110\u1ED8 TH\u1EEC NGHI\u1EC6M]: M\xE3 OTP c\u1EE7a b\u1EA1n l\xE0: ${r.otp}`)):(j(""),L(r.message||"M\xE3 OTP m\u1EDBi \u0111\xE3 \u0111\u01B0\u1EE3c g\u1EEDi v\u1EC1 email c\u1EE7a b\u1EA1n.")))}catch(t){k("L\u1ED7i k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7: "+t.message)}}},La=async()=>{try{await fetch("/api/auth/logout",{method:"POST"}),ie(null),pt(null),Pe(2350),Ue(0),Q("login"),Ke(""),je(""),Ee(""),k(null),L(null)}catch(t){console.error("Logout error",t)}},[w,Pe]=c(2350),[et,Ue]=c(0),[Ge,Aa]=c(!0),[Ca,vt]=c([]),[Ma,yt]=c({bids:[],asks:[]}),[Ia,Ea]=c("book"),[oa,na]=c(""),[wt,ia]=c(""),[$,sa]=c(!1),[Se,za]=c(100),[We,Ha]=c(5),[tt,Ba]=c("micro"),[Fe,Ra]=c("percent"),[$e,Da]=c(5),[at,Oa]=c(0),[Pa,la]=c([{id:"h1",time:"05:40:12",type:"SELL",entry:4512.4,stopLoss:4516.8,tp1:4504,status:"HIT TP1 \u{1F7E2} (+84 pips)"},{id:"h2",time:"03:15:45",type:"BUY",entry:4495.2,stopLoss:4489.5,tp1:4503.5,status:"HIT TP1 \u{1F7E2} (+83 pips)"},{id:"h3",time:"01:04:10",type:"SELL",entry:4520.1,stopLoss:4525,tp1:4511,status:"HIT SL \u{1F534} (-49 pips)"},{id:"h4",time:"23:12:05",type:"BUY",entry:4488.5,stopLoss:4482,tp1:4498,status:"HIT TP1 \u{1F7E2} (+95 pips)"}]),E=R({}),[Ua,kt]=c(""),[da,pa]=c(!0),[_,Ne]=c(80),[ge,me]=c(0),St=ge===0,[rt,ot]=c(1),g=C(()=>{if(!n?.chart?.timestamp)return[];let t=n.chart.timestamp.length,r=[];for(let o=0;o<t;o++)r.push({time:n.chart.timestamp[o],open:n.chart.open[o]??0,high:n.chart.high[o]??0,low:n.chart.low[o]??0,close:n.chart.close[o]??0,volume:n.chart.volume[o]??0});if(r.length>0){let o=r[r.length-1];o.close=w,w>o.high&&(o.high=w),w<o.low&&(o.low=w)}return r},[n,w]),Y=C(()=>{if(g.length===0)return[];let t=g.length,r=Math.max(10,Math.min(_,t)),o=Math.max(0,Math.min(ge,t-r)),i=t-o,l=Math.max(0,i-r);return g.slice(l,i)},[g,_,ge]),z=C(()=>{if(g.length===0)return 0;let t=g.length,r=Math.max(10,Math.min(_,t)),o=Math.max(0,Math.min(ge,t-r)),i=t-o;return Math.max(0,i-r)},[g,_,ge]),ca=C(()=>{if(g.length===0)return[];let t=[],o=2/((Number(ue)||50)+1),i=he||"close",l=g[0][i]||g[0].close;t.push(l);for(let s=1;s<g.length;s++)l=(g[s][i]||g[s].close)*o+l*(1-o),t.push(l);return t},[g,ue,he]),ga=C(()=>{if(g.length===0)return[];let t=[],o=2/((Number(be)||200)+1),i=fe||"close",l=g[0][i]||g[0].close;t.push(l);for(let s=1;s<g.length;s++)l=(g[s][i]||g[s].close)*o+l*(1-o),t.push(l);return t},[g,be,fe]),Nt=C(()=>{if(g.length<10)return null;let r=(n?.advancedAnalysis?.swings||[]).filter(d=>d.type==="HIGH").sort((d,x)=>d.index-x.index);if(r.length>=2){let d=r[0];for(let u of r)u.price>d.price&&(d=u);let x=r.find(u=>u.index>d.index&&u.price<d.price);if(x||(x=r[r.length-1]),d&&x&&d.index!==x.index)return{i1:d.index,price1:d.price,i2:x.index,price2:x.price,source:"SMC Swings"}}let o=0,i=g[0].high;for(let d=1;d<Math.floor(g.length*.7);d++)g[d].high>i&&(i=g[d].high,o=d);let l=o+5,s=0;if(l<g.length){s=g[l].high;for(let d=l;d<g.length;d++)g[d].high>s&&g[d].high<i&&(s=g[d].high,l=d)}return o!==l&&l<g.length?{i1:o,price1:i,i2:l,price2:s,source:"PA Scan"}:{i1:Math.max(0,g.length-80),price1:4568,i2:Math.max(0,g.length-20),price2:4516,source:"SMC Profile"}},[g,n]),p=C(()=>{if(Y.length<5)return null;let t=1400,r=520,o=4,i=68,l=12,s=34,d=t-o-i,x=r-l-s,u=Y.map(A=>A.high),h=Y.map(A=>A.low),v=Math.max(...u),b=Math.min(...h),y=v-b||1,S=(v+b)/2,M=y*1.1*rt||1;v=S+M/2,b=S-M/2;let T=v-b,H=Y.length,O=d/H,G=Math.max(1,O*.75),P=A=>o+(A+.5)*O,ae=A=>l+(1-(A-b)/T)*x,I=Math.max(1,Math.floor(H/8)),re=[];for(let A=0;A<H;A+=I){let Ve=Y[A].time*1e3,Rt=new Date(Ve),lt;["1D","1W","1M"].includes(f)?lt=Rt.toLocaleDateString("vi-VN",{day:"2-digit",month:"2-digit"}):lt=Rt.toLocaleTimeString("vi-VN",{hour:"2-digit",minute:"2-digit"}),re.push({x:P(A),label:lt})}let W=8,Te=[];for(let A=0;A<=W;A++){let Ve=b+T*A/W;Te.push({y:ae(Ve),price:Ve})}return{width:t,height:r,paddingLeft:o,paddingRight:i,paddingBottom:s,usableWidth:d,usableHeight:x,maxPrice:v,minPrice:b,paddedRange:T,candleSlotW:O,bodyWidth:G,getX:P,getY:ae,timeLabels:re,priceLabels:Te}},[Y,f,rt]),U=R(2350),Tt=R(null),Lt=R(0),Ye=R(!1),At=R(0),Ct=R(0),xe=R(null),nt=R(!1),Mt=R(0),It=R(1),ma={1:60,5:300,15:900,60:3600,"1D":86400,"1W":604800,"1M":2592e3};B(()=>{Tt.current=n},[n]);let q=(t="info")=>{try{let r=new(window.AudioContext||window.webkitAudioContext),o=r.createOscillator(),i=r.createGain();o.connect(i),i.connect(r.destination),t==="buy"?(o.frequency.setValueAtTime(587.33,r.currentTime),i.gain.setValueAtTime(.12,r.currentTime),o.start(),o.frequency.setValueAtTime(698.46,r.currentTime+.12),i.gain.setValueAtTime(.1,r.currentTime+.12),i.gain.exponentialRampToValueAtTime(.001,r.currentTime+.35),o.stop(r.currentTime+.4)):t==="sell"?(o.frequency.setValueAtTime(523.25,r.currentTime),i.gain.setValueAtTime(.12,r.currentTime),o.start(),o.frequency.setValueAtTime(392,r.currentTime+.12),i.gain.setValueAtTime(.1,r.currentTime+.12),i.gain.exponentialRampToValueAtTime(.001,r.currentTime+.35),o.stop(r.currentTime+.4)):(o.frequency.setValueAtTime(440,r.currentTime),i.gain.setValueAtTime(.08,r.currentTime),i.gain.exponentialRampToValueAtTime(.001,r.currentTime+.15),o.start(),o.stop(r.currentTime+.2))}catch(r){console.warn("Audio Context failed",r)}};B(()=>{if(!$||!n?.advancedAnalysis)return;let t=n.advancedAnalysis,r=Date.now(),o=t.fvgs.find(d=>!d.mitigated&&d.type==="BULLISH");if(o&&w<=o.top&&w>=o.bottom){let d=`fvg_bullish_${o.index}`;(!E.current[d]||r-E.current[d]>3e4)&&(E.current[d]=r,q("buy"))}let i=t.fvgs.find(d=>!d.mitigated&&d.type==="BEARISH");if(i&&w>=i.bottom&&w<=i.top){let d=`fvg_bearish_${i.index}`;(!E.current[d]||r-E.current[d]>3e4)&&(E.current[d]=r,q("sell"))}let l=t.orderBlocks.find(d=>!d.mitigated&&d.type==="BULLISH");if(l&&w>=l.low&&w<=l.high){let d=`ob_bullish_${l.index}`;(!E.current[d]||r-E.current[d]>3e4)&&(E.current[d]=r,q("buy"))}let s=t.orderBlocks.find(d=>!d.mitigated&&d.type==="BEARISH");if(s&&w>=s.low&&w<=s.high){let d=`ob_bearish_${s.index}`;(!E.current[d]||r-E.current[d]>3e4)&&(E.current[d]=r,q("sell"))}},[w,$,n]),B(()=>{let t=setInterval(()=>{let r=new Date;na(r.toLocaleTimeString("en-GB")+" UTC");let o=ma[f]||86400,i=Math.floor(r.getTime()/1e3),l=o-i%o;if(l>=3600){let s=Math.floor(l/3600),d=Math.floor(l%3600/60),x=l%60;kt(`${s}:${String(d).padStart(2,"0")}:${String(x).padStart(2,"0")}`)}else{let s=Math.floor(l/60),d=l%60;kt(`${String(s).padStart(2,"0")}:${String(d).padStart(2,"0")}`)}},1e3);return()=>clearInterval(t)},[f]),B(()=>{let t=r=>{document.activeElement?.tagName==="INPUT"||document.activeElement?.tagName==="TEXTAREA"||(r.key==="+"||r.key==="="?(r.preventDefault(),zt()):r.key==="-"?(r.preventDefault(),Ht()):r.key==="ArrowLeft"?(r.preventDefault(),me(o=>Math.min(g.length-_,o+5))):r.key==="ArrowRight"?(r.preventDefault(),me(o=>Math.max(0,o-5))):(r.key==="r"||r.key==="R")&&(r.preventDefault(),Ne(80),me(0),ot(1)))};return window.addEventListener("keydown",t),()=>window.removeEventListener("keydown",t)},[g.length,_]);let it=async(t=!1)=>{if(K){t||ct(!0),t||mt(null);try{let r=await fetch(`/api/signals/XAUUSD?tf=${f}`);if(!r.ok)throw new Error("Kh\xF4ng th\u1EC3 k\u1EBFt n\u1ED1i \u0111\u1EBFn server API Gold");let o=await r.json();pt(o),ia(new Date().toLocaleTimeString("vi-VN")),o.lastPrice>0&&(!Tt.current||Math.abs(U.current-o.lastPrice)>100?U.current=o.lastPrice:U.current=U.current*.7+o.lastPrice*.3,Pe(Math.round(U.current*100)/100)),o.signals&&o.signals.type!=="NEUTRAL"&&la(i=>{let l=i[0];if(!l||l.type!==o.signals.type||Math.abs(l.entry-o.signals.suggestion.entry)>.5){let d=new Date().toLocaleTimeString("vi-VN");return[{id:Math.random().toString(),time:d,type:o.signals.type,entry:o.signals.suggestion.entry,stopLoss:o.signals.suggestion.stopLoss,tp1:o.signals.suggestion.takeProfit1,status:"Active \u{1F7E1}"},...i.slice(0,14)]}return i}),t||(xa(o.lastPrice),ua(o.lastPrice)),Ue(o.priceChange)}catch(r){t||mt(r.message)}finally{t||ct(!1)}}},Ga=async()=>{try{let t=await fetch("/api/price/XAUUSD");if(!t.ok)return;let r=await t.json();r.price&&r.price>0&&(U.current=U.current*.7+r.price*.3,Pe(Math.round(U.current*100)/100),Ue(r.change))}catch{}};B(()=>{if(!K)return;it(!1);let t=setInterval(()=>{Ge&&K&&it(!0)},500);return()=>{clearInterval(t)}},[f,Ge,K]);let xa=t=>{let r=.35+Math.random()*.15,o=[],i=[];for(let l=1;l<=10;l++)i.push({price:t+r/2+(l-1)*.15,size:Math.round((Math.random()*80+5)*10)/10}),o.push({price:t-r/2-(l-1)*.15,size:Math.round((Math.random()*80+5)*10)/10});yt({bids:o,asks:i.reverse()})},ua=t=>{let r=[],o=new Date;for(let i=0;i<20;i++){let l=i*280,s=new Date(o.getTime()-l),d=Math.random()>.48;r.push({id:`init-${i}`,time:s.toLocaleTimeString()+"."+String(s.getMilliseconds()).padStart(3,"0"),type:d?"BUY":"SELL",price:t+(Math.random()-.5)*.4,size:(Math.random()*4.5+.1).toFixed(1)+" Lot"})}vt(r)};B(()=>{if(!Ge||!n||!K)return;let t=setInterval(()=>{let r=U.current,o=n.lastPrice,i=(o-r)*.05,l=(Math.random()-.5)*.25,s=Math.round((r+i+l)*100)/100;U.current=s,Pe(s);let d=o/(1+n.priceChange/100),x=(s-d)/d*100;if(Ue(x),Lt.current++,Lt.current%3===0){let u=.35+Math.random()*.1;yt(h=>{let v=h.asks.map((y,S)=>{let M=10-S;return{price:Math.round((s+u/2+(M-1)*.15)*100)/100,size:Math.max(1,Math.round((y.size+(Math.random()-.5)*5)*10)/10)}});return{bids:h.bids.map((y,S)=>({price:Math.round((s-u/2-S*.15)*100)/100,size:Math.max(1,Math.round((y.size+(Math.random()-.5)*5)*10)/10)})),asks:v}})}if(Math.random()<.35){let u=Math.random()>.47,h=new Date,v=u?s+Math.random()*.05:s-Math.random()*.05,b={id:Math.random().toString(),time:h.toLocaleTimeString()+"."+String(h.getMilliseconds()).padStart(3,"0"),type:u?"BUY":"SELL",price:Math.round(v*100)/100,size:(Math.random()*5+.1).toFixed(1)+" Lot"};vt(y=>[b,...y.slice(0,24)])}},85);return()=>clearInterval(t)},[Ge,n]);let ba=t=>{if(!xe.current||!p)return;let r=xe.current.getBoundingClientRect();(t.clientX-r.left)/r.width*p.width>p.width-p.paddingRight?(nt.current=!0,Mt.current=t.clientY,It.current=rt):(Ye.current=!0,At.current=t.clientX,Ct.current=ge)},ha=t=>{if(nt.current){let o=1+(t.clientY-Mt.current)*.005;ot(Math.max(.05,Math.min(10,It.current*o)))}else if(Ye.current&&xe.current&&p){let r=t.clientX-At.current,i=(xe.current.clientWidth||860)/Math.max(_,1),l=Math.round(-r/i),s=Math.max(0,Math.min(g.length-_,Ct.current+l));me(s)}},Et=()=>{Ye.current=!1,nt.current=!1},fa=()=>{Ne(80),me(0),ot(1)};B(()=>{let t=xe.current;if(!t)return;let r=o=>{o.preventDefault();let i=o.deltaY>0?1:-1;Ne(l=>Math.max(10,Math.min(500,l+i*Math.ceil(l*.08))))};return t.addEventListener("wheel",r,{passive:!1}),()=>{t.removeEventListener("wheel",r)}},[p]);let va=()=>me(0),zt=()=>Ne(t=>Math.max(10,Math.round(t*.7))),Ht=()=>Ne(t=>Math.min(500,Math.round(t*1.4))),m=C(()=>{if(!n)return null;let t=n.signals,r=n.tradingViewAnalysis,o=t.type==="BUY"?t.strength:t.type==="SELL"?-t.strength:0,i=r?r.recommendAll*100:0,l=Math.round((o+i)/2),s="NEUTRAL";l>=40?s="STRONG_BUY":l>=15?s="BUY":l<=-40?s="STRONG_SELL":l<=-15&&(s="SELL");let d=50,x=0,u=0,h=0,v=0,b=t.indicators.atr||r?.atr||3.2,y=t.indicators.rsi||r?.rsi||50,S=r?r.macd-r.macdSignal:0;if(r){let W=w>r.ema50,Te=r.ema10>r.sma20;s.includes("BUY")?(W&&(x+=6),Te&&(x+=6)):s.includes("SELL")&&(W||(x+=6),Te||(x+=6))}s.includes("BUY")?(y>=50&&y<=65&&(u+=6),S>0&&(u+=6)):s.includes("SELL")&&(y>=35&&y<=50&&(u+=6),S<0&&(u+=6)),r&&r.adx>25&&(h+=6),s.includes("BUY")&&y<30&&(v+=8),s.includes("SELL")&&y>70&&(v+=8);let M=Math.min(94,Math.max(35,Math.round(d+Math.abs(l)*.3+x+u+h+v))),T=0,H=0,O="",G=0,P=0,ae=0,I=0,re=n.chart?.close&&n.chart.close.length>0?n.chart.close[n.chart.close.length-1]:w;if(t&&t.suggestion&&t.suggestion.position!=="NEUTRAL"){let W=t.suggestion;G=W.stopLoss,P=W.takeProfit1,ae=W.takeProfit2,I=W.entry,T=Math.round((I-.15*b)*100)/100,H=Math.round((I+.15*b)*100)/100,O=`$${I.toFixed(2)}`,t.strength>0&&(M=Math.min(94,Math.max(78,80+Math.round(t.strength*.15))))}else T=Math.round((s.includes("BUY")?re-.25*b:re)*100)/100,H=Math.round((s.includes("BUY")?re:re+.25*b)*100)/100,O=`$${T.toFixed(2)} - $${H.toFixed(2)}`,I=(T+H)/2,s.includes("BUY")?(G=Math.round((I-1.5*b)*100)/100,P=Math.round((I+1.5*b)*100)/100,ae=Math.round((I+3*b)*100)/100):s.includes("SELL")&&(G=Math.round((I+1.5*b)*100)/100,P=Math.round((I-1.5*b)*100)/100,ae=Math.round((I-3*b)*100)/100);return{type:s,confluenceScore:l,winProbability:M,entryText:O,entryMid:I,sl:G,tp1:P,tp2:ae,atr:b,rsi:y,adx:r?.adx||20,ema10:r?.ema10||w,sma20:r?.sma20||w}},[n]),st=C(()=>at>0?at:!m||!m.sl?0:Math.abs(m.entryMid-m.sl),[at,m]),Bt=C(()=>Fe==="percent"?Se*We/100:$e,[Se,We,$e,Fe]),Wa=C(()=>Se<=0?0:Fe==="usd"?$e/Se*100:We,[Se,We,$e,Fe]),Fa=C(()=>st<=0?0:Bt/(st*(tt==="standard"?100:tt==="mini"?10:1)),[Bt,st,tt]),ya=C(()=>{if(!m)return{};let t=m.type,r=m.winProbability,o="var(--yellow)";return t.includes("BUY")?o="var(--green)":t.includes("SELL")&&(o="var(--red)"),{background:`conic-gradient(${o} 0% ${r}%, var(--bg3) ${r}% 100%)`}},[m]);return Ft?e("div",{className:"auth-container",children:a("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"16px"},children:[e("img",{src:"/frontend/logo.png",alt:"XAU Logo",style:{width:"120px",height:"120px",borderRadius:"16px",animation:"pulse 2s infinite ease-in-out",filter:"drop-shadow(0 0 24px rgba(255, 171, 0, 0.6))",marginBottom:"8px"}}),e("div",{style:{color:"var(--gold)",fontWeight:"bold",fontSize:"16px",letterSpacing:"1px"},children:"\u0110ANG KH\u1EDEI \u0110\u1ED8NG XAU/USD GOLD TERMINAL..."}),e("div",{className:"load-bar",style:{width:"200px"},children:e("div",{className:"load-fill"})})]})}):K?a("div",{className:"root",children:[a("header",{className:"topbar",children:[e("div",{className:"topbar-left",children:a("div",{className:"brand",style:{display:"flex",alignItems:"center"},children:[e("img",{src:"/frontend/logo.png",alt:"XAU Logo",style:{width:"32px",height:"32px",borderRadius:"6px",marginRight:"8px",filter:"drop-shadow(0 0 6px rgba(255, 171, 0, 0.35))"}}),e("span",{className:"brand-name",children:"H\u1EC6 TH\u1ED0NG GIAO D\u1ECACH V\xC0NG CHUY\xCAN NGHI\u1EC6P XAU/USD"}),e("span",{className:"brand-badge",children:"D\u1EEE LI\u1EC6U TH\u1EDCI GIAN TH\u1EF0C MILLISECOND"})]})}),a("div",{className:"topbar-right",children:[e("span",{className:"clock",children:oa||"00:00:00 UTC"}),e("button",{className:`tf-btn ${$?"active":""}`,style:{borderColor:$?"var(--green)":"rgba(255,255,255,0.05)",background:$?"rgba(0, 230, 118, 0.12)":"var(--bg3)",color:$?"var(--green)":"var(--text)",marginRight:"10px",fontWeight:$?"600":"normal",cursor:"pointer"},onClick:()=>sa(!$),children:$?"\u{1F514} B\xE1o \xC2m: B\u1EACT":"\u{1F515} B\xE1o \xC2m: T\u1EAET"}),e("button",{className:"tf-btn",style:{borderColor:"rgba(255,255,255,0.05)",background:"var(--bg3)",color:"var(--text)"},onClick:it,children:"\u{1F504} T\u1EA3i L\u1EA1i"})]})]}),a("div",{className:"layout",children:[a("aside",{className:"sidebar",children:[e("div",{className:"sb-header",children:e("div",{className:"gold-profile-card",children:e("div",{className:"g-title",children:"\u{1F7E1} V\xC0NG SPOT (XAU/USD)"})})}),a("div",{style:{padding:"16px",flex:1,display:"flex",flexDirection:"column",gap:"16px",overflowY:"auto"},children:[n&&e("div",{className:"sug-card",style:{display:"flex",justifyContent:"center",alignItems:"center",padding:"16px",background:"rgba(20, 24, 33, 0.45)",backdropFilter:"blur(8px)",border:"1px solid rgba(255, 215, 0, 0.08)",boxShadow:"0 8px 32px rgba(0, 0, 0, 0.25)"},children:e("img",{src:"/frontend/logo.png",alt:"Xtreme Algo Union Logo",style:{width:"100%",maxWidth:"220px",height:"auto",borderRadius:"12px",filter:"drop-shadow(0 0 16px rgba(255, 171, 0, 0.25))",transition:"all 0.3s ease"},onMouseOver:t=>{t.currentTarget.style.filter="drop-shadow(0 0 24px rgba(255, 171, 0, 0.5))",t.currentTarget.style.transform="scale(1.02)"},onMouseOut:t=>{t.currentTarget.style.filter="drop-shadow(0 0 16px rgba(255, 171, 0, 0.25))",t.currentTarget.style.transform="scale(1)"}})}),m&&a("div",{className:"sug-card",style:{borderTop:"3px solid var(--gold)",background:"rgba(20, 24, 33, 0.65)",backdropFilter:"blur(12px)"},children:[a("div",{className:"sug-title",style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e("span",{style:{display:"flex",alignItems:"center",gap:"6px"},children:"\u2728 CH\u1EC8 B\xC1O H\u1EE2P L\u01AFU K\u1EF8 THU\u1EACT"}),e("span",{style:{fontSize:"9px",background:"rgba(255, 171, 0, 0.15)",color:"var(--gold)",padding:"2px 6px",borderRadius:"4px",fontWeight:"bold"},children:"PRO FEED"})]}),e("div",{style:{display:"flex",alignItems:"center",gap:"16px",margin:"14px 0",background:"rgba(255,255,255,0.02)",padding:"10px",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.04)"},children:a("div",{style:{flex:1},children:[e("span",{style:{fontSize:"10px",color:"var(--text2)",textTransform:"uppercase",display:"block"},children:"Khuy\u1EBFn ngh\u1ECB h\u1EE3p l\u01B0u"}),e("span",{className:`sug-val ${m.type.includes("BUY")?"buy":m.type.includes("SELL")?"sell":""}`,style:{fontSize:"15px",fontWeight:"800",marginTop:"2px",display:"block"},children:m.type==="STRONG_BUY"?"\u{1F7E2} MUA M\u1EA0NH (STRONG BUY)":m.type==="BUY"?"\u{1F7E2} MUA V\xC0O (BUY)":m.type==="STRONG_SELL"?"\u{1F534} B\xC1N M\u1EA0NH (STRONG SELL)":m.type==="SELL"?"\u{1F534} B\xC1N RA (SELL)":"\u{1F7E1} TRUNG L\u1EACP (NEUTRAL)"})]})}),a("div",{className:"sug-grid",style:{gap:"8px"},children:[a("div",{className:"sug-item",children:[e("span",{className:"sug-label",children:"ENTRY"}),e("span",{className:"sug-val entry",style:{fontSize:"11.5px",letterSpacing:"-0.2px"},children:m.entryText})]}),a("div",{className:"sug-item",children:[e("span",{className:"sug-label",children:"\u0110i\u1EC3m C\u1EAFt l\u1ED7 (SL)"}),e("span",{className:"sug-val sl",style:{fontSize:"11.5px"},children:m.sl>0?`$${m.sl.toFixed(2)}`:"\u2014"})]}),a("div",{className:"sug-item",children:[e("span",{className:"sug-label",children:"Ch\u1ED1t l\u1EDDi 1 (TP1)"}),e("span",{className:"sug-val tp",style:{fontSize:"11.5px"},children:m.tp1>0?`$${m.tp1.toFixed(2)}`:"\u2014"})]}),a("div",{className:"sug-item",children:[e("span",{className:"sug-label",children:"Ch\u1ED1t l\u1EDDi 2 (TP2)"}),e("span",{className:"sug-val tp",style:{fontSize:"11.5px"},children:m.tp2>0?`$${m.tp2.toFixed(2)}`:"\u2014"})]}),e("div",{className:"sug-item",style:{gridColumn:"span 2"},children:a("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"8px",borderTop:"1px solid rgba(255,255,255,0.05)",paddingTop:"8px",marginTop:"4px"},children:[a("div",{children:[e("span",{className:"sug-label",style:{fontSize:"9px"},children:"T\u1EF7 l\u1EC7 r\u1EE7i ro/l\u1EE3i nhu\u1EADn:"}),e("strong",{style:{color:"#fff",display:"block",fontSize:"11px",marginTop:"2px",fontFamily:"monospace"},children:"1:1.5 \u2794 1:3.0"})]}),a("div",{children:[e("span",{className:"sug-label",style:{fontSize:"9px"},children:"H\u1EC7 s\u1ED1 bi\u1EBFn \u0111\u1ED9ng (ATR):"}),a("strong",{style:{color:"var(--gold)",display:"block",fontSize:"11px",marginTop:"2px",fontFamily:"monospace"},children:["$",m.atr.toFixed(2)]})]})]})}),a("div",{className:"sug-item",style:{gridColumn:"span 2",background:"rgba(255, 255, 255, 0.01)",padding:"8px",borderRadius:"6px",border:"1px solid rgba(255, 255, 255, 0.03)",marginTop:"4px"},children:[e("span",{className:"sug-label",style:{fontSize:"9.5px",marginBottom:"6px",display:"block"},children:"H\u1EE3p l\u01B0u \u0111a khung th\u1EDDi gian:"}),e("div",{style:{display:"grid",gridTemplateColumns:"repeat(5, 1fr)",gap:"4px",textAlign:"center"},children:[{id:"1",label:"M1"},{id:"5",label:"M5"},{id:"15",label:"M15"},{id:"60",label:"H1"},{id:"1D",label:"D1"}].map(t=>{let r=n?.multiTimeframeSignals?.[t.id]||"NEUTRAL",o="var(--text3)",i="rgba(255, 255, 255, 0.03)",l="TRUNG L\u1EACP";r.includes("BUY")?(o="var(--green)",i="rgba(0, 230, 118, 0.08)",l=r==="STRONG_BUY"?"MUA M\u1EA0NH":"MUA"):r.includes("SELL")?(o="var(--red)",i="rgba(255, 23, 68, 0.08)",l=r==="STRONG_SELL"?"B\xC1N M\u1EA0NH":"B\xC1N"):(o="var(--yellow)",i="rgba(255, 171, 0, 0.08)",l="TRUNG L\u1EACP");let s=f===t.id;return a("div",{onClick:()=>{q(),Z(t.id)},style:{background:i,border:s?"1px solid var(--gold)":"1px solid rgba(255,255,255,0.04)",borderRadius:"4px",padding:"4px 1px",cursor:"pointer",transition:"all 0.15s ease",boxShadow:s?"0 0 6px rgba(255, 171, 0, 0.12)":"none"},onMouseOver:d=>{d.currentTarget.style.transform="scale(1.03)",d.currentTarget.style.borderColor="var(--gold)"},onMouseOut:d=>{d.currentTarget.style.transform="scale(1)",d.currentTarget.style.borderColor=s?"var(--gold)":"rgba(255,255,255,0.04)"},children:[e("span",{style:{fontSize:"9px",fontWeight:"800",color:s?"var(--gold)":"#fff",display:"block"},children:t.label}),e("span",{style:{fontSize:"6.5px",color:o,display:"block",marginTop:"2px",fontWeight:"bold",whiteSpace:"nowrap"},children:l})]},t.id)})})]})]})]})]})]}),a("main",{className:"main",children:[a("div",{className:"sym-header",children:[a("div",{className:"sym-info",children:[a("div",{className:"sym-title-wrap",children:[e("span",{className:"sym-title",children:"GOLD (XAU/USD)"}),e("span",{className:"sym-subtitle",children:"V\xE0ng giao ngay / \u0110\xF4 la M\u1EF9"})]}),a("div",{className:"price-info",children:[a("span",{className:"price-current",children:["$",w.toFixed(2)]}),a("span",{className:`price-change ${et>=0?"up":"down"}`,children:[et>=0?"+":"",et.toFixed(3),"%"]})]})]}),e("div",{style:{display:"flex",gap:"4px",background:"var(--bg3)",padding:"3px",borderRadius:"6px",border:"1px solid var(--border)",marginLeft:"auto",marginRight:"6px"},children:[{id:"1",name:"M1"},{id:"5",name:"M5"},{id:"15",name:"M15"},{id:"60",name:"1H"},{id:"1D",name:"1D"}].map(t=>e("button",{onClick:()=>{q(),Z(t.id)},style:{background:f===t.id?"var(--yellow)":"transparent",border:"none",borderRadius:"4px",padding:"4px 8px",fontSize:"11px",fontWeight:"bold",color:f===t.id?"#000":"var(--text2)",cursor:"pointer",transition:"all 0.15s ease"},children:t.name},t.id))}),a("div",{style:{display:"flex",gap:"6px",alignItems:"center",marginLeft:"6px"},children:[e("button",{onClick:()=>{q(),V("tradingview")},className:`tf-btn ${N==="tradingview"?"active":""}`,style:{background:N==="tradingview"?"var(--yellow)":"var(--bg3)",borderColor:N==="tradingview"?"var(--yellow)":"rgba(255,255,255,0.05)",color:N==="tradingview"?"#000":"var(--text2)",fontWeight:"bold",cursor:"pointer",fontSize:"11px",padding:"5px 12px",borderRadius:"4px",transition:"all 0.2s ease"},children:"\u{1F4CA} BI\u1EC2U \u0110\u1ED2 TRADINGVIEW"}),e("button",{onClick:()=>{q(),V("deno")},className:`tf-btn ${N==="deno"?"active":""}`,style:{background:N==="deno"?"var(--yellow)":"var(--bg3)",borderColor:N==="deno"?"var(--yellow)":"rgba(255,255,255,0.05)",color:N==="deno"?"#000":"var(--text2)",fontWeight:"bold",cursor:"pointer",fontSize:"11px",padding:"5px 12px",borderRadius:"4px",transition:"all 0.2s ease"},children:"\u26A1 BI\u1EC2U \u0110\u1ED2 C\u1EA4U TR\xDAC SMC"})]})]}),Pt&&e("div",{className:"load-bar",children:e("div",{className:"load-fill"})}),gt&&a("div",{className:"err-msg",children:["\u26A0\uFE0F L\u1ED7i: ",gt]}),a("div",{className:"main-workspace",children:[e("div",{className:"chart-column",children:e("div",{className:"chart-wrap",style:{height:"100%",width:"100%",display:"flex",flexDirection:"column"},children:N==="tradingview"?a(Le,{children:[e(ka,{timeframe:f}),da&&a("div",{className:"tv-guide-overlay",children:[a("div",{className:"tv-guide-header",children:[a("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:[e("span",{className:"tv-guide-icon",children:"\u{1F4A1}"}),e("span",{className:"tv-guide-title",children:"M\u1EB9o: B\u1EADt \u0110\u1EBFm Ng\u01B0\u1EE3c \u0110\xF3ng N\u1EBFn Tr\xEAn Chart"})]}),e("button",{className:"tv-guide-close",onClick:()=>pa(!1),children:"\xD7"})]}),a("div",{className:"tv-guide-body",children:["\u0110\u1EC3 ch\u1EA1y \u0111\u1EBFm ng\u01B0\u1EE3c n\u1EBFn th\u1EDDi gian th\u1EF1c \u1EDF d\u01B0\u1EDBi t\u1EF7 gi\xE1 ",a("strong",{style:{color:"var(--green)"},children:["$",w.toFixed(2)]}),":",a("ol",{className:"tv-guide-steps",children:[a("li",{children:[e("strong",{children:"Click chu\u1ED9t ph\u1EA3i"})," v\xE0o v\xF9ng c\u1ED9t t\u1EF7 gi\xE1 b\xEAn ph\u1EA3i bi\u1EC3u \u0111\u1ED3."]}),a("li",{children:["Ch\u1ECDn d\xF2ng ",e("strong",{style:{color:"var(--gold)"},children:'"\u0110\u1EBFm ng\u01B0\u1EE3c t\u1EDBi khi \u0111\xF3ng n\u1EBFn" (Countdown to bar close)'}),"."]})]}),e("div",{className:"tv-guide-footer",children:"\u2713 T\u1EF1 \u0111\u1ED9ng l\u01B0u v\xE0 ho\u1EA1t \u0111\u1ED9ng v\u0129nh vi\u1EC5n tr\xEAn tr\xECnh duy\u1EC7t c\u1EE7a b\u1EA1n!"})]})]})]}):a("div",{style:{position:"relative",width:"100%",height:"100%",flex:1,display:"flex",flexDirection:"column",background:"#131722",overflow:"hidden"},children:[p?a("svg",{className:"chart-svg",ref:xe,width:"100%",height:"100%",viewBox:`0 0 ${p.width} ${p.height}`,preserveAspectRatio:"none",onMouseDown:ba,onMouseMove:ha,onMouseUp:Et,onMouseLeave:Et,onDoubleClick:fa,style:{cursor:Ye.current?"grabbing":"crosshair",userSelect:"none"},children:[e("defs",{children:a("filter",{id:"glow",x:"-20%",y:"-20%",width:"140%",height:"140%",children:[e("feGaussianBlur",{stdDeviation:"3",result:"blur"}),a("feMerge",{children:[e("feMergeNode",{in:"blur"}),e("feMergeNode",{in:"SourceGraphic"})]})]})}),p.priceLabels.map((t,r)=>a("g",{children:[e("line",{x1:p.paddingLeft,y1:t.y,x2:p.width-p.paddingRight,y2:t.y,stroke:"rgba(255, 255, 255, 0.03)",strokeWidth:"1"}),a("text",{x:p.width-p.paddingRight+8,y:t.y+4,fill:"var(--text3)",fontSize:"10px",fontFamily:"monospace",children:["$",t.price.toFixed(2)]})]},`grid-y-${r}`)),p.timeLabels.map((t,r)=>a("g",{children:[e("line",{x1:t.x,y1:0,x2:t.x,y2:p.height-p.paddingBottom,stroke:"rgba(255, 255, 255, 0.02)",strokeWidth:"1"}),e("text",{x:t.x-18,y:p.height-12,fill:"var(--text3)",fontSize:"9.5px",fontFamily:"monospace",children:t.label})]},`grid-x-${r}`)),m&&(()=>{let t=p.getY(m.entryMid),r=p.getY(m.sl),o=p.getY(m.tp2),i=p.paddingLeft,l=p.width-p.paddingRight;return a(Le,{children:[e("rect",{x:i,y:Math.min(t,r),width:l-i,height:Math.abs(t-r),fill:"rgba(255, 23, 68, 0.06)",stroke:"rgba(255, 23, 68, 0.15)",strokeWidth:"1",strokeDasharray:"2,2"}),e("rect",{x:i,y:Math.min(t,o),width:l-i,height:Math.abs(t-o),fill:"rgba(0, 230, 118, 0.06)",stroke:"rgba(0, 230, 118, 0.15)",strokeWidth:"1",strokeDasharray:"2,2"})]})})(),n?.advancedAnalysis&&(()=>{let t=n.advancedAnalysis,r=p.paddingLeft,o=p.width-p.paddingRight;return a("g",{id:"smc-dynamic-structures",children:[t.orderBlocks?.map((i,l)=>{let s=i.index,d=i.mitigated?Math.min(g.length-1,i.index+10):g.length-1,x=p.getX(s-z),u=p.getX(d-z),h=Math.max(r,x),v=Math.min(o,u);if(h>=v)return null;let b=p.getY(i.high),y=p.getY(i.low),S=Math.min(b,y),M=Math.abs(b-y),T=i.type==="BULLISH",H=T?"rgba(0, 230, 118, 0.06)":"rgba(255, 23, 68, 0.06)",O=T?"rgba(0, 230, 118, 0.22)":"rgba(255, 23, 68, 0.22)",G=T?"+OB BULLISH":"-OB BEARISH",P=T?"rgba(0, 230, 118, 0.8)":"rgba(255, 23, 68, 0.8)";return a("g",{children:[e("rect",{x:h,y:S,width:v-h,height:M,fill:H,stroke:O,strokeWidth:"1"}),v-h>50&&e("text",{x:h+6,y:S+11,fill:P,fontSize:"8px",fontWeight:"bold",fontFamily:"monospace",pointerEvents:"none",children:G})]},`ob-${l}`)}),t.fvgs?.map((i,l)=>{let s=Math.max(0,i.index-2),d=i.mitigated?Math.min(g.length-1,i.index+6):g.length-1,x=p.getX(s-z),u=p.getX(d-z),h=Math.max(r,x),v=Math.min(o,u);if(h>=v)return null;let b=p.getY(i.top),y=p.getY(i.bottom),S=Math.min(b,y),M=Math.abs(b-y),T=i.type==="BULLISH",H=T?"rgba(0, 188, 212, 0.04)":"rgba(233, 30, 99, 0.04)",O=T?"rgba(0, 188, 212, 0.16)":"rgba(233, 30, 99, 0.16)",G=T?"FVG BULLISH":"FVG BEARISH",P=T?"rgba(0, 188, 212, 0.65)":"rgba(233, 30, 99, 0.65)";return a("g",{children:[e("rect",{x:h,y:S,width:v-h,height:M,fill:H,stroke:O,strokeWidth:"0.8",strokeDasharray:"2,2"}),v-h>50&&M>6&&e("text",{x:h+6,y:S+9,fill:P,fontSize:"7.5px",fontWeight:"bold",fontFamily:"monospace",pointerEvents:"none",children:G})]},`fvg-${l}`)}),t.structureShifts?.map((i,l)=>{let s=g.findIndex(M=>M.time===i.time);if(s===-1)return null;let d=Math.min(g.length-1,s+20),x=p.getX(s-z),u=p.getX(d-z),h=Math.max(r,x),v=Math.min(o,u);if(h>=v)return null;let b=p.getY(i.price),y=i.direction==="BULLISH",S=y?"var(--green)":"var(--red)";return a("g",{children:[e("line",{x1:h,y1:b,x2:v,y2:b,stroke:S,strokeWidth:"1.2",strokeDasharray:"3,3",opacity:"0.85"}),a("g",{transform:`translate(${h+6}, ${b-6})`,children:[e("rect",{x:"-3",y:"-2",width:"48",height:"12",rx:"3",fill:"rgba(19, 23, 34, 0.95)",stroke:S,strokeWidth:"0.8"}),a("text",{x:"21",y:"7",textAnchor:"middle",fill:S,fontSize:"7.5px",fontWeight:"bold",fontFamily:"monospace",children:[i.type," ",y?"\u2197":"\u2198"]})]})]},`shift-${l}`)}),t.sweeps?.map((i,l)=>{let s=g.findIndex(h=>h.time===i.time);if(s===-1)return null;let d=p.getX(s-z);if(d<r||d>o)return null;let x=p.getY(i.price),u=i.type==="SSL";return a("g",{children:[e("line",{x1:d-4,y1:x-4,x2:d+4,y2:x+4,stroke:"var(--yellow)",strokeWidth:"1.5"}),e("line",{x1:d+4,y1:x-4,x2:d-4,y2:x+4,stroke:"var(--yellow)",strokeWidth:"1.5"}),e("text",{x:d,y:u?x+14:x-10,textAnchor:"middle",fill:"var(--yellow)",fontSize:"7.5px",fontWeight:"bold",fontFamily:"monospace",pointerEvents:"none",children:u?"SSL SWEEP":"BSL SWEEP"})]},`sweep-${l}`)})]})})(),Y.map((t,r)=>{let o=p.getX(r),i=p.getY(t.high),l=p.getY(t.low),s=p.getY(t.open),d=p.getY(t.close),u=t.close>=t.open?"var(--green)":"var(--red)";return a("g",{children:[e("line",{x1:o,y1:i,x2:o,y2:l,stroke:u,strokeWidth:"1.5"}),e("rect",{x:o-p.bodyWidth/2,y:Math.min(s,d),width:p.bodyWidth,height:Math.max(1.5,Math.abs(s-d)),fill:u,stroke:u,strokeWidth:"0.5"})]},`candle-${r}`)}),pe&&(()=>{let t="";for(let r=0;r<Y.length;r++){let o=z+r,i=ca[o];if(i){let l=p.getX(r),s=p.getY(i);t===""?t+=`M ${l} ${s}`:t+=` L ${l} ${s}`}}return t?e("path",{d:t,fill:"none",stroke:ve,strokeWidth:"2",opacity:"0.85"}):null})(),ce&&(()=>{let t="";for(let r=0;r<Y.length;r++){let o=z+r,i=ga[o];if(i){let l=p.getX(r),s=p.getY(i);t===""?t+=`M ${l} ${s}`:t+=` L ${l} ${s}`}}return t?e("path",{d:t,fill:"none",stroke:ye,strokeWidth:"2.2",opacity:"0.85"}):null})(),Nt&&(()=>{let{i1:t,price1:r,i2:o,price2:i}=Nt,l=(i-r)/(o-t),s=p.getX(t-z),d=p.getY(r),u=g.length-1+10,h=p.getX(u-z),v=p.getY(r+l*(u-t));return a("g",{children:[e("line",{x1:s,y1:d,x2:h,y2:v,stroke:"var(--gold)",strokeWidth:"2.5",strokeDasharray:"6,4",filter:"url(#glow)"}),e("circle",{cx:s,cy:d,r:"4",fill:"var(--gold)",stroke:"#000",strokeWidth:"1"}),e("circle",{cx:p.getX(o-z),cy:p.getY(i),r:"4",fill:"var(--gold)",stroke:"#000",strokeWidth:"1"}),a("text",{x:Math.max(s+10,p.width-p.paddingRight-180),y:v-10,fill:"var(--gold)",fontSize:"10px",fontWeight:"bold",fontFamily:"monospace",opacity:"0.9",children:["\u2198 \u0110\u01AF\u1EDCNG XU H\u01AF\u1EDANG GI\u1EA2M ",f==="1D"?"D1":f==="1W"?"W1":f==="1M"?"MN":`M${f}`," (SMC)"]})]})})(),m&&(()=>{let t=p.getY(m.entryMid),r=p.getY(m.sl),o=p.getY(m.tp1),i=p.getY(m.tp2),l=p.paddingLeft,s=p.width-p.paddingRight;return a("g",{children:[e("line",{x1:l,y1:r,x2:s,y2:r,stroke:"var(--red)",strokeWidth:"1.2",strokeDasharray:"4,4"}),e("rect",{x:s+4,y:r-8,width:"60",height:"16",rx:"3",fill:"rgba(255, 23, 68, 0.2)",stroke:"var(--red)",strokeWidth:"1"}),a("text",{x:s+8,y:r+4,fill:"var(--red)",fontSize:"9px",fontWeight:"bold",fontFamily:"monospace",children:["SL:$",m.sl.toFixed(1)]}),e("line",{x1:l,y1:t,x2:s,y2:t,stroke:"var(--gold)",strokeWidth:"1.5",strokeDasharray:"4,4"}),e("rect",{x:s+4,y:t-8,width:"60",height:"16",rx:"3",fill:"rgba(255, 171, 0, 0.2)",stroke:"var(--gold)",strokeWidth:"1"}),a("text",{x:s+8,y:t+4,fill:"var(--gold)",fontSize:"9px",fontWeight:"bold",fontFamily:"monospace",children:["ENT:$",m.entryMid.toFixed(1)]}),e("line",{x1:l,y1:o,x2:s,y2:o,stroke:"var(--green)",strokeWidth:"1.2",strokeDasharray:"4,4"}),e("rect",{x:s+4,y:o-8,width:"60",height:"16",rx:"3",fill:"rgba(0, 230, 118, 0.15)",stroke:"var(--green)",strokeWidth:"1"}),a("text",{x:s+8,y:o+4,fill:"var(--green)",fontSize:"9px",fontWeight:"bold",fontFamily:"monospace",children:["TP1:$",m.tp1.toFixed(1)]}),e("line",{x1:l,y1:i,x2:s,y2:i,stroke:"var(--green)",strokeWidth:"1.2",strokeDasharray:"4,4"}),e("rect",{x:s+4,y:i-8,width:"60",height:"16",rx:"3",fill:"rgba(0, 230, 118, 0.15)",stroke:"var(--green)",strokeWidth:"1"}),a("text",{x:s+8,y:i+4,fill:"var(--green)",fontSize:"9px",fontWeight:"bold",fontFamily:"monospace",children:["TP2:$",m.tp2.toFixed(1)]})]})})()]}):e("div",{className:"chart-empty",style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"var(--text3)"},children:"\u0110ang d\u1EF1ng bi\u1EC3u \u0111\u1ED3 k\u1EF9 thu\u1EADt..."}),a("div",{className:"chart-ema-legend",onMouseDown:t=>t.stopPropagation(),onMouseMove:t=>t.stopPropagation(),children:[a("div",{className:"ema-legend-row",children:[e("span",{className:"ema-legend-dot",style:{backgroundColor:ve,color:ve}}),a("span",{className:"ema-legend-name",style:{color:pe?"#fff":"var(--text3)"},children:["EMA ",ue," ",e("span",{style:{opacity:.6,fontSize:"9.5px"},children:he})]}),a("div",{className:"ema-legend-actions",children:[e("button",{className:`ema-action-btn ${pe?"active":""}`,onClick:()=>Yt(!pe),title:pe?"\u1EA8n \u0111\u01B0\u1EDDng EMA":"Hi\u1EC7n \u0111\u01B0\u1EDDng EMA",children:pe?a("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e("circle",{cx:"12",cy:"12",r:"3"})]}):a("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("path",{d:"M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"}),e("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}),e("button",{className:"ema-action-btn",onClick:()=>we("ema50"),title:"C\xE0i \u0111\u1EB7t th\xF4ng s\u1ED1 (Length, Source, Color)",children:a("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("circle",{cx:"12",cy:"12",r:"3"}),e("path",{d:"M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"})]})}),e("button",{className:"ema-action-btn open-source-btn",onClick:()=>{Be("ema50"),Re("pine")},title:"Xem m\xE3 ngu\u1ED3n m\u1EDF ch\u1EC9 b\xE1o",children:a("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("polyline",{points:"16 18 22 12 16 6"}),e("polyline",{points:"8 6 2 12 8 18"})]})})]})]}),a("div",{className:"ema-legend-row",children:[e("span",{className:"ema-legend-dot",style:{backgroundColor:ye,color:ye}}),a("span",{className:"ema-legend-name",style:{color:ce?"#fff":"var(--text3)"},children:["EMA ",be," ",e("span",{style:{opacity:.6,fontSize:"9.5px"},children:fe})]}),a("div",{className:"ema-legend-actions",children:[e("button",{className:`ema-action-btn ${ce?"active":""}`,onClick:()=>Vt(!ce),title:ce?"\u1EA8n \u0111\u01B0\u1EDDng EMA":"Hi\u1EC7n \u0111\u01B0\u1EDDng EMA",children:ce?a("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e("circle",{cx:"12",cy:"12",r:"3"})]}):a("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("path",{d:"M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"}),e("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}),e("button",{className:"ema-action-btn",onClick:()=>we("ema200"),title:"C\xE0i \u0111\u1EB7t th\xF4ng s\u1ED1 (Length, Source, Color)",children:a("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("circle",{cx:"12",cy:"12",r:"3"}),e("path",{d:"M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"})]})}),e("button",{className:"ema-action-btn open-source-btn",onClick:()=>{Be("ema200"),Re("pine")},title:"Xem m\xE3 ngu\u1ED3n m\u1EDF ch\u1EC9 b\xE1o",children:a("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("polyline",{points:"16 18 22 12 16 6"}),e("polyline",{points:"8 6 2 12 8 18"})]})})]})]})]}),te&&e("div",{className:"chart-overlay-modal",style:{pointerEvents:"auto"},onMouseDown:t=>t.stopPropagation(),onMouseMove:t=>t.stopPropagation(),children:a("div",{className:"chart-modal-card",children:[a("div",{className:"chart-modal-header",children:[a("span",{className:"chart-modal-title",children:["\u2699\uFE0F C\xE0i \u0110\u1EB7t Ch\u1EC9 B\xE1o: EMA ",te==="ema50"?"50":"200"]}),e("button",{className:"chart-modal-close",onClick:()=>we(null),children:"\xD7"})]}),a("div",{className:"chart-modal-body",children:[a("div",{className:"settings-group",children:[e("label",{className:"settings-label",children:"Chu k\u1EF3 (Length)"}),a("div",{className:"settings-input-row",children:[e("input",{type:"number",min:"2",max:"500",className:"settings-number-input",value:qe,onChange:t=>Ze(Math.max(2,parseInt(t.target.value)||2))}),e("span",{style:{fontSize:"11px",color:"var(--text3)"},children:"(2 - 500 n\u1EBFn)"})]})]}),a("div",{className:"settings-group",style:{marginTop:"12px"},children:[e("label",{className:"settings-label",children:"Ngu\u1ED3n gi\xE1 tr\u1ECB (Source)"}),e("div",{className:"settings-input-row",children:a("select",{className:"settings-select",value:Je,onChange:t=>Qe(t.target.value),children:[e("option",{value:"close",children:"\u0110\xF3ng c\u1EEDa (Close)"}),e("option",{value:"open",children:"M\u1EDF c\u1EEDa (Open)"}),e("option",{value:"high",children:"Cao nh\u1EA5t (High)"}),e("option",{value:"low",children:"Th\u1EA5p nh\u1EA5t (Low)"})]})})]}),a("div",{className:"settings-group",style:{marginTop:"12px"},children:[e("label",{className:"settings-label",children:"M\xE0u \u0111\u01B0\u1EDDng ch\u1EC9 b\xE1o (Color)"}),e("div",{className:"settings-colors-grid",children:["#FFD700","#00e5ff","#FF1744","#d500f9","#00e676","#ff9100","#ffffff","#787b86"].map(t=>e("div",{className:`settings-color-dot ${De===t?"active":""}`,style:{backgroundColor:t},onClick:()=>Oe(t)},t))}),a("div",{style:{marginTop:"10px",width:"100%"},children:[e("span",{style:{fontSize:"11px",color:"var(--text3)",display:"block",marginBottom:"4px"},children:"M\xE3 m\xE0u HEX t\xF9y ch\u1EC9nh:"}),e("input",{type:"text",className:"settings-number-input",style:{width:"120px"},value:De,onChange:t=>Oe(t.target.value)})]})]})]}),a("div",{className:"chart-modal-footer",children:[e("button",{className:"modal-btn cancel",onClick:()=>we(null),children:"H\u1EE7y b\u1ECF"}),e("button",{className:"modal-btn apply",onClick:Jt,children:"\xC1p d\u1EE5ng"})]})]})}),He&&(()=>{let t=He==="ema50"?ue:be,r=He==="ema50"?he:fe,i=`//@version=5
...
plot(emaValue, title="EMA Line", color=color.from_hex("${He==="ema50"?ve:ye}"), linewidth=2)`,l=`/**
...
`;var Ot=document.createElement("style");Ot.textContent=Dt;document.head.appendChild(Ot);var Ta=Sa(document.getElementById("root"));Ta.render(Na(dt));
