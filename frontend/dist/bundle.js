...
plot(emaValue, title="EMA Line", color=color.from_hex("${Pe==="ema50"?ke:Se}"), linewidth=2)`,d=`/**
...
`;var Vt=document.createElement("style");Vt.textContent=Yt;document.head.appendChild(Vt);var Fa=Ga(document.getElementById("root"));Fa.render(Wa(vt));
