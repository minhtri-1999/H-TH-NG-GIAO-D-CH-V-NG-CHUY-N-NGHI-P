import{createRoot as qa}from"https://esm.sh/react-dom@18.2.0/client";import{createElement as Ja}from"https://esm.sh/react@18.2.0";import _a,{useState as p,useEffect as I,useRef as U,useMemo as R}from"https://esm.sh/react@18.2.0";import{Fragment as X,jsx as e,jsxs as o}from"https://esm.sh/react@18.2.0/jsx-runtime";function Ka({timeframe:d}){let Q=U(null);return I(()=>{if(!Q.current)return;Q.current.innerHTML="";let M="60";d==="1"?M="1":d==="5"?M="5":d==="15"?M="15":d==="60"?M="60":d==="1D"?M="D":d==="1W"?M="W":d==="1M"&&(M="M");let _=document.createElement("script");_.src="https://s3.tradingview.com/external-embedding/embed-widget-advanced-chart.js",_.type="text/javascript",_.async=!0,_.innerHTML=JSON.stringify({autosize:!0,symbol:"FOREXCOM:XAUUSD",interval:M,timezone:"Asia/Ho_Chi_Minh",theme:"dark",style:"1",locale:"vi",enable_publishing:!1,allow_symbol_change:!0,calendar:!0,hide_side_toolbar:!1,studies:[{id:"MAExp@tv-basicstudies",inputs:{length:50}},{id:"MAExp@tv-basicstudies",inputs:{length:200}}],support_host:"https://www.tradingview.com"}),Q.current.appendChild(_)},[d]),e("div",{className:"tradingview-widget-container",ref:Q,style:{height:"100%",width:"100%"},children:e("div",{className:"tradingview-widget-container__widget",style:{height:"100%",width:"100%"}})})}var Ut=d=>{let M=new Date(d+252e5),_=M.getUTCFullYear(),ct=String(M.getUTCMonth()+1).padStart(2,"0");return`${String(M.getUTCDate()).padStart(2,"0")}/${ct}/${_}`};function Le(){let[d,Q]=p("5"),[M,_]=p("tradingview"),[ct,ea]=p(!1),[u,Me]=p(null),[aa,Ce]=p(!0),[Ae,re]=p(null),[$,oa]=p(()=>{let t=localStorage.getItem("active_dash_tab");return t==="ai"||t==="backtest"||t==="outlook"?t:"ai"}),Wt=t=>{oa(t),localStorage.setItem("active_dash_tab",t)},[Ie,ne]=p([]),[Qa,to]=p(!1),[rt,ra]=p(()=>localStorage.getItem("backtest_timeframe_filter")||"ALL"),na=t=>{ra(t),localStorage.setItem("backtest_timeframe_filter",t)},[gt,ia]=p(()=>localStorage.getItem("backtest_selected_day")||"ALL"),sa=t=>{ia(t),localStorage.setItem("backtest_selected_day",t)},tt=R(()=>{let t=[...Ie].sort((n,l)=>l.closeTime-n.closeTime),a=Ut(Date.now()),r=Ut(Date.now()-864e5);return gt==="TODAY"?t=t.filter(n=>Ut(n.closeTime)===a):gt==="YESTERDAY"&&(t=t.filter(n=>Ut(n.closeTime)===r)),rt==="ALL"?t:t.filter(n=>n.timeframe.toUpperCase()===rt.toUpperCase())},[Ie,rt,gt]),ut=R(()=>{if(tt.length===0)return{winRate:0,netPips:0,totalProfit:0,total:0};let t=tt.length,a=tt.filter(s=>s.status==="TP1"||s.status==="TP2").length,r=Math.round(a/t*100),n=Number(tt.reduce((s,i)=>s+(Number(i.pips)||0),0).toFixed(1)),l=Number(tt.reduce((s,i)=>s+(Number(i.profitUsd)||0),0).toFixed(2));return{winRate:r,netPips:n,totalProfit:l,total:t}},[tt]),ie=async(t=!1)=>{try{let a=await fetch("/api/backtest/history");if(a.ok){let r=await a.json();r.success&&r.trades&&ne(r.trades)}}catch(a){console.error("Error fetching backtest history:",a)}},eo=async()=>{try{let t=await fetch("/api/backtest/reset",{method:"POST"});if(t.ok){let a=await t.json();a.success&&a.trades&&ne(a.trades)}else alert("L\u1ED7i khi \u0111\u1ED3ng b\u1ED9 l\u1EA1i d\u1EEF li\u1EC7u n\u1EBFn.")}catch(t){alert("L\u1ED7i h\u1EC7 th\u1ED1ng: "+t.message)}},[D,xt]=p(null),[la,ze]=p(!1),[se,nt]=p("login"),[K,le]=p(""),[V,de]=p(""),[it,et]=p(""),[Ee,N]=p(null),[Pe,A]=p(null),[j,Gt]=p(0),[bt,mt]=p(!1),[pe,at]=p(""),[ht,Ft]=p(!1),Lt=U([]),[q,$t]=p(()=>{let t=localStorage.getItem("ai_active_trades");return t?JSON.parse(t):{}}),[Yt,ce]=p(!1),[Vt,ge]=p(0),[da,ft]=p(""),[st,Re]=p(()=>localStorage.getItem("ai_analysis_triggered")==="true");I(()=>{localStorage.setItem("ai_active_trades",JSON.stringify(q))},[q]),I(()=>{localStorage.setItem("ai_analysis_triggered",String(st))},[st]);let[vt,pa]=p(!0),[yt,ca]=p(!0),[Mt,ga]=p(50),[Ct,ua]=p(200),[At,xa]=p("close"),[It,ba]=p("close"),[zt,ma]=p("#FFD700"),[Et,ha]=p("#FF1744"),[ao,oo]=p(!1),[ro,no]=p(!1),[io,so]=p(!1),[lo,po]=p(!1),[co,go]=p(!1),[lt,Pt]=p(null),[jt,Xt]=p(null),[Rt,_t]=p("pine"),[ue,xe]=p(50),[be,me]=p("close"),[Kt,qt]=p("#FFD700");I(()=>{lt==="ema50"?(xe(Mt),me(At),qt(zt)):lt==="ema200"&&(xe(Ct),me(It),qt(Et))},[lt]);let fa=()=>{lt==="ema50"?(ga(ue),xa(be),ma(Kt)):lt==="ema200"&&(ua(ue),ba(be),ha(Kt)),Pt(null)},va=async()=>{try{ze(!0);let t=await fetch("/api/auth/me");if(t.ok){let a=await t.json();a.authenticated&&a.email?xt({email:a.email}):xt(null)}else xt(null)}catch(t){console.error("Session check error:",t),xt(null)}finally{ze(!1)}};I(()=>{va()},[]),I(()=>{D&&ie(!1)},[D]),I(()=>{if(D&&($==="ai"||$==="backtest")){ie(!0);let t=setInterval(()=>{ie(!1)},5e3);return()=>clearInterval(t)}},[$,D]),I(()=>{if(j<=0)return;let t=setInterval(()=>{Gt(a=>a-1)},1e3);return()=>clearInterval(t)},[j]);let ya=async t=>{if(t.preventDefault(),!K||!V){N("Vui l\xF2ng \u0111i\u1EC1n \u0111\u1EA7y \u0111\u1EE7 email v\xE0 m\u1EADt kh\u1EA9u.");return}mt(!0),N(null),A(null);try{let a=await fetch("/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:K,password:V})}),r=await a.json();if(!a.ok){a.status===403&&r.needsVerification?(nt("otp"),Gt(300),r.isSimulator&&r.otp?(at(r.otp),A(`\u26A0\uFE0F [CH\u1EBE \u0110\u1ED8 TH\u1EEC NGHI\u1EC6M]: Ch\u01B0a c\u1EA5u h\xECnh Email API. M\xE3 OTP c\u1EE7a b\u1EA1n l\xE0: ${r.otp}`)):(at(""),A(r.error||"T\xE0i kho\u1EA3n ch\u01B0a k\xEDch ho\u1EA1t. M\u1ED9t m\xE3 OTP m\u1EDBi \u0111\xE3 \u0111\u01B0\u1EE3c g\u1EEDi v\u1EC1 email."))):N(r.error||"\u0110\u0103ng nh\u1EADp th\u1EA5t b\u1EA1i.");return}r.success&&(xt({email:r.user.email}),A("\u0110\u0103ng nh\u1EADp th\xE0nh c\xF4ng!"))}catch(a){N("L\u1ED7i k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7: "+a.message)}finally{mt(!1)}},wa=async t=>{if(t.preventDefault(),!K||!V){N("Vui l\xF2ng \u0111i\u1EC1n \u0111\u1EA7y \u0111\u1EE7 email v\xE0 m\u1EADt kh\u1EA9u.");return}if(V.length<6){N("M\u1EADt kh\u1EA9u ph\u1EA3i ch\u1EE9a \xEDt nh\u1EA5t 6 k\xFD t\u1EF1.");return}mt(!0),N(null),A(null);try{let a=await fetch("/api/auth/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:K,password:V})}),r=await a.json();if(!a.ok){N(r.error||"\u0110\u0103ng k\xFD th\u1EA5t b\u1EA1i.");return}r.success&&(nt("otp"),Gt(300),r.isSimulator&&r.otp?(at(r.otp),A(`\u26A0\uFE0F [CH\u1EBE \u0110\u1ED8 TH\u1EEC NGHI\u1EC6M]: Ch\u01B0a c\u1EA5u h\xECnh Email API. M\xE3 OTP c\u1EE7a b\u1EA1n l\xE0: ${r.otp}`)):(at(""),A(r.message||"\u0110\u0103ng k\xFD th\xE0nh c\xF4ng! Vui l\xF2ng nh\u1EADp m\xE3 OTP g\u1EEDi t\u1EDBi email.")))}catch(a){N("L\u1ED7i k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7: "+a.message)}finally{mt(!1)}},ka=async t=>{if(t.preventDefault(),!it){N("Vui l\xF2ng nh\u1EADp m\xE3 OTP.");return}mt(!0),N(null),A(null);try{let a=await fetch("/api/auth/verify-otp",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:K,otp:it})}),r=await a.json();if(!a.ok){N(r.error||"X\xE1c th\u1EF1c OTP th\u1EA5t b\u1EA1i.");return}r.success&&(nt("login"),et(""),at(""),A("K\xEDch ho\u1EA1t t\xE0i kho\u1EA3n th\xE0nh c\xF4ng! B\xE2y gi\u1EDD b\u1EA1n c\xF3 th\u1EC3 \u0111\u0103ng nh\u1EADp."))}catch(a){N("L\u1ED7i k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7: "+a.message)}finally{mt(!1)}},Sa=async()=>{if(!(j>0)){N(null),A(null);try{let t=await fetch("/api/auth/resend-otp",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:K})}),a=await t.json();if(!t.ok){N(a.error||"G\u1EEDi l\u1EA1i OTP th\u1EA5t b\u1EA1i.");return}a.success&&(Gt(300),a.isSimulator&&a.otp?(at(a.otp),A(`\u26A0\uFE0F [CH\u1EBE \u0110\u1ED8 TH\u1EEC NGHI\u1EC6M]: M\xE3 OTP c\u1EE7a b\u1EA1n l\xE0: ${a.otp}`)):(at(""),A(a.message||"M\xE3 OTP m\u1EDBi \u0111\xE3 \u0111\u01B0\u1EE3c g\u1EEDi v\u1EC1 email c\u1EE7a b\u1EA1n.")))}catch(t){N("L\u1ED7i k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7: "+t.message)}}},Ta=async()=>{try{await fetch("/api/auth/logout",{method:"POST"}),xt(null),Me(null),Jt(4500),Zt(0),nt("login"),le(""),de(""),et(""),N(null),A(null),$t({}),ce(!1),ge(0),ft(""),Re(!1),localStorage.removeItem("ai_active_trades"),localStorage.removeItem("ai_analysis_triggered")}catch(t){console.error("Logout error",t)}},he=()=>{if(Yt)return;ce(!0),ge(5),ft("\u{1F50D} \u0110ang k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7, t\u1EA3i d\u1EEF li\u1EC7u n\u1EBFn V\xE0ng Spot XAU/USD...");let t=5,a=setInterval(()=>{t--,ge(t),t===4?(ft("\u{1F4CA} \u0110ang ph\xE2n t\xEDch c\u1EA5u tr\xFAc th\u1ECB tr\u01B0\u1EDDng SMC (BOS, CHoCH, Order Block, FVG)..."),z("info")):t===3?(ft("\u{1F4C8} \u0110ang x\xE1c \u0111\u1ECBnh c\u1EA5u tr\xFAc Price Action & c\xE1c v\xF9ng qu\xE9t thanh kho\u1EA3n (Liquidity Sweep)..."),z("info")):t===2?(ft("\u{1F56F}\uFE0F \u0110ang nh\u1EADn di\u1EC7n c\xE1c m\xF4 h\xECnh n\u1EBFn \u0111\u1EA3o chi\u1EC1u c\u01B0\u1EDDng \u0111\u1ED9 cao (Pinbar, Engulfing)..."),z("info")):t===1?(ft("\u{1F916} A.I \u0111ang t\u1ED1i \u01B0u h\xF3a \u0111i\u1EC3m v\xE0o LIMIT ch\u1ED1ng qu\xE9t SL v\xE0 ph\xE2n b\u1ED5 t\u1EF7 l\u1EC7 RR..."),z("info")):t<=0&&(clearInterval(a),ce(!1),z("buy"),Na())},1e3)},Na=()=>{let t=Y.current||k||4500,a=u?.signals?.indicators?.atr||3.2,r="BUY";u?.signals?.type==="SELL"||u?.signals?.type==="STRONG_SELL"?r="SELL":u?.signals?.type==="BUY"||u?.signals?.type==="STRONG_BUY"?r="BUY":r=Math.random()>.5?"BUY":"SELL";let n=0,l=0,s=0,i=.38+Math.random()*.22,f=.85+Math.random()*.25,g=2.5+Math.random()*.8;r==="BUY"?(n=Math.round((t-i*a)*100)/100,l=Math.round((n-f*a)*100)/100,s=Math.round((n+g*a)*100)/100):(n=Math.round((t+i*a)*100)/100,l=Math.round((n+f*a)*100)/100,s=Math.round((n-g*a)*100)/100);let b=(Math.abs(s-n)/Math.abs(n-l)).toFixed(1),v="",w="",m="";r==="BUY"?(v=`Ph\xE1t hi\u1EC7n v\xF9ng qu\xE9t thanh kho\u1EA3n \u0111\xE1y (Liquidity Sweep) d\u01B0\u1EDBi ng\u01B0\u1EE1ng h\u1ED7 tr\u1EE3 g\u1EA7n nh\u1EA5t t\u1EA1i $${(n+.8).toFixed(2)}. D\xF2ng ti\u1EC1n th\xF4ng minh (Smart Money Concept) \u0111ang \u0111\u1EB7t b\u1EABy s\u0103n d\u1EEBng l\u1ED7 (Stop Hunt) c\u1EE7a phe nh\u1ECF l\u1EBB tr\u01B0\u1EDBc khi \u0111\u1EA9y gi\xE1 t\u0103ng. \u0110i\u1EC3m BUY LIMIT \u0111\u01B0\u1EE3c thi\u1EBFt l\u1EADp \u0111\xF3n \u0111\u1EA7u r\xE2u n\u1EBFn t\u1EA1i $${n.toFixed(2)} n\u1EB1m \u1EDF v\xF9ng chi\u1EBFt kh\u1EA5u (Discount Zone) c\u1EE7a kh\u1ED1i l\u1EC7nh (Bullish Order Block).`,w=`M\u1EE9c d\u1EEBng l\u1ED7 (SL) \u0111\u01B0\u1EE3c th\u1EAFt ch\u1EB7t t\u1EA1i $${l.toFixed(2)}, ngay b\xEAn d\u01B0\u1EDBi \u0111\xE1y v\xF9ng qu\xE9t thanh kho\u1EA3n th\u1EE9 hai v\xE0 kh\u1ED1i l\u1EC7nh t\u0103ng tr\u01B0\u1EDFng (Bullish Order Block). N\u1EBFu gi\xE1 n\u1EBFn \u0111\xF3ng d\u01B0\u1EDBi v\xF9ng n\xE0y, c\u1EA5u tr\xFAc t\u0103ng (BOS) s\u1EBD b\u1ECB v\xF4 hi\u1EC7u h\xF3a ho\xE0n to\xE0n, vi\u1EC7c c\u1EAFt l\u1ED7 l\xE0 b\u1EAFt bu\u1ED9c \u0111\u1EC3 b\u1EA3o to\xE0n v\u1ED1n.`,m=`M\u1EE5c ti\xEAu ch\u1ED1t l\u1EDDi (TP) t\u1EA1i $${s.toFixed(2)} \u0111\u01B0\u1EE3c x\xE1c \u0111\u1ECBnh \u1EDF \u0111\u1EC9nh c\u0169 M15 v\xE0 v\xF9ng m\u1EA5t c\xE2n b\u1EB1ng cung c\u1EA7u (Fair Value Gap - FVG) gi\u1EA3m gi\xE1 ph\xEDa tr\xEAn, n\u01A1i t\xEDch t\u1EE5 l\u01B0\u1EE3ng l\u1EDBn thanh kho\u1EA3n ch\u1EDD mua c\u1EE7a th\u1ECB tr\u01B0\u1EDDng. \u0110\u1EA1t t\u1EF7 l\u1EC7 r\u1EE7i ro/l\u1EE3i nhu\u1EADn (R:R) c\u1EF1c cao 1:${b}.`):(v=`Ph\xE1t hi\u1EC7n b\u1EABy qu\xE9t thanh kho\u1EA3n \u0111\u1EC9nh (Liquidity Sweep/Buy-side Liquidity) \u1EDF v\xF9ng kh\xE1ng c\u1EF1 $${(n-.8).toFixed(2)}. C\xE1c t\u1ED5 ch\u1EE9c l\u1EDBn \u0111ang k\xEDch ho\u1EA1t qu\xE9t Stop Hunt c\xE1c l\u1EC7nh b\xE1n kh\u1ED1ng nh\u1ECF l\u1EBB \u0111\u1EC3 gom thanh kho\u1EA3n. \u0110i\u1EC3m SELL LIMIT \u0111\u01B0\u1EE3c thi\u1EBFt l\u1EADp \u0111\xF3n \u0111\u1EA7u t\u1EA1i $${n.toFixed(2)} n\u1EB1m \u1EDF v\xF9ng Premium Zone t\u1ED1i \u01B0u v\xE0 kh\u1ED1i l\u1EC7nh gi\u1EA3m tr\u01B0\u1EDFng (Bearish Order Block).`,w=`M\u1EE9c d\u1EEBng l\u1ED7 (SL) th\u1EAFt ch\u1EB7t \u0111\u1EB7t t\u1EA1i $${l.toFixed(2)} ph\xEDa tr\xEAn \u0111\u1EC9nh qu\xE9t thanh kho\u1EA3n. Vi\u1EC7c v\u01B0\u1EE3t qua m\u1EE9c gi\xE1 n\xE0y s\u1EBD ph\xE1 v\u1EE1 c\u1EA5u tr\xFAc gi\u1EA3m hi\u1EC7n t\u1EA1i (CHoCH t\u0103ng), v\xF4 hi\u1EC7u h\xF3a ho\xE0n to\xE0n k\u1ECBch b\u1EA3n b\xE1n kh\u1ED1ng.`,m=`M\u1EE5c ti\xEAu ch\u1ED1t l\u1EDDi (TP) t\u1EA1i $${s.toFixed(2)} n\u1EB1m s\xE2u d\u01B0\u1EDBi \u0111\xE1y c\u0169 v\xE0 v\xF9ng FVG t\u0103ng gi\xE1 ch\u01B0a \u0111\u01B0\u1EE3c gi\u1EA3m thi\u1EC3u (Unmitigated Bullish FVG), b\u1EA3o to\xE0n l\u1EE3i nhu\u1EADn t\u1ED1i \u0111a v\u1EDBi t\u1EF7 l\u1EC7 r\u1EE7i ro/l\u1EE3i nhu\u1EADn (R:R) \u0111\u1EA1t 1:${b}.`);let y={timeframe:d,position:r,type:"LIMIT",entry:n,stopLoss:l,takeProfit:s,status:"PENDING",pips:0,openPrice:0,openTime:"",rrRatio:b,entryReason:v,slReason:w,tpReason:m};$t(L=>({...L,[d]:y}))},uo=()=>{Wt("ai"),Re(!0);let t=q[d];(!t||t.status==="TP"||t.status==="SL")&&!Yt&&he()};I(()=>{if($==="ai"&&st&&!Yt){let t=q[d];(!t||t.status==="TP"||t.status==="SL")&&he()}},[$,d,st]);let[k,Jt]=p(4500),[fe,Zt]=p(0),[Dt,xo]=p(!0),[bo,De]=p([]),[mo,Oe]=p({bids:[],asks:[]}),[ho,fo]=p("book"),[La,Ma]=p(""),[vo,Ca]=p(""),[J,Aa]=p(!1),[Ot,yo]=p(100),[Qt,wo]=p(5),[ve,ko]=p("micro"),[te,So]=p("percent"),[ee,To]=p(5),[ye,No]=p(0),[Lo,Ia]=p([{id:"h1",time:"05:40:12",type:"SELL",entry:4512.4,stopLoss:4516.8,tp1:4504,status:"HIT TP1 \u{1F7E2} (+84 pips)"},{id:"h2",time:"03:15:45",type:"BUY",entry:4495.2,stopLoss:4489.5,tp1:4503.5,status:"HIT TP1 \u{1F7E2} (+83 pips)"},{id:"h3",time:"01:04:10",type:"SELL",entry:4520.1,stopLoss:4525,tp1:4511,status:"HIT SL \u{1F534} (-49 pips)"},{id:"h4",time:"23:12:05",type:"BUY",entry:4488.5,stopLoss:4482,tp1:4498,status:"HIT TP1 \u{1F7E2} (+95 pips)"}]),W=U({}),[Mo,He]=p(""),[za,Ea]=p(!0),[ot,Ht]=p(80),[wt,kt]=p(0),Be=wt===0,[we,ke]=p(1),x=R(()=>{if(!u?.chart?.timestamp)return[];let t=u.chart.timestamp.length,a=[];for(let r=0;r<t;r++)a.push({time:u.chart.timestamp[r],open:u.chart.open[r]??0,high:u.chart.high[r]??0,low:u.chart.low[r]??0,close:u.chart.close[r]??0,volume:u.chart.volume[r]??0});if(a.length>0){let r=a[a.length-1];r.close=k,k>r.high&&(r.high=k),k<r.low&&(r.low=k)}return a},[u,k]),Z=R(()=>{if(x.length===0)return[];let t=x.length,a=Math.max(10,Math.min(ot,t)),r=Math.max(0,Math.min(wt,t-a)),n=t-r,l=Math.max(0,n-a);return x.slice(l,n)},[x,ot,wt]),G=R(()=>{if(x.length===0)return 0;let t=x.length,a=Math.max(10,Math.min(ot,t)),r=Math.max(0,Math.min(wt,t-a)),n=t-r;return Math.max(0,n-a)},[x,ot,wt]),Pa=R(()=>{if(x.length===0)return[];let t=[],r=2/((Number(Mt)||50)+1),n=At||"close",l=x[0][n]||x[0].close;t.push(l);for(let s=1;s<x.length;s++)l=(x[s][n]||x[s].close)*r+l*(1-r),t.push(l);return t},[x,Mt,At]),Ra=R(()=>{if(x.length===0)return[];let t=[],r=2/((Number(Ct)||200)+1),n=It||"close",l=x[0][n]||x[0].close;t.push(l);for(let s=1;s<x.length;s++)l=(x[s][n]||x[s].close)*r+l*(1-r),t.push(l);return t},[x,Ct,It]),Ue=R(()=>{if(x.length<10)return null;let a=(u?.advancedAnalysis?.swings||[]).filter(i=>i.type==="HIGH").sort((i,f)=>i.index-f.index);if(a.length>=2){let i=a[0];for(let g of a)g.price>i.price&&(i=g);let f=a.find(g=>g.index>i.index&&g.price<i.price);if(f||(f=a[a.length-1]),i&&f&&i.index!==f.index)return{i1:i.index,price1:i.price,i2:f.index,price2:f.price,source:"SMC Swings"}}let r=0,n=x[0].high;for(let i=1;i<Math.floor(x.length*.7);i++)x[i].high>n&&(n=x[i].high,r=i);let l=r+5,s=0;if(l<x.length){s=x[l].high;for(let i=l;i<x.length;i++)x[i].high>s&&x[i].high<n&&(s=x[i].high,l=i)}return r!==l&&l<x.length?{i1:r,price1:n,i2:l,price2:s,source:"PA Scan"}:{i1:Math.max(0,x.length-80),price1:4568,i2:Math.max(0,x.length-20),price2:4516,source:"SMC Profile"}},[x,u]),c=R(()=>{if(Z.length<5)return null;let t=1400,a=520,r=4,n=68,l=12,s=34,i=t-r-n,f=a-l-s,g=Z.map(T=>T.high),b=Z.map(T=>T.low),v=Math.max(...g),w=Math.min(...b),m=v-w||1,y=(v+w)/2,L=m*1.1*we||1;v=y+L/2,w=y-L/2;let S=v-w,E=Z.length,O=i/E,H=Math.max(1,O*.75),C=T=>r+(T+.5)*O,dt=T=>l+(1-(T-w)/S)*f,Tt=Math.max(1,Math.floor(E/8)),P=[];for(let T=0;T<E;T+=Tt){let Nt=Z[T].time*1e3,oe=new Date(Nt),Bt;["1D","1W","1M"].includes(d)?Bt=oe.toLocaleDateString("vi-VN",{day:"2-digit",month:"2-digit"}):Bt=oe.toLocaleTimeString("vi-VN",{hour:"2-digit",minute:"2-digit"}),P.push({x:C(T),label:Bt})}let pt=8,B=[];for(let T=0;T<=pt;T++){let Nt=w+S*T/pt;B.push({y:dt(Nt),price:Nt})}return{width:t,height:a,paddingLeft:r,paddingRight:n,paddingBottom:s,usableWidth:i,usableHeight:f,maxPrice:v,minPrice:w,paddedRange:S,candleSlotW:O,bodyWidth:H,getX:C,getY:dt,timeLabels:P,priceLabels:B}},[Z,d,we]),Y=U(4500),We=U(null),Ge=U(0),ae=U(!1),Fe=U(0),$e=U(0),St=U(null),Se=U(!1),Ye=U(0),Ve=U(1),Da={1:60,5:300,15:900,60:3600,"1D":86400,"1W":604800,"1M":2592e3};I(()=>{We.current=u},[u]);let z=(t="info")=>{try{let a=new(window.AudioContext||window.webkitAudioContext),r=a.createOscillator(),n=a.createGain();r.connect(n),n.connect(a.destination),t==="buy"?(r.frequency.setValueAtTime(587.33,a.currentTime),n.gain.setValueAtTime(.12,a.currentTime),r.start(),r.frequency.setValueAtTime(698.46,a.currentTime+.12),n.gain.setValueAtTime(.1,a.currentTime+.12),n.gain.exponentialRampToValueAtTime(.001,a.currentTime+.35),r.stop(a.currentTime+.4)):t==="sell"?(r.frequency.setValueAtTime(523.25,a.currentTime),n.gain.setValueAtTime(.12,a.currentTime),r.start(),r.frequency.setValueAtTime(392,a.currentTime+.12),n.gain.setValueAtTime(.1,a.currentTime+.12),n.gain.exponentialRampToValueAtTime(.001,a.currentTime+.35),r.stop(a.currentTime+.4)):(r.frequency.setValueAtTime(440,a.currentTime),n.gain.setValueAtTime(.08,a.currentTime),n.gain.exponentialRampToValueAtTime(.001,a.currentTime+.15),r.start(),r.stop(a.currentTime+.2))}catch(a){console.warn("Audio Context failed",a)}};I(()=>{if(!J||!u?.advancedAnalysis)return;let t=u.advancedAnalysis,a=Date.now(),r=t.fvgs.find(i=>!i.mitigated&&i.type==="BULLISH");if(r&&k<=r.top&&k>=r.bottom){let i=`fvg_bullish_${r.index}`;(!W.current[i]||a-W.current[i]>3e4)&&(W.current[i]=a,z("buy"))}let n=t.fvgs.find(i=>!i.mitigated&&i.type==="BEARISH");if(n&&k>=n.bottom&&k<=n.top){let i=`fvg_bearish_${n.index}`;(!W.current[i]||a-W.current[i]>3e4)&&(W.current[i]=a,z("sell"))}let l=t.orderBlocks.find(i=>!i.mitigated&&i.type==="BULLISH");if(l&&k>=l.low&&k<=l.high){let i=`ob_bullish_${l.index}`;(!W.current[i]||a-W.current[i]>3e4)&&(W.current[i]=a,z("buy"))}let s=t.orderBlocks.find(i=>!i.mitigated&&i.type==="BEARISH");if(s&&k>=s.low&&k<=s.high){let i=`ob_bearish_${s.index}`;(!W.current[i]||a-W.current[i]>3e4)&&(W.current[i]=a,z("sell"))}},[k,J,u]),I(()=>{let t=setInterval(()=>{let a=new Date;Ma(a.toLocaleTimeString("en-GB")+" UTC");let r=Da[d]||86400,n=Math.floor(a.getTime()/1e3),l=r-n%r;if(l>=3600){let s=Math.floor(l/3600),i=Math.floor(l%3600/60),f=l%60;He(`${s}:${String(i).padStart(2,"0")}:${String(f).padStart(2,"0")}`)}else{let s=Math.floor(l/60),i=l%60;He(`${String(s).padStart(2,"0")}:${String(i).padStart(2,"0")}`)}},1e3);return()=>clearInterval(t)},[d]),I(()=>{let t=a=>{document.activeElement?.tagName==="INPUT"||document.activeElement?.tagName==="TEXTAREA"||(a.key==="+"||a.key==="="?(a.preventDefault(),Xe()):a.key==="-"?(a.preventDefault(),_e()):a.key==="ArrowLeft"?(a.preventDefault(),kt(r=>Math.min(x.length-ot,r+5))):a.key==="ArrowRight"?(a.preventDefault(),kt(r=>Math.max(0,r-5))):(a.key==="r"||a.key==="R")&&(a.preventDefault(),Ht(80),kt(0),ke(1)))};return window.addEventListener("keydown",t),()=>window.removeEventListener("keydown",t)},[x.length,ot]);let Te=async(t=!1)=>{if(D){t||Ce(!0),t||re(null);try{let a=await fetch(`/api/signals/XAUUSD?tf=${d}`);if(!a.ok)throw new Error("Kh\xF4ng th\u1EC3 k\u1EBFt n\u1ED1i \u0111\u1EBFn server API Gold");let r=await a.json();re(null),Me(r),Ca(new Date().toLocaleTimeString("vi-VN")),r.lastPrice>0&&(!We.current||Math.abs(Y.current-r.lastPrice)>100?Y.current=r.lastPrice:Y.current=Y.current*.7+r.lastPrice*.3,Jt(Math.round(Y.current*100)/100)),r.signals&&r.signals.type!=="NEUTRAL"&&Ia(n=>{let l=n[0];if(!l||l.type!==r.signals.type||Math.abs(l.entry-r.signals.suggestion.entry)>.5){let i=new Date().toLocaleTimeString("vi-VN");return[{id:Math.random().toString(),time:i,type:r.signals.type,entry:r.signals.suggestion.entry,stopLoss:r.signals.suggestion.stopLoss,tp1:r.signals.suggestion.takeProfit1,status:"Active \u{1F7E1}"},...n.slice(0,14)]}return n}),t||(Ha(r.lastPrice),Ba(r.lastPrice)),Zt(r.priceChange)}catch(a){t||re(a.message)}finally{t||Ce(!1)}}},Oa=async()=>{try{let t=await fetch("/api/price/XAUUSD");if(!t.ok)return;let a=await t.json();a.price&&a.price>0&&(Y.current=Y.current*.7+a.price*.3,Jt(Math.round(Y.current*100)/100),Zt(a.change))}catch{}};I(()=>{if(!D)return;Te(!1);let t=setInterval(()=>{Dt&&D&&Oa()},1500),a=setInterval(()=>{Dt&&D&&Te(!0)},3e4);return()=>{clearInterval(t),clearInterval(a)}},[d,Dt,D]);let Ha=t=>{let a=.35+Math.random()*.15,r=[],n=[];for(let l=1;l<=10;l++)n.push({price:t+a/2+(l-1)*.15,size:Math.round((Math.random()*80+5)*10)/10}),r.push({price:t-a/2-(l-1)*.15,size:Math.round((Math.random()*80+5)*10)/10});Oe({bids:r,asks:n.reverse()})},Ba=t=>{let a=[],r=new Date;for(let n=0;n<20;n++){let l=n*280,s=new Date(r.getTime()-l),i=Math.random()>.48;a.push({id:`init-${n}`,time:s.toLocaleTimeString()+"."+String(s.getMilliseconds()).padStart(3,"0"),type:i?"BUY":"SELL",price:t+(Math.random()-.5)*.4,size:(Math.random()*4.5+.1).toFixed(1)+" Lot"})}De(a)};I(()=>{if(!Dt||!u||!D)return;let t=setInterval(()=>{let a=Y.current,r=u.lastPrice,n=(r-a)*.05,l=(Math.random()-.5)*.25,s=Math.round((a+n+l)*100)/100;Y.current=s,Jt(s);let i=r/(1+u.priceChange/100),f=(s-i)/i*100;if(Zt(f),Ge.current++,Ge.current%3===0){let b=.35+Math.random()*.1;Oe(v=>{let w=v.asks.map((y,L)=>{let S=10-L;return{price:Math.round((s+b/2+(S-1)*.15)*100)/100,size:Math.max(1,Math.round((y.size+(Math.random()-.5)*5)*10)/10)}});return{bids:v.bids.map((y,L)=>({price:Math.round((s-b/2-L*.15)*100)/100,size:Math.max(1,Math.round((y.size+(Math.random()-.5)*5)*10)/10)})),asks:w}})}if(Math.random()<.35){let b=Math.random()>.47,v=new Date,w=b?s+Math.random()*.05:s-Math.random()*.05,m={id:Math.random().toString(),time:v.toLocaleTimeString()+"."+String(v.getMilliseconds()).padStart(3,"0"),type:b?"BUY":"SELL",price:Math.round(w*100)/100,size:(Math.random()*5+.1).toFixed(1)+" Lot"};De(y=>[m,...y.slice(0,24)])}let g=q[d];if(g){if(g.status==="PENDING")(g.position==="BUY"?s<=g.entry:s>=g.entry)&&($t(w=>{let m={...w};return m[d]&&m[d].status==="PENDING"&&(m[d]={...m[d],status:"ACTIVE",openPrice:s,openTime:new Date().toLocaleTimeString()}),m}),z("info"));else if(g.status==="ACTIVE"){let b=g.position==="BUY",v=b?s>=g.takeProfit:s<=g.takeProfit,w=b?s<=g.stopLoss:s>=g.stopLoss;if(v||w){let m=v?"TP":"SL",y=0;b?y=Math.round((s-g.entry)*10):y=Math.round((g.entry-s)*10);let L=100,S=.1;d==="5"?S=.2:d==="15"?S=.5:d==="60"?S=1:d==="1D"&&(S=2);let E=Number((y*L*S/10).toFixed(2));$t(H=>{let C={...H};return C[d]&&C[d].status==="ACTIVE"&&(C[d]={...C[d],status:m,closePrice:s,closeTime:new Date().toLocaleTimeString(),pips:y,profitUsd:E}),C});let O={id:`AI-${d.toUpperCase()}-${Date.now()}-${Math.random().toString(36).substring(2,6).toUpperCase()}`,timeframe:d==="1"?"M1":d==="5"?"M5":d==="15"?"M15":d==="60"?"H1":"D1",position:g.position,entry:g.entry,stopLoss:g.stopLoss,takeProfit1:g.takeProfit,takeProfit2:g.takeProfit,status:m==="TP"?"TP1":"SL",openTime:Date.now()-3e4,closeTime:Date.now(),pips:y,profitUsd:E,isAi:!0};ne(H=>[O,...H]),z(m==="TP"?"buy":"sell")}}}},85);return()=>clearInterval(t)},[Dt,u,D,d,q]);let Ua=t=>{if(!St.current||!c)return;let a=St.current.getBoundingClientRect();(t.clientX-a.left)/a.width*c.width>c.width-c.paddingRight?(Se.current=!0,Ye.current=t.clientY,Ve.current=we):(ae.current=!0,Fe.current=t.clientX,$e.current=wt)},Wa=t=>{if(Se.current){let r=1+(t.clientY-Ye.current)*.005;ke(Math.max(.05,Math.min(10,Ve.current*r)))}else if(ae.current&&St.current&&c){let a=t.clientX-Fe.current,n=(St.current.clientWidth||860)/Math.max(ot,1),l=Math.round(-a/n),s=Math.max(0,Math.min(x.length-ot,$e.current+l));kt(s)}},je=()=>{ae.current=!1,Se.current=!1},Ga=()=>{Ht(80),kt(0),ke(1)};I(()=>{let t=St.current;if(!t)return;let a=r=>{r.preventDefault();let n=r.deltaY>0?1:-1;Ht(l=>Math.max(10,Math.min(500,l+n*Math.ceil(l*.08))))};return t.addEventListener("wheel",a,{passive:!1}),()=>{t.removeEventListener("wheel",a)}},[c]);let Fa=()=>kt(0),Xe=()=>Ht(t=>Math.max(10,Math.round(t*.7))),_e=()=>Ht(t=>Math.min(500,Math.round(t*1.4))),h=R(()=>{if(!u)return null;let t=q[d];if(st&&t&&(t.status==="PENDING"||t.status==="ACTIVE")){let B=t.position==="BUY",T=B?"BUY":"SELL",Nt=t.stopLoss,oe=t.takeProfit,Bt=t.takeProfit,Ze=t.entry,Xa=`$${Ze.toFixed(2)}`;return{type:T,confluenceScore:B?78:-78,winProbability:88,entryText:Xa,entryMid:Ze,sl:Nt,tp1:oe,tp2:Bt,atr:u.signals?.indicators?.atr||u.tradingViewAnalysis?.atr||3.2,rsi:u.signals?.indicators?.rsi||u.tradingViewAnalysis?.rsi||50,adx:u.tradingViewAnalysis?.adx||20,ema10:u.tradingViewAnalysis?.ema10||k,sma20:u.tradingViewAnalysis?.sma20||k}}let a=u.signals,r=u.tradingViewAnalysis,n=a.type==="BUY"?a.strength:a.type==="SELL"?-a.strength:0,l=r?r.recommendAll*100:0,s=Math.round((n+l)/2),i="NEUTRAL";s>=40?i="STRONG_BUY":s>=15?i="BUY":s<=-40?i="STRONG_SELL":s<=-15&&(i="SELL");let f=50,g=0,b=0,v=0,w=0,m=a.indicators.atr||r?.atr||3.2,y=a.indicators.rsi||r?.rsi||50,L=r?r.macd-r.macdSignal:0;if(r){let B=k>r.ema50,T=r.ema10>r.sma20;i.includes("BUY")?(B&&(g+=6),T&&(g+=6)):i.includes("SELL")&&(B||(g+=6),T||(g+=6))}i.includes("BUY")?(y>=50&&y<=65&&(b+=6),L>0&&(b+=6)):i.includes("SELL")&&(y>=35&&y<=50&&(b+=6),L<0&&(b+=6)),r&&r.adx>25&&(v+=6),i.includes("BUY")&&y<30&&(w+=8),i.includes("SELL")&&y>70&&(w+=8);let S=Math.min(94,Math.max(35,Math.round(f+Math.abs(s)*.3+g+b+v+w))),E=0,O=0,H="",C=0,dt=0,Tt=0,P=0,pt=u.chart?.close&&u.chart.close.length>0?u.chart.close[u.chart.close.length-1]:k;if(a&&a.suggestion&&a.suggestion.position!=="NEUTRAL"){let B=a.suggestion;C=B.stopLoss,dt=B.takeProfit1,Tt=B.takeProfit2,P=B.entry,E=Math.round((P-.15*m)*100)/100,O=Math.round((P+.15*m)*100)/100,H=`$${P.toFixed(2)}`,a.strength>0&&(S=Math.min(94,Math.max(78,80+Math.round(a.strength*.15))))}else E=Math.round((i.includes("BUY")?pt-.25*m:pt)*100)/100,O=Math.round((i.includes("BUY")?pt:pt+.25*m)*100)/100,H=`$${E.toFixed(2)} - $${O.toFixed(2)}`,P=(E+O)/2,i.includes("BUY")?(C=Math.round((P-1.5*m)*100)/100,dt=Math.round((P+1.5*m)*100)/100,Tt=Math.round((P+3*m)*100)/100):i.includes("SELL")&&(C=Math.round((P+1.5*m)*100)/100,dt=Math.round((P-1.5*m)*100)/100,Tt=Math.round((P-3*m)*100)/100);return{type:i,confluenceScore:s,winProbability:S,entryText:H,entryMid:P,sl:C,tp1:dt,tp2:Tt,atr:m,rsi:y,adx:r?.adx||20,ema10:r?.ema10||k,sma20:r?.sma20||k}},[u,q,st,d,k]),Ne=R(()=>ye>0?ye:!h||!h.sl?0:Math.abs(h.entryMid-h.sl),[ye,h]),Ke=R(()=>te==="percent"?Ot*Qt/100:ee,[Ot,Qt,ee,te]),Co=R(()=>Ot<=0?0:te==="usd"?ee/Ot*100:Qt,[Ot,Qt,ee,te]),Ao=R(()=>Ne<=0?0:Ke/(Ne*(ve==="standard"?100:ve==="mini"?10:1)),[Ke,Ne,ve]),Io=R(()=>{if(!h)return{};let t=h.type,a=h.winProbability,r="var(--yellow)";return t.includes("BUY")?r="var(--green)":t.includes("SELL")&&(r="var(--red)"),{background:`conic-gradient(${r} 0% ${a}%, var(--bg3) ${a}% 100%)`}},[h]),$a=(t,a)=>{let r=a.replace(/\D/g,"").slice(-1),n=it.split("");for(;n.length<6;)n.push("");n[t]=r;let l=n.join("");et(l),r&&t<5&&Lt.current[t+1]?.focus()},Ya=(t,a)=>{if(a.key==="Backspace"){let r=it.split("");for(;r.length<6;)r.push("");!r[t]&&t>0?(r[t-1]="",et(r.join("")),Lt.current[t-1]?.focus()):(r[t]="",et(r.join("")))}},F=(()=>{let t=V;if(!t)return 0;let a=0;return t.length>=6&&a++,t.length>=10&&a++,/[A-Z]/.test(t)&&/[0-9]/.test(t)&&a++,a})(),qe=300,Va=qe>0?j/qe:0,Je=2*Math.PI*22,ja=Je*(1-Va);return la?o("div",{className:"auth-container",children:[e("div",{className:"auth-grid-overlay"}),o("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"20px",position:"relative",zIndex:1},children:[e("div",{className:"auth-logo-ring",children:e("img",{src:"/frontend/logo.png",alt:"XAU Logo",className:"auth-logo-img"})}),e("div",{style:{color:"var(--gold)",fontWeight:"800",fontSize:"14px",letterSpacing:"2px",textTransform:"uppercase"},children:"\u0110ang kh\u1EDFi \u0111\u1ED9ng h\u1EC7 th\u1ED1ng..."}),e("div",{className:"load-bar",style:{width:"220px"},children:e("div",{className:"load-fill"})})]})]}):D?o("div",{className:"root",children:[o("header",{className:"topbar",children:[e("div",{className:"topbar-left",children:o("div",{className:"brand",style:{display:"flex",alignItems:"center"},children:[e("img",{src:"/frontend/logo.png",alt:"XAU Logo",style:{width:"45px",height:"45px",borderRadius:"8px",marginRight:"8px",filter:"drop-shadow(0 0 8px rgba(255, 171, 0, 0.4))"}}),e("span",{className:"brand-name",children:"H\u1EC6 TH\u1ED0NG GIAO D\u1ECACH V\xC0NG CHUY\xCAN NGHI\u1EC6P XAU/USD"}),e("span",{className:"brand-badge",children:"D\u1EEE LI\u1EC6U TH\u1EDCI GIAN TH\u1EF0C MILLISECOND"})]})}),o("div",{className:"topbar-right",children:[e("span",{className:"clock",children:La||"00:00:00 UTC"}),D&&o("div",{className:"user-profile-chip",style:{display:"flex",alignItems:"center",gap:"8px",background:"rgba(255, 215, 0, 0.04)",border:"1px solid rgba(255, 215, 0, 0.12)",padding:"4px 12px",borderRadius:"8px",marginRight:"10px",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.03)"},children:[o("span",{style:{fontSize:"11px",color:"var(--text2)",fontWeight:"600"},children:["\u{1F464} ",D.email]}),e("div",{style:{width:"1px",height:"12px",background:"rgba(255,255,255,0.12)",margin:"0 4px"}}),e("button",{type:"button",onClick:Ta,style:{background:"transparent",border:"none",color:"#ff1744",fontSize:"11px",fontWeight:"700",cursor:"pointer",padding:"2px 6px",borderRadius:"4px",display:"flex",alignItems:"center",gap:"4px",transition:"all 0.2s ease"},onMouseOver:t=>{t.currentTarget.style.background="rgba(255, 23, 68, 0.1)"},onMouseOut:t=>{t.currentTarget.style.background="transparent"},children:"\u{1F6AA} \u0110\u0103ng xu\u1EA5t"})]}),e("button",{className:`tf-btn ${J?"active":""}`,style:{borderColor:J?"var(--green)":"rgba(255,255,255,0.05)",background:J?"rgba(0, 230, 118, 0.12)":"var(--bg3)",color:J?"var(--green)":"var(--text)",marginRight:"10px",fontWeight:J?"600":"normal",cursor:"pointer"},onClick:()=>Aa(!J),children:J?"\u{1F514} B\xE1o \xC2m: B\u1EACT":"\u{1F515} B\xE1o \xC2m: T\u1EAET"}),e("button",{className:"tf-btn",style:{borderColor:"rgba(255,255,255,0.05)",background:"var(--bg3)",color:"var(--text)"},onClick:Te,children:"\u{1F504} T\u1EA3i L\u1EA1i"})]})]}),o("div",{className:"layout",children:[!ct&&o("aside",{className:"sidebar",children:[e("header",{className:"sb-header hide-on-mobile",children:e("div",{className:"gold-profile-card",children:e("div",{className:"g-title",children:"\u{1F7E1} V\xC0NG SPOT (XAU/USD)"})})}),o("div",{style:{padding:"16px",flex:1,display:"flex",flexDirection:"column",gap:"16px",overflowY:"auto"},children:[u&&e("div",{className:"sug-card hide-on-mobile",style:{display:"flex",justifyContent:"center",alignItems:"center",padding:"16px",background:"rgba(20, 24, 33, 0.45)",backdropFilter:"blur(8px)",border:"1px solid rgba(255, 215, 0, 0.08)",boxShadow:"0 8px 32px rgba(0, 0, 0, 0.25)"},children:e("img",{src:"/frontend/logo.png",alt:"Xtreme Algo Union Logo",style:{width:"100%",maxWidth:"220px",height:"auto",borderRadius:"12px",filter:"drop-shadow(0 0 16px rgba(255, 171, 0, 0.25))",transition:"all 0.3s ease"},onMouseOver:t=>{t.currentTarget.style.filter="drop-shadow(0 0 24px rgba(255, 171, 0, 0.5))",t.currentTarget.style.transform="scale(1.02)"},onMouseOut:t=>{t.currentTarget.style.filter="drop-shadow(0 0 16px rgba(255, 171, 0, 0.25))",t.currentTarget.style.transform="scale(1)"}})}),st?h&&o("div",{className:"sug-card",style:{borderTop:"3px solid var(--gold)",background:"rgba(20, 24, 33, 0.65)",backdropFilter:"blur(12px)"},children:[o("div",{className:"sug-title",style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e("span",{style:{display:"flex",alignItems:"center",gap:"6px"},children:"\u2728 CH\u1EC8 B\xC1O H\u1EE2P L\u01AFU K\u1EF8 THU\u1EACT"}),e("span",{style:{fontSize:"9px",background:"rgba(255, 171, 0, 0.15)",color:"var(--gold)",padding:"2px 6px",borderRadius:"4px",fontWeight:"bold"},children:"PRO FEED"})]}),e("div",{style:{display:"flex",alignItems:"center",gap:"16px",margin:"14px 0",background:"rgba(255,255,255,0.02)",padding:"10px",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.04)"},children:o("div",{style:{flex:1},children:[e("span",{style:{fontSize:"10px",color:"var(--text2)",textTransform:"uppercase",display:"block"},children:"Khuy\u1EBFn ngh\u1ECB h\u1EE3p l\u01B0u"}),e("span",{className:`sug-val ${h.type.includes("BUY")?"buy":h.type.includes("SELL")?"sell":""}`,style:{fontSize:"15px",fontWeight:"800",marginTop:"2px",display:"block"},children:h.type==="STRONG_BUY"?"\u{1F7E2} MUA M\u1EA0NH (STRONG BUY)":h.type==="BUY"?"\u{1F7E2} MUA V\xC0O (BUY)":h.type==="STRONG_SELL"?"\u{1F534} B\xC1N M\u1EA0NH (STRONG SELL)":h.type==="SELL"?"\u{1F534} B\xC1N RA (SELL)":"\u{1F7E1} TRUNG L\u1EACP (NEUTRAL)"})]})}),o("div",{className:"sug-grid",style:{gap:"8px"},children:[o("div",{className:"sug-item",children:[e("span",{className:"sug-label",children:"ENTRY"}),e("span",{className:"sug-val entry",style:{fontSize:"11.5px",letterSpacing:"-0.2px"},children:h.entryText})]}),o("div",{className:"sug-item",children:[e("span",{className:"sug-label",children:"\u0110i\u1EC3m C\u1EAFt l\u1ED7 (SL)"}),e("span",{className:"sug-val sl",style:{fontSize:"11.5px"},children:h.sl>0?`$${h.sl.toFixed(2)}`:"\u2014"})]}),o("div",{className:"sug-item",children:[e("span",{className:"sug-label",children:"Ch\u1ED1t l\u1EDDi 1 (TP1)"}),e("span",{className:"sug-val tp",style:{fontSize:"11.5px"},children:h.tp1>0?`$${h.tp1.toFixed(2)}`:"\u2014"})]}),o("div",{className:"sug-item",children:[e("span",{className:"sug-label",children:"Ch\u1ED1t l\u1EDDi 2 (TP2)"}),e("span",{className:"sug-val tp",style:{fontSize:"11.5px"},children:h.tp2>0?`$${h.tp2.toFixed(2)}`:"\u2014"})]}),e("div",{className:"sug-item",style:{gridColumn:"span 2"},children:o("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"8px",borderTop:"1px solid rgba(255,255,255,0.05)",paddingTop:"8px",marginTop:"4px"},children:[o("div",{children:[e("span",{className:"sug-label",style:{fontSize:"9px"},children:"T\u1EF7 l\u1EC7 r\u1EE7i ro/l\u1EE3i nhu\u1EADn:"}),e("strong",{style:{color:"#fff",display:"block",fontSize:"11px",marginTop:"2px",fontFamily:"monospace"},children:"1:1.5 \u2794 1:3.0"})]}),o("div",{children:[e("span",{className:"sug-label",style:{fontSize:"9px"},children:"H\u1EC7 s\u1ED1 bi\u1EBFn \u0111\u1ED9ng (ATR):"}),o("strong",{style:{color:"var(--gold)",display:"block",fontSize:"11px",marginTop:"2px",fontFamily:"monospace"},children:["$",h.atr.toFixed(2)]})]})]})}),o("div",{className:"sug-item",style:{gridColumn:"span 2",background:"rgba(255, 255, 255, 0.01)",padding:"8px",borderRadius:"6px",border:"1px solid rgba(255, 255, 255, 0.03)",marginTop:"4px"},children:[e("span",{className:"sug-label",style:{fontSize:"9.5px",marginBottom:"6px",display:"block"},children:"H\u1EE3p l\u01B0u \u0111a khung th\u1EDDi gian:"}),e("div",{style:{display:"grid",gridTemplateColumns:"repeat(5, 1fr)",gap:"4px",textAlign:"center"},children:[{id:"1",label:"M1"},{id:"5",label:"M5"},{id:"15",label:"M15"},{id:"60",label:"H1"},{id:"1D",label:"D1"}].map(t=>{let a=u?.multiTimeframeSignals?.[t.id]||"NEUTRAL",r="var(--text3)",n="rgba(255, 255, 255, 0.03)",l="TRUNG L\u1EACP";a.includes("BUY")?(r="var(--green)",n="rgba(0, 230, 118, 0.08)",l=a==="STRONG_BUY"?"MUA M\u1EA0NH":"MUA"):a.includes("SELL")?(r="var(--red)",n="rgba(255, 23, 68, 0.08)",l=a==="STRONG_SELL"?"B\xC1N M\u1EA0NH":"B\xC1N"):(r="var(--yellow)",n="rgba(255, 171, 0, 0.08)",l="TRUNG L\u1EACP");let s=d===t.id;return o("div",{onClick:()=>{z(),Q(t.id)},style:{background:n,border:s?"1px solid var(--gold)":"1px solid rgba(255,255,255,0.04)",borderRadius:"4px",padding:"4px 1px",cursor:"pointer",transition:"all 0.15s ease",boxShadow:s?"0 0 6px rgba(255, 171, 0, 0.12)":"none"},onMouseOver:i=>{i.currentTarget.style.transform="scale(1.03)",i.currentTarget.style.borderColor="var(--gold)"},onMouseOut:i=>{i.currentTarget.style.transform="scale(1)",i.currentTarget.style.borderColor=s?"var(--gold)":"rgba(255,255,255,0.04)"},children:[e("span",{style:{fontSize:"9px",fontWeight:"800",color:s?"var(--gold)":"#fff",display:"block"},children:t.label}),e("span",{style:{fontSize:"6.5px",color:r,display:"block",marginTop:"2px",fontWeight:"bold",whiteSpace:"nowrap"},children:l})]},t.id)})})]})]})]}):o("div",{className:"sug-card",style:{borderTop:"3px solid rgba(255, 171, 0, 0.3)",background:"rgba(20, 24, 33, 0.45)",backdropFilter:"blur(12px)",padding:"24px 16px",textAlign:"center",borderRadius:"8px",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"12px",border:"1px solid rgba(255, 171, 0, 0.15)",boxShadow:"0 8px 32px rgba(0,0,0,0.4)"},children:[e("div",{style:{width:"44px",height:"44px",borderRadius:"50%",background:"rgba(255, 171, 0, 0.1)",display:"flex",alignItems:"center",justifyContent:"center",border:"1px dashed var(--gold)",boxShadow:"0 0 15px rgba(255, 171, 0, 0.2)",animation:"aiDotBlink 1.5s infinite alternate"},children:e("span",{style:{fontSize:"18px"},children:"\u26A1"})}),e("h4",{style:{color:"#fff",margin:"4px 0 0 0",fontSize:"13px",fontWeight:"800",letterSpacing:"0.2px"},children:"CH\u1EC8 B\xC1O \u0110ANG KH\xD3A"}),o("p",{style:{color:"var(--text2)",fontSize:"11px",lineHeight:"1.5",margin:0},children:["Ch\u1EC9 b\xE1o h\u1EE3p l\u01B0u k\u1EF9 thu\u1EADt \u0111ang t\u1EA1m \u1EA9n. Vui l\xF2ng b\u1EA5m v\xE0o tab ",e("strong",{style:{color:"var(--gold)"},children:"\u{1F916} Ph\xE2n t\xEDch A.I"})," v\xE0 kh\u1EDFi ch\u1EA1y \u0111\u1EC3 k\xEDch ho\u1EA1t \u0111\u1ED3ng b\u1ED9 d\u1EEF li\u1EC7u."]})]})]})]}),o("main",{className:"main",children:[o("div",{className:"sym-header",children:[o("div",{className:"sym-info",children:[o("div",{className:"sym-title-wrap",children:[e("span",{className:"sym-title",children:"GOLD (XAU/USD)"}),e("span",{className:"sym-subtitle",children:"V\xE0ng giao ngay / \u0110\xF4 la M\u1EF9"})]}),o("div",{className:"price-info",children:[o("span",{className:"price-current",children:["$",k.toFixed(2)]}),o("span",{className:`price-change ${fe>=0?"up":"down"}`,children:[fe>=0?"+":"",fe.toFixed(3),"%"]})]})]}),e("div",{className:"hide-on-mobile",style:{display:"flex",gap:"4px",background:"var(--bg3)",padding:"3px",borderRadius:"6px",border:"1px solid var(--border)",marginLeft:"auto",marginRight:"6px"},children:[{id:"1",name:"M1"},{id:"5",name:"M5"},{id:"15",name:"M15"},{id:"60",name:"1H"},{id:"1D",name:"1D"}].map(t=>e("button",{onClick:()=>{z(),Q(t.id)},style:{background:d===t.id?"var(--yellow)":"transparent",border:"none",borderRadius:"4px",padding:"4px 8px",fontSize:"11px",fontWeight:"bold",color:d===t.id?"#000":"var(--text2)",cursor:"pointer",transition:"all 0.15s ease"},children:t.name},t.id))}),e("div",{style:{display:"flex",gap:"6px",alignItems:"center",marginLeft:"6px"},children:e("button",{onClick:()=>{z(),_("tradingview")},className:`tf-btn ${M==="tradingview"?"active":""}`,style:{background:M==="tradingview"?"var(--yellow)":"var(--bg3)",borderColor:M==="tradingview"?"var(--yellow)":"rgba(255,255,255,0.05)",color:M==="tradingview"?"#000":"var(--text2)",fontWeight:"bold",cursor:"pointer",fontSize:"11px",padding:"5px 12px",borderRadius:"4px",transition:"all 0.2s ease"},children:"\u{1F4CA} BI\u1EC2U \u0110\u1ED2 TRADINGVIEW"})})]}),aa&&e("div",{className:"load-bar",children:e("div",{className:"load-fill"})}),Ae&&o("div",{className:"err-msg",children:["\u26A0\uFE0F L\u1ED7i: ",Ae]}),o("div",{className:"main-workspace",children:[e("div",{className:`chart-column ${ct?"full-chart-active":""}`,children:e("div",{className:"chart-wrap",style:{height:"100%",width:"100%",display:"flex",flexDirection:"column",position:"relative"},children:M==="tradingview"?o(X,{children:[e(Ka,{timeframe:d}),za&&o("div",{className:"tv-guide-overlay",children:[o("div",{className:"tv-guide-header",children:[o("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:[e("span",{className:"tv-guide-icon",children:"\u{1F4A1}"}),e("span",{className:"tv-guide-title",children:"M\u1EB9o: B\u1EADt \u0110\u1EBFm Ng\u01B0\u1EE3c \u0110\xF3ng N\u1EBFn Tr\xEAn Chart"})]}),e("button",{className:"tv-guide-close",onClick:()=>Ea(!1),children:"\xD7"})]}),o("div",{className:"tv-guide-body",children:["\u0110\u1EC3 ch\u1EA1y \u0111\u1EBFm ng\u01B0\u1EE3c n\u1EBFn th\u1EDDi gian th\u1EF1c \u1EDF d\u01B0\u1EDBi t\u1EF7 gi\xE1 ",o("strong",{style:{color:"var(--green)"},children:["$",k.toFixed(2)]}),":",o("ol",{className:"tv-guide-steps",children:[o("li",{children:[e("strong",{children:"Click chu\u1ED9t ph\u1EA3i"})," v\xE0o v\xF9ng c\u1ED9t t\u1EF7 gi\xE1 b\xEAn ph\u1EA3i bi\u1EC3u \u0111\u1ED3."]}),o("li",{children:["Ch\u1ECDn d\xF2ng ",e("strong",{style:{color:"var(--gold)"},children:'"\u0110\u1EBFm ng\u01B0\u1EE3c t\u1EDBi khi \u0111\xF3ng n\u1EBFn" (Countdown to bar close)'}),"."]})]}),e("div",{className:"tv-guide-footer",children:"\u2713 T\u1EF1 \u0111\u1ED9ng l\u01B0u v\xE0 ho\u1EA1t \u0111\u1ED9ng v\u0129nh vi\u1EC5n tr\xEAn tr\xECnh duy\u1EC7t c\u1EE7a b\u1EA1n!"})]})]})]}):o("div",{style:{position:"relative",width:"100%",height:"100%",flex:1,display:"flex",flexDirection:"column",background:"#131722",overflow:"hidden"},children:[c?o("svg",{className:"chart-svg",ref:St,width:"100%",height:"100%",viewBox:`0 0 ${c.width} ${c.height}`,preserveAspectRatio:"none",onMouseDown:Ua,onMouseMove:Wa,onMouseUp:je,onMouseLeave:je,onDoubleClick:Ga,style:{cursor:ae.current?"grabbing":"crosshair",userSelect:"none"},children:[e("defs",{children:o("filter",{id:"glow",x:"-20%",y:"-20%",width:"140%",height:"140%",children:[e("feGaussianBlur",{stdDeviation:"3",result:"blur"}),o("feMerge",{children:[e("feMergeNode",{in:"blur"}),e("feMergeNode",{in:"SourceGraphic"})]})]})}),c.priceLabels.map((t,a)=>o("g",{children:[e("line",{x1:c.paddingLeft,y1:t.y,x2:c.width-c.paddingRight,y2:t.y,stroke:"rgba(255, 255, 255, 0.03)",strokeWidth:"1"}),o("text",{x:c.width-c.paddingRight+8,y:t.y+4,fill:"var(--text3)",fontSize:"10px",fontFamily:"monospace",children:["$",t.price.toFixed(2)]})]},`grid-y-${a}`)),c.timeLabels.map((t,a)=>o("g",{children:[e("line",{x1:t.x,y1:0,x2:t.x,y2:c.height-c.paddingBottom,stroke:"rgba(255, 255, 255, 0.02)",strokeWidth:"1"}),e("text",{x:t.x-18,y:c.height-12,fill:"var(--text3)",fontSize:"9.5px",fontFamily:"monospace",children:t.label})]},`grid-x-${a}`)),h&&(()=>{let t=c.getY(h.entryMid),a=c.getY(h.sl),r=c.getY(h.tp2),n=c.paddingLeft,l=c.width-c.paddingRight;return o(X,{children:[e("rect",{x:n,y:Math.min(t,a),width:l-n,height:Math.abs(t-a),fill:"rgba(255, 23, 68, 0.06)",stroke:"rgba(255, 23, 68, 0.15)",strokeWidth:"1",strokeDasharray:"2,2"}),e("rect",{x:n,y:Math.min(t,r),width:l-n,height:Math.abs(t-r),fill:"rgba(0, 230, 118, 0.06)",stroke:"rgba(0, 230, 118, 0.15)",strokeWidth:"1",strokeDasharray:"2,2"})]})})(),u?.advancedAnalysis&&(()=>{let t=u.advancedAnalysis,a=c.paddingLeft,r=c.width-c.paddingRight;return o("g",{id:"smc-dynamic-structures",children:[t.orderBlocks?.map((n,l)=>{let s=n.index,i=n.mitigated?Math.min(x.length-1,n.index+10):x.length-1,f=c.getX(s-G),g=c.getX(i-G),b=Math.max(a,f),v=Math.min(r,g);if(b>=v)return null;let w=c.getY(n.high),m=c.getY(n.low),y=Math.min(w,m),L=Math.abs(w-m),S=n.type==="BULLISH",E=S?"rgba(0, 230, 118, 0.06)":"rgba(255, 23, 68, 0.06)",O=S?"rgba(0, 230, 118, 0.22)":"rgba(255, 23, 68, 0.22)",H=S?"+OB BULLISH":"-OB BEARISH",C=S?"rgba(0, 230, 118, 0.8)":"rgba(255, 23, 68, 0.8)";return o("g",{children:[e("rect",{x:b,y,width:v-b,height:L,fill:E,stroke:O,strokeWidth:"1"}),v-b>50&&e("text",{x:b+6,y:y+11,fill:C,fontSize:"8px",fontWeight:"bold",fontFamily:"monospace",pointerEvents:"none",children:H})]},`ob-${l}`)}),t.fvgs?.map((n,l)=>{let s=Math.max(0,n.index-2),i=n.mitigated?Math.min(x.length-1,n.index+6):x.length-1,f=c.getX(s-G),g=c.getX(i-G),b=Math.max(a,f),v=Math.min(r,g);if(b>=v)return null;let w=c.getY(n.top),m=c.getY(n.bottom),y=Math.min(w,m),L=Math.abs(w-m),S=n.type==="BULLISH",E=S?"rgba(0, 188, 212, 0.04)":"rgba(233, 30, 99, 0.04)",O=S?"rgba(0, 188, 212, 0.16)":"rgba(233, 30, 99, 0.16)",H=S?"FVG BULLISH":"FVG BEARISH",C=S?"rgba(0, 188, 212, 0.65)":"rgba(233, 30, 99, 0.65)";return o("g",{children:[e("rect",{x:b,y,width:v-b,height:L,fill:E,stroke:O,strokeWidth:"0.8",strokeDasharray:"2,2"}),v-b>50&&L>6&&e("text",{x:b+6,y:y+9,fill:C,fontSize:"7.5px",fontWeight:"bold",fontFamily:"monospace",pointerEvents:"none",children:H})]},`fvg-${l}`)}),t.structureShifts?.map((n,l)=>{let s=x.findIndex(L=>L.time===n.time);if(s===-1)return null;let i=Math.min(x.length-1,s+20),f=c.getX(s-G),g=c.getX(i-G),b=Math.max(a,f),v=Math.min(r,g);if(b>=v)return null;let w=c.getY(n.price),m=n.direction==="BULLISH",y=m?"var(--green)":"var(--red)";return o("g",{children:[e("line",{x1:b,y1:w,x2:v,y2:w,stroke:y,strokeWidth:"1.2",strokeDasharray:"3,3",opacity:"0.85"}),o("g",{transform:`translate(${b+6}, ${w-6})`,children:[e("rect",{x:"-3",y:"-2",width:"48",height:"12",rx:"3",fill:"rgba(19, 23, 34, 0.95)",stroke:y,strokeWidth:"0.8"}),o("text",{x:"21",y:"7",textAnchor:"middle",fill:y,fontSize:"7.5px",fontWeight:"bold",fontFamily:"monospace",children:[n.type," ",m?"\u2197":"\u2198"]})]})]},`shift-${l}`)}),t.sweeps?.map((n,l)=>{let s=x.findIndex(b=>b.time===n.time);if(s===-1)return null;let i=c.getX(s-G);if(i<a||i>r)return null;let f=c.getY(n.price),g=n.type==="SSL";return o("g",{children:[e("line",{x1:i-4,y1:f-4,x2:i+4,y2:f+4,stroke:"var(--yellow)",strokeWidth:"1.5"}),e("line",{x1:i+4,y1:f-4,x2:i-4,y2:f+4,stroke:"var(--yellow)",strokeWidth:"1.5"}),e("text",{x:i,y:g?f+14:f-10,textAnchor:"middle",fill:"var(--yellow)",fontSize:"7.5px",fontWeight:"bold",fontFamily:"monospace",pointerEvents:"none",children:g?"SSL SWEEP":"BSL SWEEP"})]},`sweep-${l}`)})]})})(),Z.map((t,a)=>{let r=c.getX(a),n=c.getY(t.high),l=c.getY(t.low),s=c.getY(t.open),i=c.getY(t.close),g=t.close>=t.open?"var(--green)":"var(--red)";return o("g",{children:[e("line",{x1:r,y1:n,x2:r,y2:l,stroke:g,strokeWidth:"1.5"}),e("rect",{x:r-c.bodyWidth/2,y:Math.min(s,i),width:c.bodyWidth,height:Math.max(1.5,Math.abs(s-i)),fill:g,stroke:g,strokeWidth:"0.5"})]},`candle-${a}`)}),vt&&(()=>{let t="";for(let a=0;a<Z.length;a++){let r=G+a,n=Pa[r];if(n){let l=c.getX(a),s=c.getY(n);t===""?t+=`M ${l} ${s}`:t+=` L ${l} ${s}`}}return t?e("path",{d:t,fill:"none",stroke:zt,strokeWidth:"2",opacity:"0.85"}):null})(),yt&&(()=>{let t="";for(let a=0;a<Z.length;a++){let r=G+a,n=Ra[r];if(n){let l=c.getX(a),s=c.getY(n);t===""?t+=`M ${l} ${s}`:t+=` L ${l} ${s}`}}return t?e("path",{d:t,fill:"none",stroke:Et,strokeWidth:"2.2",opacity:"0.85"}):null})(),Ue&&(()=>{let{i1:t,price1:a,i2:r,price2:n}=Ue,l=(n-a)/(r-t),s=c.getX(t-G),i=c.getY(a),g=x.length-1+10,b=c.getX(g-G),v=c.getY(a+l*(g-t));return o("g",{children:[e("line",{x1:s,y1:i,x2:b,y2:v,stroke:"var(--gold)",strokeWidth:"2.5",strokeDasharray:"6,4",filter:"url(#glow)"}),e("circle",{cx:s,cy:i,r:"4",fill:"var(--gold)",stroke:"#000",strokeWidth:"1"}),e("circle",{cx:c.getX(r-G),cy:c.getY(n),r:"4",fill:"var(--gold)",stroke:"#000",strokeWidth:"1"}),o("text",{x:Math.max(s+10,c.width-c.paddingRight-180),y:v-10,fill:"var(--gold)",fontSize:"10px",fontWeight:"bold",fontFamily:"monospace",opacity:"0.9",children:["\u2198 \u0110\u01AF\u1EDCNG XU H\u01AF\u1EDANG GI\u1EA2M ",d==="1D"?"D1":d==="1W"?"W1":d==="1M"?"MN":`M${d}`," (SMC)"]})]})})(),h&&(()=>{let t=c.getY(h.entryMid),a=c.getY(h.sl),r=c.getY(h.tp1),n=c.getY(h.tp2),l=c.paddingLeft,s=c.width-c.paddingRight;return o("g",{children:[e("line",{x1:l,y1:a,x2:s,y2:a,stroke:"var(--red)",strokeWidth:"1.2",strokeDasharray:"4,4"}),e("rect",{x:s+4,y:a-8,width:"60",height:"16",rx:"3",fill:"rgba(255, 23, 68, 0.2)",stroke:"var(--red)",strokeWidth:"1"}),o("text",{x:s+8,y:a+4,fill:"var(--red)",fontSize:"9px",fontWeight:"bold",fontFamily:"monospace",children:["SL:$",h.sl.toFixed(1)]}),e("line",{x1:l,y1:t,x2:s,y2:t,stroke:"var(--gold)",strokeWidth:"1.5",strokeDasharray:"4,4"}),e("rect",{x:s+4,y:t-8,width:"60",height:"16",rx:"3",fill:"rgba(255, 171, 0, 0.2)",stroke:"var(--gold)",strokeWidth:"1"}),o("text",{x:s+8,y:t+4,fill:"var(--gold)",fontSize:"9px",fontWeight:"bold",fontFamily:"monospace",children:["ENT:$",h.entryMid.toFixed(1)]}),e("line",{x1:l,y1:r,x2:s,y2:r,stroke:"var(--green)",strokeWidth:"1.2",strokeDasharray:"4,4"}),e("rect",{x:s+4,y:r-8,width:"60",height:"16",rx:"3",fill:"rgba(0, 230, 118, 0.15)",stroke:"var(--green)",strokeWidth:"1"}),o("text",{x:s+8,y:r+4,fill:"var(--green)",fontSize:"9px",fontWeight:"bold",fontFamily:"monospace",children:["TP1:$",h.tp1.toFixed(1)]}),e("line",{x1:l,y1:n,x2:s,y2:n,stroke:"var(--green)",strokeWidth:"1.2",strokeDasharray:"4,4"}),e("rect",{x:s+4,y:n-8,width:"60",height:"16",rx:"3",fill:"rgba(0, 230, 118, 0.15)",stroke:"var(--green)",strokeWidth:"1"}),o("text",{x:s+8,y:n+4,fill:"var(--green)",fontSize:"9px",fontWeight:"bold",fontFamily:"monospace",children:["TP2:$",h.tp2.toFixed(1)]})]})})()]}):e("div",{className:"chart-empty",style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"var(--text3)"},children:"\u0110ang d\u1EF1ng bi\u1EC3u \u0111\u1ED3 k\u1EF9 thu\u1EADt..."}),o("div",{className:"chart-ema-legend",onMouseDown:t=>t.stopPropagation(),onMouseMove:t=>t.stopPropagation(),children:[o("div",{className:"ema-legend-row",children:[e("span",{className:"ema-legend-dot",style:{backgroundColor:zt,color:zt}}),o("span",{className:"ema-legend-name",style:{color:vt?"#fff":"var(--text3)"},children:["EMA ",Mt," ",e("span",{style:{opacity:.6,fontSize:"9.5px"},children:At})]}),o("div",{className:"ema-legend-actions",children:[e("button",{className:`ema-action-btn ${vt?"active":""}`,onClick:()=>pa(!vt),title:vt?"\u1EA8n \u0111\u01B0\u1EDDng EMA":"Hi\u1EC7n \u0111\u01B0\u1EDDng EMA",children:vt?o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e("circle",{cx:"12",cy:"12",r:"3"})]}):o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("path",{d:"M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"}),e("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}),e("button",{className:"ema-action-btn",onClick:()=>Pt("ema50"),title:"C\xE0i \u0111\u1EB7t th\xF4ng s\u1ED1 (Length, Source, Color)",children:o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("circle",{cx:"12",cy:"12",r:"3"}),e("path",{d:"M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"})]})}),e("button",{className:"ema-action-btn open-source-btn",onClick:()=>{Xt("ema50"),_t("pine")},title:"Xem m\xE3 ngu\u1ED3n m\u1EDF ch\u1EC9 b\xE1o",children:o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("polyline",{points:"16 18 22 12 16 6"}),e("polyline",{points:"8 6 2 12 8 18"})]})})]})]}),o("div",{className:"ema-legend-row",children:[e("span",{className:"ema-legend-dot",style:{backgroundColor:Et,color:Et}}),o("span",{className:"ema-legend-name",style:{color:yt?"#fff":"var(--text3)"},children:["EMA ",Ct," ",e("span",{style:{opacity:.6,fontSize:"9.5px"},children:It})]}),o("div",{className:"ema-legend-actions",children:[e("button",{className:`ema-action-btn ${yt?"active":""}`,onClick:()=>ca(!yt),title:yt?"\u1EA8n \u0111\u01B0\u1EDDng EMA":"Hi\u1EC7n \u0111\u01B0\u1EDDng EMA",children:yt?o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e("circle",{cx:"12",cy:"12",r:"3"})]}):o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("path",{d:"M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"}),e("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}),e("button",{className:"ema-action-btn",onClick:()=>Pt("ema200"),title:"C\xE0i \u0111\u1EB7t th\xF4ng s\u1ED1 (Length, Source, Color)",children:o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("circle",{cx:"12",cy:"12",r:"3"}),e("path",{d:"M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"})]})}),e("button",{className:"ema-action-btn open-source-btn",onClick:()=>{Xt("ema200"),_t("pine")},title:"Xem m\xE3 ngu\u1ED3n m\u1EDF ch\u1EC9 b\xE1o",children:o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("polyline",{points:"16 18 22 12 16 6"}),e("polyline",{points:"8 6 2 12 8 18"})]})})]})]})]}),lt&&e("div",{className:"chart-overlay-modal",style:{pointerEvents:"auto"},onMouseDown:t=>t.stopPropagation(),onMouseMove:t=>t.stopPropagation(),children:o("div",{className:"chart-modal-card",children:[o("div",{className:"chart-modal-header",children:[o("span",{className:"chart-modal-title",children:["\u2699\uFE0F C\xE0i \u0110\u1EB7t Ch\u1EC9 B\xE1o: EMA ",lt==="ema50"?"50":"200"]}),e("button",{className:"chart-modal-close",onClick:()=>Pt(null),children:"\xD7"})]}),o("div",{className:"chart-modal-body",children:[o("div",{className:"settings-group",children:[e("label",{className:"settings-label",children:"Chu k\u1EF3 (Length)"}),o("div",{className:"settings-input-row",children:[e("input",{type:"number",min:"2",max:"500",className:"settings-number-input",value:ue,onChange:t=>xe(Math.max(2,parseInt(t.target.value)||2))}),e("span",{style:{fontSize:"11px",color:"var(--text3)"},children:"(2 - 500 n\u1EBFn)"})]})]}),o("div",{className:"settings-group",style:{marginTop:"12px"},children:[e("label",{className:"settings-label",children:"Ngu\u1ED3n gi\xE1 tr\u1ECB (Source)"}),e("div",{className:"settings-input-row",children:o("select",{className:"settings-select",value:be,onChange:t=>me(t.target.value),children:[e("option",{value:"close",children:"\u0110\xF3ng c\u1EEDa (Close)"}),e("option",{value:"open",children:"M\u1EDF c\u1EEDa (Open)"}),e("option",{value:"high",children:"Cao nh\u1EA5t (High)"}),e("option",{value:"low",children:"Th\u1EA5p nh\u1EA5t (Low)"})]})})]}),o("div",{className:"settings-group",style:{marginTop:"12px"},children:[e("label",{className:"settings-label",children:"M\xE0u \u0111\u01B0\u1EDDng ch\u1EC9 b\xE1o (Color)"}),e("div",{className:"settings-colors-grid",children:["#FFD700","#00e5ff","#FF1744","#d500f9","#00e676","#ff9100","#ffffff","#787b86"].map(t=>e("div",{className:`settings-color-dot ${Kt===t?"active":""}`,style:{backgroundColor:t},onClick:()=>qt(t)},t))}),o("div",{style:{marginTop:"10px",width:"100%"},children:[e("span",{style:{fontSize:"11px",color:"var(--text3)",display:"block",marginBottom:"4px"},children:"M\xE3 m\xE0u HEX t\xF9y ch\u1EC9nh:"}),e("input",{type:"text",className:"settings-number-input",style:{width:"120px"},value:Kt,onChange:t=>qt(t.target.value)})]})]})]}),o("div",{className:"chart-modal-footer",children:[e("button",{className:"modal-btn cancel",onClick:()=>Pt(null),children:"H\u1EE7y b\u1ECF"}),e("button",{className:"modal-btn apply",onClick:fa,children:"\xC1p d\u1EE5ng"})]})]})}),jt&&(()=>{let t=jt==="ema50"?Mt:Ct,a=jt==="ema50"?At:It,n=`//@version=5
...
plot(emaValue, title="EMA Line", color=color.from_hex("${jt==="ema50"?zt:Et}"), linewidth=2)`,l=`/**
