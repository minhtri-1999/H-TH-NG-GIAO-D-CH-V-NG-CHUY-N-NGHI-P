import{createRoot as qa}from"https://esm.sh/react-dom@18.2.0/client";import{createElement as Ja}from"https://esm.sh/react@18.2.0";import _a,{useState as c,useEffect as E,useRef as U,useMemo as D}from"https://esm.sh/react@18.2.0";import{Fragment as K,jsx as e,jsxs as o}from"https://esm.sh/react@18.2.0/jsx-runtime";function Ka({timeframe:p}){let rt=U(null);return E(()=>{if(!rt.current)return;rt.current.innerHTML="";let I="60";p==="1"?I="1":p==="5"?I="5":p==="15"?I="15":p==="60"?I="60":p==="1D"?I="D":p==="1W"?I="W":p==="1M"&&(I="M");let q=document.createElement("script");q.src="https://s3.tradingview.com/external-embedding/embed-widget-advanced-chart.js",q.type="text/javascript",q.async=!0,q.innerHTML=JSON.stringify({autosize:!0,symbol:"FOREXCOM:XAUUSD",interval:I,timezone:"Asia/Ho_Chi_Minh",theme:"dark",style:"1",locale:"vi",enable_publishing:!1,allow_symbol_change:!0,calendar:!0,hide_side_toolbar:!1,studies:[{id:"MAExp@tv-basicstudies",inputs:{length:50}},{id:"MAExp@tv-basicstudies",inputs:{length:200}}],support_host:"https://www.tradingview.com"}),rt.current.appendChild(q)},[p]),e("div",{className:"tradingview-widget-container",ref:rt,style:{height:"100%",width:"100%"},children:e("div",{className:"tradingview-widget-container__widget",style:{height:"100%",width:"100%"}})})}var Wt=p=>{let I=new Date(p+252e5),q=I.getUTCFullYear(),pt=String(I.getUTCMonth()+1).padStart(2,"0");return`${String(I.getUTCDate()).padStart(2,"0")}/${pt}/${q}`};function Le(){let[p,rt]=c("5"),[I,q]=c("tradingview"),[pt,ea]=c(!1),[x,Me]=c(null),[aa,Ce]=c(!0),[Ie,re]=c(null),[V,oa]=c(()=>{let t=localStorage.getItem("active_dash_tab");return t==="ai"||t==="backtest"||t==="outlook"?t:"ai"}),$t=t=>{oa(t),localStorage.setItem("active_dash_tab",t)},[Ae,ne]=c([]),[Qa,to]=c(!1),[nt,ra]=c(()=>localStorage.getItem("backtest_timeframe_filter")||"ALL"),na=t=>{ra(t),localStorage.setItem("backtest_timeframe_filter",t)},[ct,ia]=c(()=>localStorage.getItem("backtest_selected_day")||"ALL"),sa=t=>{ia(t),localStorage.setItem("backtest_selected_day",t)},tt=D(()=>{let t=[...Ae].sort((n,l)=>l.closeTime-n.closeTime),a=Wt(Date.now()),r=Wt(Date.now()-864e5);return ct==="TODAY"?t=t.filter(n=>Wt(n.closeTime)===a):ct==="YESTERDAY"&&(t=t.filter(n=>Wt(n.closeTime)===r)),nt==="ALL"?t:t.filter(n=>n.timeframe.toUpperCase()===nt.toUpperCase())},[Ae,nt,ct]),gt=D(()=>{if(tt.length===0)return{winRate:0,netPips:0,totalProfit:0,total:0};let t=tt.length,a=tt.filter(s=>s.status==="TP1"||s.status==="TP2").length,r=Math.round(a/t*100),n=Number(tt.reduce((s,i)=>s+(Number(i.pips)||0),0).toFixed(1)),l=Number(tt.reduce((s,i)=>s+(Number(i.profitUsd)||0),0).toFixed(2));return{winRate:r,netPips:n,totalProfit:l,total:t}},[tt]),ie=async(t=!1)=>{try{let a=await fetch("/api/backtest/history");if(a.ok){let r=await a.json();r.success&&r.trades&&ne(r.trades)}}catch(a){console.error("Error fetching backtest history:",a)}},eo=async()=>{try{let t=await fetch("/api/backtest/reset",{method:"POST"});if(t.ok){let a=await t.json();a.success&&a.trades&&ne(a.trades)}else alert("L\u1ED7i khi \u0111\u1ED3ng b\u1ED9 l\u1EA1i d\u1EEF li\u1EC7u n\u1EBFn.")}catch(t){alert("L\u1ED7i h\u1EC7 th\u1ED1ng: "+t.message)}},[H,ut]=c(null),[la,ze]=c(!1),[se,it]=c("login"),[J,le]=c(""),[X,de]=c(""),[st,et]=c(""),[Ee,M]=c(null),[Pe,z]=c(null),[_,Ft]=c(0),[xt,ht]=c(!1),[pe,at]=c(""),[mt,Gt]=c(!1),Nt=U([]),[W,Lt]=c(()=>{let t=localStorage.getItem("ai_active_trades");if(!t)return{};try{let a=JSON.parse(t);for(let r of Object.keys(a)){let n=a[r];if(n&&n.takeProfit&&(!n.takeProfit1||n.takeProfit1===n.takeProfit2)){let l=n.position==="BUY";n.takeProfit1=n.takeProfit;let s=8.5+Math.random()*5;n.takeProfit2=l?Math.round((n.takeProfit1+s)*100)/100:Math.round((n.takeProfit1-s)*100)/100}}return a}catch{return{}}}),[Yt,ce]=c(!1),[Vt,ge]=c(0),[da,bt]=c(""),[Mt,Re]=c(()=>localStorage.getItem("ai_analysis_triggered")==="true");E(()=>{localStorage.setItem("ai_active_trades",JSON.stringify(W))},[W]),E(()=>{localStorage.setItem("ai_analysis_triggered",String(Mt))},[Mt]);let[ft,pa]=c(!0),[vt,ca]=c(!0),[Ct,ga]=c(50),[It,ua]=c(200),[At,xa]=c("close"),[zt,ha]=c("close"),[Et,ma]=c("#FFD700"),[Pt,ba]=c("#FF1744"),[ao,oo]=c(!1),[ro,no]=c(!1),[io,so]=c(!1),[lo,po]=c(!1),[co,go]=c(!1),[lt,Rt]=c(null),[jt,Xt]=c(null),[Dt,_t]=c("pine"),[ue,xe]=c(50),[he,me]=c("close"),[Kt,qt]=c("#FFD700");E(()=>{lt==="ema50"?(xe(Ct),me(At),qt(Et)):lt==="ema200"&&(xe(It),me(zt),qt(Pt))},[lt]);let fa=()=>{lt==="ema50"?(ga(ue),xa(he),ma(Kt)):lt==="ema200"&&(ua(ue),ha(he),ba(Kt)),Rt(null)},va=async()=>{try{ze(!0);let t=await fetch("/api/auth/me");if(t.ok){let a=await t.json();a.authenticated&&a.email?ut({email:a.email}):ut(null)}else ut(null)}catch(t){console.error("Session check error:",t),ut(null)}finally{ze(!1)}};E(()=>{va()},[]),E(()=>{H&&ie(!1)},[H]),E(()=>{if(H&&(V==="ai"||V==="backtest")){ie(!0);let t=setInterval(()=>{ie(!1)},5e3);return()=>clearInterval(t)}},[V,H]),E(()=>{if(_<=0)return;let t=setInterval(()=>{Ft(a=>a-1)},1e3);return()=>clearInterval(t)},[_]);let ya=async t=>{if(t.preventDefault(),!J||!X){M("Vui l\xF2ng \u0111i\u1EC1n \u0111\u1EA7y \u0111\u1EE7 email v\xE0 m\u1EADt kh\u1EA9u.");return}ht(!0),M(null),z(null);try{let a=await fetch("/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:J,password:X})}),r=await a.json();if(!a.ok){a.status===403&&r.needsVerification?(it("otp"),Ft(300),r.isSimulator&&r.otp?(at(r.otp),z(`\u26A0\uFE0F [CH\u1EBE \u0110\u1ED8 TH\u1EEC NGHI\u1EC6M]: Ch\u01B0a c\u1EA5u h\xECnh Email API. M\xE3 OTP c\u1EE7a b\u1EA1n l\xE0: ${r.otp}`)):(at(""),z(r.error||"T\xE0i kho\u1EA3n ch\u01B0a k\xEDch ho\u1EA1t. M\u1ED9t m\xE3 OTP m\u1EDBi \u0111\xE3 \u0111\u01B0\u1EE3c g\u1EEDi v\u1EC1 email."))):M(r.error||"\u0110\u0103ng nh\u1EADp th\u1EA5t b\u1EA1i.");return}r.success&&(ut({email:r.user.email}),z("\u0110\u0103ng nh\u1EADp th\xE0nh c\xF4ng!"))}catch(a){M("L\u1ED7i k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7: "+a.message)}finally{ht(!1)}},wa=async t=>{if(t.preventDefault(),!J||!X){M("Vui l\xF2ng \u0111i\u1EC1n \u0111\u1EA7y \u0111\u1EE7 email v\xE0 m\u1EADt kh\u1EA9u.");return}if(X.length<6){M("M\u1EADt kh\u1EA9u ph\u1EA3i ch\u1EE9a \xEDt nh\u1EA5t 6 k\xFD t\u1EF1.");return}ht(!0),M(null),z(null);try{let a=await fetch("/api/auth/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:J,password:X})}),r=await a.json();if(!a.ok){M(r.error||"\u0110\u0103ng k\xFD th\u1EA5t b\u1EA1i.");return}r.success&&(it("otp"),Ft(300),r.isSimulator&&r.otp?(at(r.otp),z(`\u26A0\uFE0F [CH\u1EBE \u0110\u1ED8 TH\u1EEC NGHI\u1EC6M]: Ch\u01B0a c\u1EA5u h\xECnh Email API. M\xE3 OTP c\u1EE7a b\u1EA1n l\xE0: ${r.otp}`)):(at(""),z(r.message||"\u0110\u0103ng k\xFD th\xE0nh c\xF4ng! Vui l\xF2ng nh\u1EADp m\xE3 OTP g\u1EEDi t\u1EDBi email.")))}catch(a){M("L\u1ED7i k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7: "+a.message)}finally{ht(!1)}},ka=async t=>{if(t.preventDefault(),!st){M("Vui l\xF2ng nh\u1EADp m\xE3 OTP.");return}ht(!0),M(null),z(null);try{let a=await fetch("/api/auth/verify-otp",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:J,otp:st})}),r=await a.json();if(!a.ok){M(r.error||"X\xE1c th\u1EF1c OTP th\u1EA5t b\u1EA1i.");return}r.success&&(it("login"),et(""),at(""),z("K\xEDch ho\u1EA1t t\xE0i kho\u1EA3n th\xE0nh c\xF4ng! B\xE2y gi\u1EDD b\u1EA1n c\xF3 th\u1EC3 \u0111\u0103ng nh\u1EADp."))}catch(a){M("L\u1ED7i k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7: "+a.message)}finally{ht(!1)}},Sa=async()=>{if(!(_>0)){M(null),z(null);try{let t=await fetch("/api/auth/resend-otp",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:J})}),a=await t.json();if(!t.ok){M(a.error||"G\u1EEDi l\u1EA1i OTP th\u1EA5t b\u1EA1i.");return}a.success&&(Ft(300),a.isSimulator&&a.otp?(at(a.otp),z(`\u26A0\uFE0F [CH\u1EBE \u0110\u1ED8 TH\u1EEC NGHI\u1EC6M]: M\xE3 OTP c\u1EE7a b\u1EA1n l\xE0: ${a.otp}`)):(at(""),z(a.message||"M\xE3 OTP m\u1EDBi \u0111\xE3 \u0111\u01B0\u1EE3c g\u1EEDi v\u1EC1 email c\u1EE7a b\u1EA1n.")))}catch(t){M("L\u1ED7i k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7: "+t.message)}}},Ta=async()=>{try{await fetch("/api/auth/logout",{method:"POST"}),ut(null),Me(null),Jt(4500),Zt(0),it("login"),le(""),de(""),et(""),M(null),z(null),Lt({}),ce(!1),ge(0),bt(""),Re(!1),localStorage.removeItem("ai_active_trades"),localStorage.removeItem("ai_analysis_triggered")}catch(t){console.error("Logout error",t)}},be=()=>{if(Yt)return;ce(!0),ge(5),bt("\u{1F50D} \u0110ang k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7, t\u1EA3i d\u1EEF li\u1EC7u n\u1EBFn V\xE0ng Spot XAU/USD...");let t=5,a=setInterval(()=>{t--,ge(t),t===4?(bt("\u{1F4CA} \u0110ang ph\xE2n t\xEDch c\u1EA5u tr\xFAc th\u1ECB tr\u01B0\u1EDDng SMC (BOS, CHoCH, Order Block, FVG)..."),P("info")):t===3?(bt("\u{1F4C8} \u0110ang x\xE1c \u0111\u1ECBnh c\u1EA5u tr\xFAc Price Action & c\xE1c v\xF9ng qu\xE9t thanh kho\u1EA3n (Liquidity Sweep)..."),P("info")):t===2?(bt("\u{1F56F}\uFE0F \u0110ang nh\u1EADn di\u1EC7n c\xE1c m\xF4 h\xECnh n\u1EBFn \u0111\u1EA3o chi\u1EC1u c\u01B0\u1EDDng \u0111\u1ED9 cao (Pinbar, Engulfing)..."),P("info")):t===1?(bt("\u{1F916} A.I \u0111ang t\u1ED1i \u01B0u h\xF3a \u0111i\u1EC3m v\xE0o LIMIT ch\u1ED1ng qu\xE9t SL v\xE0 ph\xE2n b\u1ED5 t\u1EF7 l\u1EC7 RR..."),P("info")):t<=0&&(clearInterval(a),ce(!1),P("buy"),Na())},1e3)},Na=()=>{let t=j.current||T||4500,a=x?.signals?.indicators?.atr||3.2,r="BUY";x?.signals?.type==="SELL"||x?.signals?.type==="STRONG_SELL"?r="SELL":x?.signals?.type==="BUY"||x?.signals?.type==="STRONG_BUY"?r="BUY":r=Math.random()>.5?"BUY":"SELL";let n=x?.advancedAnalysis?.swings||[],l=n.filter(N=>N.type==="LOW"&&!N.broken),s=n.filter(N=>N.type==="HIGH"&&!N.broken),i=t-2.5*a,f=t+2.5*a;l.length>0&&(i=l[l.length-1].price),s.length>0&&(f=s[s.length-1].price);let d=0,u=0,m=0,b=0;r==="BUY"?(d=i-.22*a,u=i-.58*a,m=d+1.25*a,b=f-.15*a):(d=f+.22*a,u=f+.58*a,m=d-1.25*a,b=i+.15*a),r==="BUY"?(d>=t&&(d=t-.25*a),(u>=d||d-u>.45*a)&&(u=d-.36*a),b<=d&&(b=d+3.5*a),(m<=d||m>=b)&&(m=d+1.25*a)):(d<=t&&(d=t+.25*a),(u<=d||u-d>.45*a)&&(u=d+.36*a),b>=d&&(b=d-3.5*a),(m>=d||m<=b)&&(m=d-1.25*a)),d=Math.round(d*100)/100,u=Math.round(u*100)/100,m=Math.round(m*100)/100,b=Math.round(b*100)/100;let y=(Math.abs(b-d)/Math.abs(d-u)).toFixed(1),w="",S="",k="";r==="BUY"?(w=`Thu\u1EADt to\xE1n A.I ph\xE1t hi\u1EC7n v\xF9ng qu\xE9t thanh kho\u1EA3n \u0111\xE1y (SSL Sweep Zone) n\u1EB1m ngay ph\xEDa d\u01B0\u1EDBi \u0111\xE1y Swing Low t\u1EA1i $${i.toFixed(2)}. Thay v\xEC mua \u0111u\u1ED5i t\u1EA1i h\u1ED7 tr\u1EE3 nh\u01B0 \u0111\xE1m \u0111\xF4ng nh\u1ECF l\u1EBB, l\u1EC7nh BUY LIMIT \u0111\u01B0\u1EE3c t\u1ED1i \u01B0u \u0111\u1EB7t t\u1EA1i m\u1EE9c gi\xE1 c\u1EF1c th\u1EA5p $${d.toFixed(2)} \u0111\u1EC3 \u0111\xF3n \u0111\u1EA7u c\xFA \u0111\xE2m qu\xE9t d\u1EEBng l\u1ED7 (Stop Hunt) c\u1EE7a c\xE1 m\u1EADp, \u0111\u1EA3m b\u1EA3o \u0111i\u1EC3m v\xE0o l\u1EC7nh c\xF3 x\xE1c su\u1EA5t th\u1EAFng cao nh\u1EA5t ngay khi thanh kho\u1EA3n \u0111\u01B0\u1EE3c gi\u1EA3i ph\xF3ng.`,S=`M\u1EE9c d\u1EEBng l\u1ED7 (SL) c\u1EF1c ng\u1EAFn \u0111\u01B0\u1EE3c th\u1EAFt ch\u1EB7t t\u1EA1i $${u.toFixed(2)}, ch\u1EC9 c\xE1ch Entry kho\u1EA3ng ${Math.abs(d-u).toFixed(2)} \u0111i\u1EC3m. \u0110i\u1EC3m SL n\xE0y \u0111\u01B0\u1EE3c \u0111\u1EB7t v\u01B0\u1EE3t qua ho\xE0n to\xE0n \u0111\xE1y r\xE2u n\u1EBFn qu\xE9t c\u1EE7a Market Maker (v\xF9ng qu\xE9t t\u1ED1i \u0111a c\u1EE7a r\xE2u n\u1EBFn th\u01B0\u1EDDng d\u1EEBng \u1EDF m\u1EE9c 0.50 * ATR), b\u1EA3o \u0111\u1EA3m an to\xE0n tuy\u1EC7t \u0111\u1ED1i tr\u01B0\u1EDBc m\u1ECDi bi\u1EBFn \u0111\u1ED9ng nhi\u1EC5u v\xE0 t\u1ED1i \u01B0u h\xF3a kh\u1ED1i l\u01B0\u1EE3ng giao d\u1ECBch.`,k=`H\u1EC7 th\u1ED1ng thi\u1EBFt l\u1EADp m\u1EE5c ti\xEAu k\xE9p t\u1ED1i \u01B0u: Ch\u1ED1t l\u1EDDi 1 (TP1) t\u1EA1i $${m.toFixed(2)} ch\u1ED1t 50% kh\u1ED1i l\u01B0\u1EE3ng kh\xF3a l\u1EE3i nhu\u1EADn 1:3.47 v\xE0 l\u1EADp t\u1EE9c d\u1EDDi SL v\u1EC1 Entry h\xF2a v\u1ED1n (Break-Even). Ch\u1ED1t l\u1EDDi 2 (TP2) h\u01B0\u1EDBng t\u1EDBi \u0111\u1EC9nh Swing High \u0111\u1ED1i di\u1EC7n t\u1EA1i $${b.toFixed(2)} (v\xF9ng t\xEDch l\u0169y thanh kho\u1EA3n BSL), hi\u1EC7n th\u1EF1c h\xF3a t\u1EF7 l\u1EC7 Risk/Reward si\xEAu h\u1EA1ng \u0111\u1EA1t t\u1EDBi 1:${y} ho\xE0n to\xE0n kh\xF4ng r\u1EE7i ro.`):(w=`Thu\u1EADt to\xE1n A.I ph\xE1t hi\u1EC7n v\xF9ng b\u1EABy thanh kho\u1EA3n \u0111\u1EC9nh (BSL Sweep Zone) n\u1EB1m ngay ph\xEDa tr\xEAn \u0111\u1EC9nh Swing High t\u1EA1i $${f.toFixed(2)}. L\u1EC7nh SELL LIMIT \u0111\u01B0\u1EE3c t\u1ED1i \u01B0u \u0111\u1EB7t cao t\u1EA1i $${d.toFixed(2)} nh\u1EB1m t\u1EADn d\u1EE5ng l\u1EF1c \u0111\u1EA9y d\u1EEBng l\u1ED7 c\u1EE7a c\xE1c v\u1ECB th\u1EBF b\xE1n kh\u1ED1ng nh\u1ECF l\u1EBB b\u1ECB qu\xE9t \u0111\u1EC3 k\xEDch ho\u1EA1t \u0111i\u1EC3m kh\u1EDBp l\u1EC7nh c\u1EE7a t\u1ED5 ch\u1EE9c l\u1EDBn v\u1EDBi m\u1EE9c gi\xE1 t\u1ED1t nh\u1EA5t.`,S=`M\u1EE9c d\u1EEBng l\u1ED7 (SL) c\u1EF1c ng\u1EAFn \u0111\u01B0\u1EE3c th\u1EAFt ch\u1EB7t t\u1EA1i $${u.toFixed(2)}, ch\u1EC9 c\xE1ch Entry kho\u1EA3ng ${Math.abs(d-u).toFixed(2)} \u0111i\u1EC3m. V\u1ECB tr\xED n\xE0y n\u1EB1m ho\xE0n to\xE0n b\xEAn ngo\xE0i khu v\u1EF1c qu\xE9t r\xE2u n\u1EBFn c\u1EE7a th\u1ECB tr\u01B0\u1EDDng (Stop Hunt zone tr\xEAn \u0111\u1EC9nh Swing High), thi\u1EBFt l\u1EADp m\u1ED9t ch\u1ED1t ch\u1EB7n ph\xF2ng ng\u1EF1 v\u1EEFng ch\u1EAFc tr\u01B0\u1EDBc c\xE1c c\xFA gi\u1EADt gi\xE1 gi\u1EA3 t\u1EA1o c\u1EE7a c\xE1 m\u1EADp.`,k=`H\u1EC7 th\u1ED1ng ph\xE2n b\u1ED5 ch\u1ED1t l\u1EDDi: TP1 t\u1EA1i $${m.toFixed(2)} ch\u1ED1t l\u1EDDi m\u1ED9t ph\u1EA7n \u0111\u1EC3 b\u1EA3o to\xE0n l\u1EE3i nhu\u1EADn t\u1EC9 l\u1EC7 1:3.47 v\xE0 k\xEDch ho\u1EA1t d\u1EDDi SL v\u1EC1 \u0111i\u1EC3m h\xF2a v\u1ED1n \u0111\u1EC3 g\u1ED3ng l\xE3i an to\xE0n. TP2 t\u1EA1i \u0111\xE1y Swing Low c\u0169 $${b.toFixed(2)} (v\xF9ng ch\u1EE9a Sell-side Liquidity c\u1EF1c m\u1EA1nh) \u0111\u1EA3m b\u1EA3o t\u1EC9 su\u1EA5t l\u1EE3i nhu\u1EADn \u0111\u1EC9nh cao v\u1EDBi R:R \u0111\u1EA1t 1:${y}.`);let C={timeframe:p,position:r,type:"LIMIT",entry:d,stopLoss:u,takeProfit1:m,takeProfit2:b,hitTp1:!1,status:"PENDING",pips:0,openPrice:0,openTime:"",rrRatio:y,entryReason:w,slReason:S,tpReason:k};Lt(N=>({...N,[p]:C}))},uo=()=>{$t("ai"),Re(!0);let t=W[p];(!t||t.status==="TP"||t.status==="SL")&&!Yt&&be()};E(()=>{if(V==="ai"&&Mt&&!Yt){let t=W[p];(!t||t.status==="TP"||t.status==="SL")&&be()}},[V,p,Mt]);let[T,Jt]=c(4500),[fe,Zt]=c(0),[Ht,xo]=c(!0),[ho,De]=c([]),[mo,He]=c({bids:[],asks:[]}),[bo,fo]=c("book"),[La,Ma]=c(""),[vo,Ca]=c(""),[Z,Ia]=c(!1),[Ot,yo]=c(100),[Qt,wo]=c(5),[ve,ko]=c("micro"),[te,So]=c("percent"),[ee,To]=c(5),[ye,No]=c(0),[Lo,Aa]=c([{id:"h1",time:"05:40:12",type:"SELL",entry:4512.4,stopLoss:4516.8,tp1:4504,status:"HIT TP1 \u{1F7E2} (+84 pips)"},{id:"h2",time:"03:15:45",type:"BUY",entry:4495.2,stopLoss:4489.5,tp1:4503.5,status:"HIT TP1 \u{1F7E2} (+83 pips)"},{id:"h3",time:"01:04:10",type:"SELL",entry:4520.1,stopLoss:4525,tp1:4511,status:"HIT SL \u{1F534} (-49 pips)"},{id:"h4",time:"23:12:05",type:"BUY",entry:4488.5,stopLoss:4482,tp1:4498,status:"HIT TP1 \u{1F7E2} (+95 pips)"}]),$=U({}),[Mo,Oe]=c(""),[za,Ea]=c(!0),[ot,Bt]=c(80),[yt,wt]=c(0),Be=yt===0,[we,ke]=c(1),h=D(()=>{if(!x?.chart?.timestamp)return[];let t=x.chart.timestamp.length,a=[];for(let r=0;r<t;r++)a.push({time:x.chart.timestamp[r],open:x.chart.open[r]??0,high:x.chart.high[r]??0,low:x.chart.low[r]??0,close:x.chart.close[r]??0,volume:x.chart.volume[r]??0});if(a.length>0){let r=a[a.length-1];r.close=T,T>r.high&&(r.high=T),T<r.low&&(r.low=T)}return a},[x,T]),Q=D(()=>{if(h.length===0)return[];let t=h.length,a=Math.max(10,Math.min(ot,t)),r=Math.max(0,Math.min(yt,t-a)),n=t-r,l=Math.max(0,n-a);return h.slice(l,n)},[h,ot,yt]),F=D(()=>{if(h.length===0)return 0;let t=h.length,a=Math.max(10,Math.min(ot,t)),r=Math.max(0,Math.min(yt,t-a)),n=t-r;return Math.max(0,n-a)},[h,ot,yt]),Pa=D(()=>{if(h.length===0)return[];let t=[],r=2/((Number(Ct)||50)+1),n=At||"close",l=h[0][n]||h[0].close;t.push(l);for(let s=1;s<h.length;s++)l=(h[s][n]||h[s].close)*r+l*(1-r),t.push(l);return t},[h,Ct,At]),Ra=D(()=>{if(h.length===0)return[];let t=[],r=2/((Number(It)||200)+1),n=zt||"close",l=h[0][n]||h[0].close;t.push(l);for(let s=1;s<h.length;s++)l=(h[s][n]||h[s].close)*r+l*(1-r),t.push(l);return t},[h,It,zt]),Ue=D(()=>{if(h.length<10)return null;let a=(x?.advancedAnalysis?.swings||[]).filter(i=>i.type==="HIGH").sort((i,f)=>i.index-f.index);if(a.length>=2){let i=a[0];for(let d of a)d.price>i.price&&(i=d);let f=a.find(d=>d.index>i.index&&d.price<i.price);if(f||(f=a[a.length-1]),i&&f&&i.index!==f.index)return{i1:i.index,price1:i.price,i2:f.index,price2:f.price,source:"SMC Swings"}}let r=0,n=h[0].high;for(let i=1;i<Math.floor(h.length*.7);i++)h[i].high>n&&(n=h[i].high,r=i);let l=r+5,s=0;if(l<h.length){s=h[l].high;for(let i=l;i<h.length;i++)h[i].high>s&&h[i].high<n&&(s=h[i].high,l=i)}return r!==l&&l<h.length?{i1:r,price1:n,i2:l,price2:s,source:"PA Scan"}:{i1:Math.max(0,h.length-80),price1:4568,i2:Math.max(0,h.length-20),price2:4516,source:"SMC Profile"}},[h,x]),g=D(()=>{if(Q.length<5)return null;let t=1400,a=520,r=4,n=68,l=12,s=34,i=t-r-n,f=a-l-s,d=Q.map(L=>L.high),u=Q.map(L=>L.low),m=Math.max(...d),b=Math.min(...u),y=m-b||1,w=(m+b)/2,S=y*1.1*we||1;m=w+S/2,b=w-S/2;let k=m-b,C=Q.length,N=i/C,Y=Math.max(1,N*.75),A=L=>r+(L+.5)*N,O=L=>l+(1-(L-b)/k)*f,St=Math.max(1,Math.floor(C/8)),R=[];for(let L=0;L<C;L+=St){let Tt=Q[L].time*1e3,oe=new Date(Tt),Ut;["1D","1W","1M"].includes(p)?Ut=oe.toLocaleDateString("vi-VN",{day:"2-digit",month:"2-digit"}):Ut=oe.toLocaleTimeString("vi-VN",{hour:"2-digit",minute:"2-digit"}),R.push({x:A(L),label:Ut})}let dt=8,B=[];for(let L=0;L<=dt;L++){let Tt=b+k*L/dt;B.push({y:O(Tt),price:Tt})}return{width:t,height:a,paddingLeft:r,paddingRight:n,paddingBottom:s,usableWidth:i,usableHeight:f,maxPrice:m,minPrice:b,paddedRange:k,candleSlotW:N,bodyWidth:Y,getX:A,getY:O,timeLabels:R,priceLabels:B}},[Q,p,we]),j=U(4500),We=U(null),$e=U(0),ae=U(!1),Fe=U(0),Ge=U(0),kt=U(null),Se=U(!1),Ye=U(0),Ve=U(1),Da={1:60,5:300,15:900,60:3600,"1D":86400,"1W":604800,"1M":2592e3};E(()=>{We.current=x},[x]);let P=(t="info")=>{try{let a=new(window.AudioContext||window.webkitAudioContext),r=a.createOscillator(),n=a.createGain();r.connect(n),n.connect(a.destination),t==="buy"?(r.frequency.setValueAtTime(587.33,a.currentTime),n.gain.setValueAtTime(.12,a.currentTime),r.start(),r.frequency.setValueAtTime(698.46,a.currentTime+.12),n.gain.setValueAtTime(.1,a.currentTime+.12),n.gain.exponentialRampToValueAtTime(.001,a.currentTime+.35),r.stop(a.currentTime+.4)):t==="sell"?(r.frequency.setValueAtTime(523.25,a.currentTime),n.gain.setValueAtTime(.12,a.currentTime),r.start(),r.frequency.setValueAtTime(392,a.currentTime+.12),n.gain.setValueAtTime(.1,a.currentTime+.12),n.gain.exponentialRampToValueAtTime(.001,a.currentTime+.35),r.stop(a.currentTime+.4)):(r.frequency.setValueAtTime(440,a.currentTime),n.gain.setValueAtTime(.08,a.currentTime),n.gain.exponentialRampToValueAtTime(.001,a.currentTime+.15),r.start(),r.stop(a.currentTime+.2))}catch(a){console.warn("Audio Context failed",a)}};E(()=>{if(!Z||!x?.advancedAnalysis)return;let t=x.advancedAnalysis,a=Date.now(),r=t.fvgs.find(i=>!i.mitigated&&i.type==="BULLISH");if(r&&T<=r.top&&T>=r.bottom){let i=`fvg_bullish_${r.index}`;(!$.current[i]||a-$.current[i]>3e4)&&($.current[i]=a,P("buy"))}let n=t.fvgs.find(i=>!i.mitigated&&i.type==="BEARISH");if(n&&T>=n.bottom&&T<=n.top){let i=`fvg_bearish_${n.index}`;(!$.current[i]||a-$.current[i]>3e4)&&($.current[i]=a,P("sell"))}let l=t.orderBlocks.find(i=>!i.mitigated&&i.type==="BULLISH");if(l&&T>=l.low&&T<=l.high){let i=`ob_bullish_${l.index}`;(!$.current[i]||a-$.current[i]>3e4)&&($.current[i]=a,P("buy"))}let s=t.orderBlocks.find(i=>!i.mitigated&&i.type==="BEARISH");if(s&&T>=s.low&&T<=s.high){let i=`ob_bearish_${s.index}`;(!$.current[i]||a-$.current[i]>3e4)&&($.current[i]=a,P("sell"))}},[T,Z,x]),E(()=>{let t=setInterval(()=>{let a=new Date;Ma(a.toLocaleTimeString("en-GB")+" UTC");let r=Da[p]||86400,n=Math.floor(a.getTime()/1e3),l=r-n%r;if(l>=3600){let s=Math.floor(l/3600),i=Math.floor(l%3600/60),f=l%60;Oe(`${s}:${String(i).padStart(2,"0")}:${String(f).padStart(2,"0")}`)}else{let s=Math.floor(l/60),i=l%60;Oe(`${String(s).padStart(2,"0")}:${String(i).padStart(2,"0")}`)}},1e3);return()=>clearInterval(t)},[p]),E(()=>{let t=a=>{document.activeElement?.tagName==="INPUT"||document.activeElement?.tagName==="TEXTAREA"||(a.key==="+"||a.key==="="?(a.preventDefault(),Xe()):a.key==="-"?(a.preventDefault(),_e()):a.key==="ArrowLeft"?(a.preventDefault(),wt(r=>Math.min(h.length-ot,r+5))):a.key==="ArrowRight"?(a.preventDefault(),wt(r=>Math.max(0,r-5))):(a.key==="r"||a.key==="R")&&(a.preventDefault(),Bt(80),wt(0),ke(1)))};return window.addEventListener("keydown",t),()=>window.removeEventListener("keydown",t)},[h.length,ot]);let Te=async(t=!1)=>{if(H){t||Ce(!0),t||re(null);try{let a=await fetch(`/api/signals/XAUUSD?tf=${p}`);if(!a.ok)throw new Error("Kh\xF4ng th\u1EC3 k\u1EBFt n\u1ED1i \u0111\u1EBFn server API Gold");let r=await a.json();re(null),Me(r),Ca(new Date().toLocaleTimeString("vi-VN")),r.lastPrice>0&&(!We.current||Math.abs(j.current-r.lastPrice)>100?j.current=r.lastPrice:j.current=j.current*.7+r.lastPrice*.3,Jt(Math.round(j.current*100)/100)),r.signals&&r.signals.type!=="NEUTRAL"&&Aa(n=>{let l=n[0];if(!l||l.type!==r.signals.type||Math.abs(l.entry-r.signals.suggestion.entry)>.5){let i=new Date().toLocaleTimeString("vi-VN");return[{id:Math.random().toString(),time:i,type:r.signals.type,entry:r.signals.suggestion.entry,stopLoss:r.signals.suggestion.stopLoss,tp1:r.signals.suggestion.takeProfit1,status:"Active \u{1F7E1}"},...n.slice(0,14)]}return n}),t||(Oa(r.lastPrice),Ba(r.lastPrice)),Zt(r.priceChange)}catch(a){t||re(a.message)}finally{t||Ce(!1)}}},Ha=async()=>{try{let t=await fetch("/api/price/XAUUSD");if(!t.ok)return;let a=await t.json();a.price&&a.price>0&&(j.current=j.current*.7+a.price*.3,Jt(Math.round(j.current*100)/100),Zt(a.change))}catch{}};E(()=>{if(!H)return;Te(!1);let t=setInterval(()=>{Ht&&H&&Ha()},1500),a=setInterval(()=>{Ht&&H&&Te(!0)},3e4);return()=>{clearInterval(t),clearInterval(a)}},[p,Ht,H]);let Oa=t=>{let a=.35+Math.random()*.15,r=[],n=[];for(let l=1;l<=10;l++)n.push({price:t+a/2+(l-1)*.15,size:Math.round((Math.random()*80+5)*10)/10}),r.push({price:t-a/2-(l-1)*.15,size:Math.round((Math.random()*80+5)*10)/10});He({bids:r,asks:n.reverse()})},Ba=t=>{let a=[],r=new Date;for(let n=0;n<20;n++){let l=n*280,s=new Date(r.getTime()-l),i=Math.random()>.48;a.push({id:`init-${n}`,time:s.toLocaleTimeString()+"."+String(s.getMilliseconds()).padStart(3,"0"),type:i?"BUY":"SELL",price:t+(Math.random()-.5)*.4,size:(Math.random()*4.5+.1).toFixed(1)+" Lot"})}De(a)};E(()=>{if(!Ht||!x||!H)return;let t=setInterval(()=>{let a=j.current,r=x.lastPrice,n=(r-a)*.05,l=(Math.random()-.5)*.25,s=Math.round((a+n+l)*100)/100;j.current=s,Jt(s);let i=r/(1+x.priceChange/100),f=(s-i)/i*100;if(Zt(f),$e.current++,$e.current%3===0){let u=.35+Math.random()*.1;He(m=>{let b=m.asks.map((w,S)=>{let k=10-S;return{price:Math.round((s+u/2+(k-1)*.15)*100)/100,size:Math.max(1,Math.round((w.size+(Math.random()-.5)*5)*10)/10)}});return{bids:m.bids.map((w,S)=>({price:Math.round((s-u/2-S*.15)*100)/100,size:Math.max(1,Math.round((w.size+(Math.random()-.5)*5)*10)/10)})),asks:b}})}if(Math.random()<.35){let u=Math.random()>.47,m=new Date,b=u?s+Math.random()*.05:s-Math.random()*.05,y={id:Math.random().toString(),time:m.toLocaleTimeString()+"."+String(m.getMilliseconds()).padStart(3,"0"),type:u?"BUY":"SELL",price:Math.round(b*100)/100,size:(Math.random()*5+.1).toFixed(1)+" Lot"};De(w=>[y,...w.slice(0,24)])}let d=W[p];if(d){if(d.status==="PENDING")(d.position==="BUY"?s<=d.entry:s>=d.entry)&&(Lt(b=>{let y={...b};return y[p]&&y[p].status==="PENDING"&&(y[p]={...y[p],status:"ACTIVE",openPrice:s,openTime:new Date().toLocaleTimeString()}),y}),P("info"));else if(d.status==="ACTIVE"){let u=d.position==="BUY";d.hitTp1||(u?s>=d.takeProfit1:s<=d.takeProfit1)&&(Lt(S=>{let k={...S};return k[p]&&k[p].status==="ACTIVE"&&(k[p]={...k[p],hitTp1:!0,stopLoss:d.entry}),k}),P("buy"));let m=d.hitTp1?d.entry:d.stopLoss,b=u?s>=d.takeProfit2:s<=d.takeProfit2,y=u?s<=m:s>=m;if(b||y){let w=b?"TP":"SL",S=0;u?S=Math.round((s-d.entry)*10):S=Math.round((d.entry-s)*10);let k=100,C=.1;p==="5"?C=.2:p==="15"?C=.5:p==="60"?C=1:p==="1D"&&(C=2);let N=Number((S*k*C/10).toFixed(2));Lt(A=>{let O={...A};return O[p]&&O[p].status==="ACTIVE"&&(O[p]={...O[p],status:w,closePrice:s,closeTime:new Date().toLocaleTimeString(),pips:S,profitUsd:N}),O});let Y={id:`AI-${p.toUpperCase()}-${Date.now()}-${Math.random().toString(36).substring(2,6).toUpperCase()}`,timeframe:p==="1"?"M1":p==="5"?"M5":p==="15"?"M15":p==="60"?"H1":"D1",position:d.position,entry:d.entry,stopLoss:d.stopLoss,takeProfit1:d.takeProfit1,takeProfit2:d.takeProfit2,status:w==="TP"?"TP2":d.hitTp1?"TP1":"SL",openTime:Date.now()-3e4,closeTime:Date.now(),pips:S,profitUsd:N,isAi:!0};ne(A=>[Y,...A]),fetch("/api/backtest/trade",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(Y)}).catch(A=>console.error("Error saving real-time closed trade:",A)),P(w==="TP"?"buy":"sell")}}}},85);return()=>clearInterval(t)},[Ht,x,H,p,W]);let Ua=t=>{if(!kt.current||!g)return;let a=kt.current.getBoundingClientRect();(t.clientX-a.left)/a.width*g.width>g.width-g.paddingRight?(Se.current=!0,Ye.current=t.clientY,Ve.current=we):(ae.current=!0,Fe.current=t.clientX,Ge.current=yt)},Wa=t=>{if(Se.current){let r=1+(t.clientY-Ye.current)*.005;ke(Math.max(.05,Math.min(10,Ve.current*r)))}else if(ae.current&&kt.current&&g){let a=t.clientX-Fe.current,n=(kt.current.clientWidth||860)/Math.max(ot,1),l=Math.round(-a/n),s=Math.max(0,Math.min(h.length-ot,Ge.current+l));wt(s)}},je=()=>{ae.current=!1,Se.current=!1},$a=()=>{Bt(80),wt(0),ke(1)};E(()=>{let t=kt.current;if(!t)return;let a=r=>{r.preventDefault();let n=r.deltaY>0?1:-1;Bt(l=>Math.max(10,Math.min(500,l+n*Math.ceil(l*.08))))};return t.addEventListener("wheel",a,{passive:!1}),()=>{t.removeEventListener("wheel",a)}},[g]);let Fa=()=>wt(0),Xe=()=>Bt(t=>Math.max(10,Math.round(t*.7))),_e=()=>Bt(t=>Math.min(500,Math.round(t*1.4))),v=D(()=>{if(!x)return null;let t=W[p];if(t&&(t.status==="PENDING"||t.status==="ACTIVE")){let B=t.position==="BUY",L=B?"BUY":"SELL",Tt=t.stopLoss??0,oe=t.takeProfit1??t.takeProfit??0,Ut=t.takeProfit2??t.takeProfit??0,Ze=t.entry??0,Xa=`$${Ze.toFixed(2)}`;return{type:L,confluenceScore:B?78:-78,winProbability:88,entryText:Xa,entryMid:Ze,sl:Tt,tp1:oe,tp2:Ut,atr:x.signals?.indicators?.atr||x.tradingViewAnalysis?.atr||3.2,rsi:x.signals?.indicators?.rsi||x.tradingViewAnalysis?.rsi||50,adx:x.tradingViewAnalysis?.adx||20,ema10:x.tradingViewAnalysis?.ema10||T,sma20:x.tradingViewAnalysis?.sma20||T}}let a=x.signals,r=x.tradingViewAnalysis,n=a.type==="BUY"?a.strength:a.type==="SELL"?-a.strength:0,l=r?r.recommendAll*100:0,s=Math.round((n+l)/2),i="NEUTRAL";s>=40?i="STRONG_BUY":s>=15?i="BUY":s<=-40?i="STRONG_SELL":s<=-15&&(i="SELL");let f=50,d=0,u=0,m=0,b=0,y=a.indicators.atr||r?.atr||3.2,w=a.indicators.rsi||r?.rsi||50,S=r?r.macd-r.macdSignal:0;if(r){let B=T>r.ema50,L=r.ema10>r.sma20;i.includes("BUY")?(B&&(d+=6),L&&(d+=6)):i.includes("SELL")&&(B||(d+=6),L||(d+=6))}i.includes("BUY")?(w>=50&&w<=65&&(u+=6),S>0&&(u+=6)):i.includes("SELL")&&(w>=35&&w<=50&&(u+=6),S<0&&(u+=6)),r&&r.adx>25&&(m+=6),i.includes("BUY")&&w<30&&(b+=8),i.includes("SELL")&&w>70&&(b+=8);let k=Math.min(94,Math.max(35,Math.round(f+Math.abs(s)*.3+d+u+m+b))),C=0,N=0,Y="",A=0,O=0,St=0,R=0,dt=x.chart?.close&&x.chart.close.length>0?x.chart.close[x.chart.close.length-1]:T;if(a&&a.suggestion&&a.suggestion.position!=="NEUTRAL"){let B=a.suggestion;A=B.stopLoss,O=B.takeProfit1,St=B.takeProfit2,R=B.entry,C=Math.round((R-.15*y)*100)/100,N=Math.round((R+.15*y)*100)/100,Y=`$${R.toFixed(2)}`,a.strength>0&&(k=Math.min(94,Math.max(78,80+Math.round(a.strength*.15))))}else C=Math.round((i.includes("BUY")?dt-.25*y:dt)*100)/100,N=Math.round((i.includes("BUY")?dt:dt+.25*y)*100)/100,Y=`$${C.toFixed(2)} - $${N.toFixed(2)}`,R=(C+N)/2,i.includes("BUY")?(A=Math.round((R-1.5*y)*100)/100,O=Math.round((R+1.5*y)*100)/100,St=Math.round((R+3*y)*100)/100):i.includes("SELL")&&(A=Math.round((R+1.5*y)*100)/100,O=Math.round((R-1.5*y)*100)/100,St=Math.round((R-3*y)*100)/100);return{type:i,confluenceScore:s,winProbability:k,entryText:Y,entryMid:R,sl:A,tp1:O,tp2:St,atr:y,rsi:w,adx:r?.adx||20,ema10:r?.ema10||T,sma20:r?.sma20||T}},[x,W,Mt,p,T]),Ne=D(()=>ye>0?ye:!v||!v.sl?0:Math.abs(v.entryMid-v.sl),[ye,v]),Ke=D(()=>te==="percent"?Ot*Qt/100:ee,[Ot,Qt,ee,te]),Co=D(()=>Ot<=0?0:te==="usd"?ee/Ot*100:Qt,[Ot,Qt,ee,te]),Io=D(()=>Ne<=0?0:Ke/(Ne*(ve==="standard"?100:ve==="mini"?10:1)),[Ke,Ne,ve]),Ao=D(()=>{if(!v)return{};let t=v.type,a=v.winProbability,r="var(--yellow)";return t.includes("BUY")?r="var(--green)":t.includes("SELL")&&(r="var(--red)"),{background:`conic-gradient(${r} 0% ${a}%, var(--bg3) ${a}% 100%)`}},[v]),Ga=(t,a)=>{let r=a.replace(/\D/g,"").slice(-1),n=st.split("");for(;n.length<6;)n.push("");n[t]=r;let l=n.join("");et(l),r&&t<5&&Nt.current[t+1]?.focus()},Ya=(t,a)=>{if(a.key==="Backspace"){let r=st.split("");for(;r.length<6;)r.push("");!r[t]&&t>0?(r[t-1]="",et(r.join("")),Nt.current[t-1]?.focus()):(r[t]="",et(r.join("")))}},G=(()=>{let t=X;if(!t)return 0;let a=0;return t.length>=6&&a++,t.length>=10&&a++,/[A-Z]/.test(t)&&/[0-9]/.test(t)&&a++,a})(),qe=300,Va=qe>0?_/qe:0,Je=2*Math.PI*22,ja=Je*(1-Va);return la?o("div",{className:"auth-container",children:[e("div",{className:"auth-grid-overlay"}),o("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"20px",position:"relative",zIndex:1},children:[e("div",{className:"auth-logo-ring",children:e("img",{src:"/frontend/logo.png",alt:"XAU Logo",className:"auth-logo-img"})}),e("div",{style:{color:"var(--gold)",fontWeight:"800",fontSize:"14px",letterSpacing:"2px",textTransform:"uppercase"},children:"\u0110ang kh\u1EDFi \u0111\u1ED9ng h\u1EC7 th\u1ED1ng..."}),e("div",{className:"load-bar",style:{width:"220px"},children:e("div",{className:"load-fill"})})]})]}):H?o("div",{className:"root",children:[o("header",{className:"topbar",children:[e("div",{className:"topbar-left",children:o("div",{className:"brand",style:{display:"flex",alignItems:"center"},children:[e("img",{src:"/frontend/logo.png",alt:"XAU Logo",style:{width:"45px",height:"45px",borderRadius:"8px",marginRight:"8px",filter:"drop-shadow(0 0 8px rgba(255, 171, 0, 0.4))"}}),e("span",{className:"brand-name",children:"H\u1EC6 TH\u1ED0NG GIAO D\u1ECACH V\xC0NG CHUY\xCAN NGHI\u1EC6P XAU/USD"}),e("span",{className:"brand-badge",children:"D\u1EEE LI\u1EC6U TH\u1EDCI GIAN TH\u1EF0C MILLISECOND"})]})}),o("div",{className:"topbar-right",children:[e("span",{className:"clock",children:La||"00:00:00 UTC"}),H&&o("div",{className:"user-profile-chip",style:{display:"flex",alignItems:"center",gap:"8px",background:"rgba(255, 215, 0, 0.04)",border:"1px solid rgba(255, 215, 0, 0.12)",padding:"4px 12px",borderRadius:"8px",marginRight:"10px",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.03)"},children:[o("span",{style:{fontSize:"11px",color:"var(--text2)",fontWeight:"600"},children:["\u{1F464} ",H.email]}),e("div",{style:{width:"1px",height:"12px",background:"rgba(255,255,255,0.12)",margin:"0 4px"}}),e("button",{type:"button",onClick:Ta,style:{background:"transparent",border:"none",color:"#ff1744",fontSize:"11px",fontWeight:"700",cursor:"pointer",padding:"2px 6px",borderRadius:"4px",display:"flex",alignItems:"center",gap:"4px",transition:"all 0.2s ease"},onMouseOver:t=>{t.currentTarget.style.background="rgba(255, 23, 68, 0.1)"},onMouseOut:t=>{t.currentTarget.style.background="transparent"},children:"\u{1F6AA} \u0110\u0103ng xu\u1EA5t"})]}),e("button",{className:`tf-btn ${Z?"active":""}`,style:{borderColor:Z?"var(--green)":"rgba(255,255,255,0.05)",background:Z?"rgba(0, 230, 118, 0.12)":"var(--bg3)",color:Z?"var(--green)":"var(--text)",marginRight:"10px",fontWeight:Z?"600":"normal",cursor:"pointer"},onClick:()=>Ia(!Z),children:Z?"\u{1F514} B\xE1o \xC2m: B\u1EACT":"\u{1F515} B\xE1o \xC2m: T\u1EAET"}),e("button",{className:"tf-btn",style:{borderColor:"rgba(255,255,255,0.05)",background:"var(--bg3)",color:"var(--text)"},onClick:Te,children:"\u{1F504} T\u1EA3i L\u1EA1i"})]})]}),o("div",{className:"layout",children:[!pt&&o("aside",{className:"sidebar",children:[e("header",{className:"sb-header hide-on-mobile",children:e("div",{className:"gold-profile-card",children:e("div",{className:"g-title",children:"\u{1F7E1} V\xC0NG SPOT (XAU/USD)"})})}),o("div",{style:{padding:"16px",flex:1,display:"flex",flexDirection:"column",gap:"16px",overflowY:"auto"},children:[x&&e("div",{className:"sug-card hide-on-mobile",style:{display:"flex",justifyContent:"center",alignItems:"center",padding:"16px",background:"rgba(20, 24, 33, 0.45)",backdropFilter:"blur(8px)",border:"1px solid rgba(255, 215, 0, 0.08)",boxShadow:"0 8px 32px rgba(0, 0, 0, 0.25)"},children:e("img",{src:"/frontend/logo.png",alt:"Xtreme Algo Union Logo",style:{width:"100%",maxWidth:"220px",height:"auto",borderRadius:"12px",filter:"drop-shadow(0 0 16px rgba(255, 171, 0, 0.25))",transition:"all 0.3s ease"},onMouseOver:t=>{t.currentTarget.style.filter="drop-shadow(0 0 24px rgba(255, 171, 0, 0.5))",t.currentTarget.style.transform="scale(1.02)"},onMouseOut:t=>{t.currentTarget.style.filter="drop-shadow(0 0 16px rgba(255, 171, 0, 0.25))",t.currentTarget.style.transform="scale(1)"}})}),W[p]&&(W[p].status==="PENDING"||W[p].status==="ACTIVE")?v&&o("div",{className:"sug-card",style:{borderTop:"3px solid var(--gold)",background:"rgba(20, 24, 33, 0.65)",backdropFilter:"blur(12px)"},children:[o("div",{className:"sug-title",style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e("span",{style:{display:"flex",alignItems:"center",gap:"6px"},children:"\u2728 CH\u1EC8 B\xC1O H\u1EE2P L\u01AFU K\u1EF8 THU\u1EACT"}),e("span",{style:{fontSize:"9px",background:"rgba(255, 171, 0, 0.15)",color:"var(--gold)",padding:"2px 6px",borderRadius:"4px",fontWeight:"bold"},children:"PRO FEED"})]}),e("div",{style:{display:"flex",alignItems:"center",gap:"16px",margin:"14px 0",background:"rgba(255,255,255,0.02)",padding:"10px",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.04)"},children:o("div",{style:{flex:1},children:[e("span",{style:{fontSize:"10px",color:"var(--text2)",textTransform:"uppercase",display:"block"},children:"Khuy\u1EBFn ngh\u1ECB h\u1EE3p l\u01B0u"}),e("span",{className:`sug-val ${v.type.includes("BUY")?"buy":v.type.includes("SELL")?"sell":""}`,style:{fontSize:"15px",fontWeight:"800",marginTop:"2px",display:"block"},children:v.type==="STRONG_BUY"?"\u{1F7E2} MUA M\u1EA0NH (STRONG BUY)":v.type==="BUY"?"\u{1F7E2} MUA V\xC0O (BUY)":v.type==="STRONG_SELL"?"\u{1F534} B\xC1N M\u1EA0NH (STRONG SELL)":v.type==="SELL"?"\u{1F534} B\xC1N RA (SELL)":"\u{1F7E1} TRUNG L\u1EACP (NEUTRAL)"})]})}),o("div",{className:"sug-grid",style:{gap:"8px"},children:[o("div",{className:"sug-item",children:[e("span",{className:"sug-label",children:"ENTRY"}),e("span",{className:"sug-val entry",style:{fontSize:"11.5px",letterSpacing:"-0.2px"},children:v.entryText})]}),o("div",{className:"sug-item",children:[e("span",{className:"sug-label",children:"\u0110i\u1EC3m C\u1EAFt l\u1ED7 (SL)"}),e("span",{className:"sug-val sl",style:{fontSize:"11.5px"},children:v.sl>0?`$${v.sl.toFixed(2)}`:"\u2014"})]}),o("div",{className:"sug-item",children:[e("span",{className:"sug-label",children:"Ch\u1ED1t l\u1EDDi 1 (TP1)"}),e("span",{className:"sug-val tp",style:{fontSize:"11.5px"},children:v.tp1>0?`$${v.tp1.toFixed(2)}`:"\u2014"})]}),o("div",{className:"sug-item",children:[e("span",{className:"sug-label",children:"Ch\u1ED1t l\u1EDDi 2 (TP2)"}),e("span",{className:"sug-val tp",style:{fontSize:"11.5px"},children:v.tp2>0?`$${v.tp2.toFixed(2)}`:"\u2014"})]}),e("div",{className:"sug-item",style:{gridColumn:"span 2"},children:o("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"8px",borderTop:"1px solid rgba(255,255,255,0.05)",paddingTop:"8px",marginTop:"4px"},children:[o("div",{children:[e("span",{className:"sug-label",style:{fontSize:"9px"},children:"T\u1EF7 l\u1EC7 r\u1EE7i ro/l\u1EE3i nhu\u1EADn:"}),e("strong",{style:{color:"#fff",display:"block",fontSize:"11px",marginTop:"2px",fontFamily:"monospace"},children:"1:3.0 \u2794 1:3.0"})]}),o("div",{children:[e("span",{className:"sug-label",style:{fontSize:"9px"},children:"H\u1EC7 s\u1ED1 bi\u1EBFn \u0111\u1ED9ng (ATR):"}),o("strong",{style:{color:"var(--gold)",display:"block",fontSize:"11px",marginTop:"2px",fontFamily:"monospace"},children:["$",v.atr.toFixed(2)]})]})]})})]})]}):o("div",{className:"sug-card",style:{borderTop:"3px solid rgba(255, 171, 0, 0.3)",background:"rgba(20, 24, 33, 0.45)",backdropFilter:"blur(12px)",padding:"24px 16px",textAlign:"center",borderRadius:"8px",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"12px",border:"1px solid rgba(255, 171, 0, 0.15)",boxShadow:"0 8px 32px rgba(0,0,0,0.4)"},children:[e("div",{style:{width:"44px",height:"44px",borderRadius:"50%",background:"rgba(255, 171, 0, 0.1)",display:"flex",alignItems:"center",justifyContent:"center",border:"1px dashed var(--gold)",boxShadow:"0 0 15px rgba(255, 171, 0, 0.2)",animation:"aiDotBlink 1.5s infinite alternate"},children:e("span",{style:{fontSize:"18px"},children:"\u26A1"})}),e("h4",{style:{color:"#fff",margin:"4px 0 0 0",fontSize:"13px",fontWeight:"800",letterSpacing:"0.2px"},children:"CH\u1EC8 B\xC1O \u0110ANG KH\xD3A"}),o("p",{style:{color:"var(--text2)",fontSize:"11px",lineHeight:"1.5",margin:0},children:["Ch\u1EC9 b\xE1o h\u1EE3p l\u01B0u k\u1EF9 thu\u1EADt \u0111ang t\u1EA1m \u1EA9n. Vui l\xF2ng b\u1EA5m v\xE0o tab ",e("strong",{style:{color:"var(--gold)"},children:"\u{1F916} Ph\xE2n t\xEDch A.I"})," v\xE0 kh\u1EDFi ch\u1EA1y \u0111\u1EC3 k\xEDch ho\u1EA1t \u0111\u1ED3ng b\u1ED9 d\u1EEF li\u1EC7u."]})]})]})]}),o("main",{className:"main",children:[o("div",{className:"sym-header",children:[o("div",{className:"sym-info",children:[o("div",{className:"sym-title-wrap",children:[e("span",{className:"sym-title",children:"GOLD (XAU/USD)"}),e("span",{className:"sym-subtitle",children:"V\xE0ng giao ngay / \u0110\xF4 la M\u1EF9"})]}),o("div",{className:"price-info",children:[o("span",{className:"price-current",children:["$",T.toFixed(2)]}),o("span",{className:`price-change ${fe>=0?"up":"down"}`,children:[fe>=0?"+":"",fe.toFixed(3),"%"]})]})]}),e("div",{className:"hide-on-mobile",style:{display:"flex",gap:"4px",background:"var(--bg3)",padding:"3px",borderRadius:"6px",border:"1px solid var(--border)",marginLeft:"auto",marginRight:"6px"},children:[{id:"1",name:"M1"},{id:"5",name:"M5"},{id:"15",name:"M15"},{id:"60",name:"1H"},{id:"1D",name:"1D"}].map(t=>e("button",{onClick:()=>{P(),rt(t.id)},style:{background:p===t.id?"var(--yellow)":"transparent",border:"none",borderRadius:"4px",padding:"4px 8px",fontSize:"11px",fontWeight:"bold",color:p===t.id?"#000":"var(--text2)",cursor:"pointer",transition:"all 0.15s ease"},children:t.name},t.id))}),e("div",{style:{display:"flex",gap:"6px",alignItems:"center",marginLeft:"6px"},children:e("button",{onClick:()=>{P(),q("tradingview")},className:`tf-btn ${I==="tradingview"?"active":""}`,style:{background:I==="tradingview"?"var(--yellow)":"var(--bg3)",borderColor:I==="tradingview"?"var(--yellow)":"rgba(255,255,255,0.05)",color:I==="tradingview"?"#000":"var(--text2)",fontWeight:"bold",cursor:"pointer",fontSize:"11px",padding:"5px 12px",borderRadius:"4px",transition:"all 0.2s ease"},children:"\u{1F4CA} BI\u1EC2U \u0110\u1ED2 TRADINGVIEW"})})]}),aa&&e("div",{className:"load-bar",children:e("div",{className:"load-fill"})}),Ie&&o("div",{className:"err-msg",children:["\u26A0\uFE0F L\u1ED7i: ",Ie]}),o("div",{className:"main-workspace",children:[e("div",{className:`chart-column ${pt?"full-chart-active":""}`,children:e("div",{className:"chart-wrap",style:{height:"100%",width:"100%",display:"flex",flexDirection:"column",position:"relative"},children:I==="tradingview"?o(K,{children:[e(Ka,{timeframe:p}),za&&o("div",{className:"tv-guide-overlay",children:[o("div",{className:"tv-guide-header",children:[o("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:[e("span",{className:"tv-guide-icon",children:"\u{1F4A1}"}),e("span",{className:"tv-guide-title",children:"M\u1EB9o: B\u1EADt \u0110\u1EBFm Ng\u01B0\u1EE3c \u0110\xF3ng N\u1EBFn Tr\xEAn Chart"})]}),e("button",{className:"tv-guide-close",onClick:()=>Ea(!1),children:"\xD7"})]}),o("div",{className:"tv-guide-body",children:["\u0110\u1EC3 ch\u1EA1y \u0111\u1EBFm ng\u01B0\u1EE3c n\u1EBFn th\u1EDDi gian th\u1EF1c \u1EDF d\u01B0\u1EDBi t\u1EF7 gi\xE1 ",o("strong",{style:{color:"var(--green)"},children:["$",T.toFixed(2)]}),":",o("ol",{className:"tv-guide-steps",children:[o("li",{children:[e("strong",{children:"Click chu\u1ED9t ph\u1EA3i"})," v\xE0o v\xF9ng c\u1ED9t t\u1EF7 gi\xE1 b\xEAn ph\u1EA3i bi\u1EC3u \u0111\u1ED3."]}),o("li",{children:["Ch\u1ECDn d\xF2ng ",e("strong",{style:{color:"var(--gold)"},children:'"\u0110\u1EBFm ng\u01B0\u1EE3c t\u1EDBi khi \u0111\xF3ng n\u1EBFn" (Countdown to bar close)'}),"."]})]}),e("div",{className:"tv-guide-footer",children:"\u2713 T\u1EF1 \u0111\u1ED9ng l\u01B0u v\xE0 ho\u1EA1t \u0111\u1ED9ng v\u0129nh vi\u1EC5n tr\xEAn tr\xECnh duy\u1EC7t c\u1EE7a b\u1EA1n!"})]})]})]}):o("div",{style:{position:"relative",width:"100%",height:"100%",flex:1,display:"flex",flexDirection:"column",background:"#131722",overflow:"hidden"},children:[g?o("svg",{className:"chart-svg",ref:kt,width:"100%",height:"100%",viewBox:`0 0 ${g.width} ${g.height}`,preserveAspectRatio:"none",onMouseDown:Ua,onMouseMove:Wa,onMouseUp:je,onMouseLeave:je,onDoubleClick:$a,style:{cursor:ae.current?"grabbing":"crosshair",userSelect:"none"},children:[e("defs",{children:o("filter",{id:"glow",x:"-20%",y:"-20%",width:"140%",height:"140%",children:[e("feGaussianBlur",{stdDeviation:"3",result:"blur"}),o("feMerge",{children:[e("feMergeNode",{in:"blur"}),e("feMergeNode",{in:"SourceGraphic"})]})]})}),g.priceLabels.map((t,a)=>o("g",{children:[e("line",{x1:g.paddingLeft,y1:t.y,x2:g.width-g.paddingRight,y2:t.y,stroke:"rgba(255, 255, 255, 0.03)",strokeWidth:"1"}),o("text",{x:g.width-g.paddingRight+8,y:t.y+4,fill:"var(--text3)",fontSize:"10px",fontFamily:"monospace",children:["$",t.price.toFixed(2)]})]},`grid-y-${a}`)),g.timeLabels.map((t,a)=>o("g",{children:[e("line",{x1:t.x,y1:0,x2:t.x,y2:g.height-g.paddingBottom,stroke:"rgba(255, 255, 255, 0.02)",strokeWidth:"1"}),e("text",{x:t.x-18,y:g.height-12,fill:"var(--text3)",fontSize:"9.5px",fontFamily:"monospace",children:t.label})]},`grid-x-${a}`)),v&&(()=>{let t=g.getY(v.entryMid),a=g.getY(v.sl),r=g.getY(v.tp2),n=g.paddingLeft,l=g.width-g.paddingRight;return o(K,{children:[e("rect",{x:n,y:Math.min(t,a),width:l-n,height:Math.abs(t-a),fill:"rgba(255, 23, 68, 0.06)",stroke:"rgba(255, 23, 68, 0.15)",strokeWidth:"1",strokeDasharray:"2,2"}),e("rect",{x:n,y:Math.min(t,r),width:l-n,height:Math.abs(t-r),fill:"rgba(0, 230, 118, 0.06)",stroke:"rgba(0, 230, 118, 0.15)",strokeWidth:"1",strokeDasharray:"2,2"})]})})(),x?.advancedAnalysis&&(()=>{let t=x.advancedAnalysis,a=g.paddingLeft,r=g.width-g.paddingRight;return o("g",{id:"smc-dynamic-structures",children:[t.orderBlocks?.map((n,l)=>{let s=n.index,i=n.mitigated?Math.min(h.length-1,n.index+10):h.length-1,f=g.getX(s-F),d=g.getX(i-F),u=Math.max(a,f),m=Math.min(r,d);if(u>=m)return null;let b=g.getY(n.high),y=g.getY(n.low),w=Math.min(b,y),S=Math.abs(b-y),k=n.type==="BULLISH",C=k?"rgba(0, 230, 118, 0.06)":"rgba(255, 23, 68, 0.06)",N=k?"rgba(0, 230, 118, 0.22)":"rgba(255, 23, 68, 0.22)",Y=k?"+OB BULLISH":"-OB BEARISH",A=k?"rgba(0, 230, 118, 0.8)":"rgba(255, 23, 68, 0.8)";return o("g",{children:[e("rect",{x:u,y:w,width:m-u,height:S,fill:C,stroke:N,strokeWidth:"1"}),m-u>50&&e("text",{x:u+6,y:w+11,fill:A,fontSize:"8px",fontWeight:"bold",fontFamily:"monospace",pointerEvents:"none",children:Y})]},`ob-${l}`)}),t.fvgs?.map((n,l)=>{let s=Math.max(0,n.index-2),i=n.mitigated?Math.min(h.length-1,n.index+6):h.length-1,f=g.getX(s-F),d=g.getX(i-F),u=Math.max(a,f),m=Math.min(r,d);if(u>=m)return null;let b=g.getY(n.top),y=g.getY(n.bottom),w=Math.min(b,y),S=Math.abs(b-y),k=n.type==="BULLISH",C=k?"rgba(0, 188, 212, 0.04)":"rgba(233, 30, 99, 0.04)",N=k?"rgba(0, 188, 212, 0.16)":"rgba(233, 30, 99, 0.16)",Y=k?"FVG BULLISH":"FVG BEARISH",A=k?"rgba(0, 188, 212, 0.65)":"rgba(233, 30, 99, 0.65)";return o("g",{children:[e("rect",{x:u,y:w,width:m-u,height:S,fill:C,stroke:N,strokeWidth:"0.8",strokeDasharray:"2,2"}),m-u>50&&S>6&&e("text",{x:u+6,y:w+9,fill:A,fontSize:"7.5px",fontWeight:"bold",fontFamily:"monospace",pointerEvents:"none",children:Y})]},`fvg-${l}`)}),t.structureShifts?.map((n,l)=>{let s=h.findIndex(S=>S.time===n.time);if(s===-1)return null;let i=Math.min(h.length-1,s+20),f=g.getX(s-F),d=g.getX(i-F),u=Math.max(a,f),m=Math.min(r,d);if(u>=m)return null;let b=g.getY(n.price),y=n.direction==="BULLISH",w=y?"var(--green)":"var(--red)";return o("g",{children:[e("line",{x1:u,y1:b,x2:m,y2:b,stroke:w,strokeWidth:"1.2",strokeDasharray:"3,3",opacity:"0.85"}),o("g",{transform:`translate(${u+6}, ${b-6})`,children:[e("rect",{x:"-3",y:"-2",width:"48",height:"12",rx:"3",fill:"rgba(19, 23, 34, 0.95)",stroke:w,strokeWidth:"0.8"}),o("text",{x:"21",y:"7",textAnchor:"middle",fill:w,fontSize:"7.5px",fontWeight:"bold",fontFamily:"monospace",children:[n.type," ",y?"\u2197":"\u2198"]})]})]},`shift-${l}`)}),t.sweeps?.map((n,l)=>{let s=h.findIndex(u=>u.time===n.time);if(s===-1)return null;let i=g.getX(s-F);if(i<a||i>r)return null;let f=g.getY(n.price),d=n.type==="SSL";return o("g",{children:[e("line",{x1:i-4,y1:f-4,x2:i+4,y2:f+4,stroke:"var(--yellow)",strokeWidth:"1.5"}),e("line",{x1:i+4,y1:f-4,x2:i-4,y2:f+4,stroke:"var(--yellow)",strokeWidth:"1.5"}),e("text",{x:i,y:d?f+14:f-10,textAnchor:"middle",fill:"var(--yellow)",fontSize:"7.5px",fontWeight:"bold",fontFamily:"monospace",pointerEvents:"none",children:d?"SSL SWEEP":"BSL SWEEP"})]},`sweep-${l}`)})]})})(),Q.map((t,a)=>{let r=g.getX(a),n=g.getY(t.high),l=g.getY(t.low),s=g.getY(t.open),i=g.getY(t.close),d=t.close>=t.open?"var(--green)":"var(--red)";return o("g",{children:[e("line",{x1:r,y1:n,x2:r,y2:l,stroke:d,strokeWidth:"1.5"}),e("rect",{x:r-g.bodyWidth/2,y:Math.min(s,i),width:g.bodyWidth,height:Math.max(1.5,Math.abs(s-i)),fill:d,stroke:d,strokeWidth:"0.5"})]},`candle-${a}`)}),ft&&(()=>{let t="";for(let a=0;a<Q.length;a++){let r=F+a,n=Pa[r];if(n){let l=g.getX(a),s=g.getY(n);t===""?t+=`M ${l} ${s}`:t+=` L ${l} ${s}`}}return t?e("path",{d:t,fill:"none",stroke:Et,strokeWidth:"2",opacity:"0.85"}):null})(),vt&&(()=>{let t="";for(let a=0;a<Q.length;a++){let r=F+a,n=Ra[r];if(n){let l=g.getX(a),s=g.getY(n);t===""?t+=`M ${l} ${s}`:t+=` L ${l} ${s}`}}return t?e("path",{d:t,fill:"none",stroke:Pt,strokeWidth:"2.2",opacity:"0.85"}):null})(),Ue&&(()=>{let{i1:t,price1:a,i2:r,price2:n}=Ue,l=(n-a)/(r-t),s=g.getX(t-F),i=g.getY(a),d=h.length-1+10,u=g.getX(d-F),m=g.getY(a+l*(d-t));return o("g",{children:[e("line",{x1:s,y1:i,x2:u,y2:m,stroke:"var(--gold)",strokeWidth:"2.5",strokeDasharray:"6,4",filter:"url(#glow)"}),e("circle",{cx:s,cy:i,r:"4",fill:"var(--gold)",stroke:"#000",strokeWidth:"1"}),e("circle",{cx:g.getX(r-F),cy:g.getY(n),r:"4",fill:"var(--gold)",stroke:"#000",strokeWidth:"1"}),o("text",{x:Math.max(s+10,g.width-g.paddingRight-180),y:m-10,fill:"var(--gold)",fontSize:"10px",fontWeight:"bold",fontFamily:"monospace",opacity:"0.9",children:["\u2198 \u0110\u01AF\u1EDCNG XU H\u01AF\u1EDANG GI\u1EA2M ",p==="1D"?"D1":p==="1W"?"W1":p==="1M"?"MN":`M${p}`," (SMC)"]})]})})(),v&&(()=>{let t=g.getY(v.entryMid),a=g.getY(v.sl),r=g.getY(v.tp1),n=g.getY(v.tp2),l=g.paddingLeft,s=g.width-g.paddingRight;return o("g",{children:[e("line",{x1:l,y1:a,x2:s,y2:a,stroke:"var(--red)",strokeWidth:"1.2",strokeDasharray:"4,4"}),e("rect",{x:s+4,y:a-8,width:"60",height:"16",rx:"3",fill:"rgba(255, 23, 68, 0.2)",stroke:"var(--red)",strokeWidth:"1"}),o("text",{x:s+8,y:a+4,fill:"var(--red)",fontSize:"9px",fontWeight:"bold",fontFamily:"monospace",children:["SL:$",v.sl.toFixed(1)]}),e("line",{x1:l,y1:t,x2:s,y2:t,stroke:"var(--gold)",strokeWidth:"1.5",strokeDasharray:"4,4"}),e("rect",{x:s+4,y:t-8,width:"60",height:"16",rx:"3",fill:"rgba(255, 171, 0, 0.2)",stroke:"var(--gold)",strokeWidth:"1"}),o("text",{x:s+8,y:t+4,fill:"var(--gold)",fontSize:"9px",fontWeight:"bold",fontFamily:"monospace",children:["ENT:$",v.entryMid.toFixed(1)]}),e("line",{x1:l,y1:r,x2:s,y2:r,stroke:"var(--green)",strokeWidth:"1.2",strokeDasharray:"4,4"}),e("rect",{x:s+4,y:r-8,width:"60",height:"16",rx:"3",fill:"rgba(0, 230, 118, 0.15)",stroke:"var(--green)",strokeWidth:"1"}),o("text",{x:s+8,y:r+4,fill:"var(--green)",fontSize:"9px",fontWeight:"bold",fontFamily:"monospace",children:["TP1:$",v.tp1.toFixed(1)]}),e("line",{x1:l,y1:n,x2:s,y2:n,stroke:"var(--green)",strokeWidth:"1.2",strokeDasharray:"4,4"}),e("rect",{x:s+4,y:n-8,width:"60",height:"16",rx:"3",fill:"rgba(0, 230, 118, 0.15)",stroke:"var(--green)",strokeWidth:"1"}),o("text",{x:s+8,y:n+4,fill:"var(--green)",fontSize:"9px",fontWeight:"bold",fontFamily:"monospace",children:["TP2:$",v.tp2.toFixed(1)]})]})})()]}):e("div",{className:"chart-empty",style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"var(--text3)"},children:"\u0110ang d\u1EF1ng bi\u1EC3u \u0111\u1ED3 k\u1EF9 thu\u1EADt..."}),o("div",{className:"chart-ema-legend",onMouseDown:t=>t.stopPropagation(),onMouseMove:t=>t.stopPropagation(),children:[o("div",{className:"ema-legend-row",children:[e("span",{className:"ema-legend-dot",style:{backgroundColor:Et,color:Et}}),o("span",{className:"ema-legend-name",style:{color:ft?"#fff":"var(--text3)"},children:["EMA ",Ct," ",e("span",{style:{opacity:.6,fontSize:"9.5px"},children:At})]}),o("div",{className:"ema-legend-actions",children:[e("button",{className:`ema-action-btn ${ft?"active":""}`,onClick:()=>pa(!ft),title:ft?"\u1EA8n \u0111\u01B0\u1EDDng EMA":"Hi\u1EC7n \u0111\u01B0\u1EDDng EMA",children:ft?o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e("circle",{cx:"12",cy:"12",r:"3"})]}):o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("path",{d:"M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"}),e("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}),e("button",{className:"ema-action-btn",onClick:()=>Rt("ema50"),title:"C\xE0i \u0111\u1EB7t th\xF4ng s\u1ED1 (Length, Source, Color)",children:o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("circle",{cx:"12",cy:"12",r:"3"}),e("path",{d:"M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"})]})}),e("button",{className:"ema-action-btn open-source-btn",onClick:()=>{Xt("ema50"),_t("pine")},title:"Xem m\xE3 ngu\u1ED3n m\u1EDF ch\u1EC9 b\xE1o",children:o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("polyline",{points:"16 18 22 12 16 6"}),e("polyline",{points:"8 6 2 12 8 18"})]})})]})]}),o("div",{className:"ema-legend-row",children:[e("span",{className:"ema-legend-dot",style:{backgroundColor:Pt,color:Pt}}),o("span",{className:"ema-legend-name",style:{color:vt?"#fff":"var(--text3)"},children:["EMA ",It," ",e("span",{style:{opacity:.6,fontSize:"9.5px"},children:zt})]}),o("div",{className:"ema-legend-actions",children:[e("button",{className:`ema-action-btn ${vt?"active":""}`,onClick:()=>ca(!vt),title:vt?"\u1EA8n \u0111\u01B0\u1EDDng EMA":"Hi\u1EC7n \u0111\u01B0\u1EDDng EMA",children:vt?o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e("circle",{cx:"12",cy:"12",r:"3"})]}):o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("path",{d:"M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"}),e("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}),e("button",{className:"ema-action-btn",onClick:()=>Rt("ema200"),title:"C\xE0i \u0111\u1EB7t th\xF4ng s\u1ED1 (Length, Source, Color)",children:o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("circle",{cx:"12",cy:"12",r:"3"}),e("path",{d:"M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"})]})}),e("button",{className:"ema-action-btn open-source-btn",onClick:()=>{Xt("ema200"),_t("pine")},title:"Xem m\xE3 ngu\u1ED3n m\u1EDF ch\u1EC9 b\xE1o",children:o("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e("polyline",{points:"16 18 22 12 16 6"}),e("polyline",{points:"8 6 2 12 8 18"})]})})]})]})]}),lt&&e("div",{className:"chart-overlay-modal",style:{pointerEvents:"auto"},onMouseDown:t=>t.stopPropagation(),onMouseMove:t=>t.stopPropagation(),children:o("div",{className:"chart-modal-card",children:[o("div",{className:"chart-modal-header",children:[o("span",{className:"chart-modal-title",children:["\u2699\uFE0F C\xE0i \u0110\u1EB7t Ch\u1EC9 B\xE1o: EMA ",lt==="ema50"?"50":"200"]}),e("button",{className:"chart-modal-close",onClick:()=>Rt(null),children:"\xD7"})]}),o("div",{className:"chart-modal-body",children:[o("div",{className:"settings-group",children:[e("label",{className:"settings-label",children:"Chu k\u1EF3 (Length)"}),o("div",{className:"settings-input-row",children:[e("input",{type:"number",min:"2",max:"500",className:"settings-number-input",value:ue,onChange:t=>xe(Math.max(2,parseInt(t.target.value)||2))}),e("span",{style:{fontSize:"11px",color:"var(--text3)"},children:"(2 - 500 n\u1EBFn)"})]})]}),o("div",{className:"settings-group",style:{marginTop:"12px"},children:[e("label",{className:"settings-label",children:"Ngu\u1ED3n gi\xE1 tr\u1ECB (Source)"}),e("div",{className:"settings-input-row",children:o("select",{className:"settings-select",value:he,onChange:t=>me(t.target.value),children:[e("option",{value:"close",children:"\u0110\xF3ng c\u1EEDa (Close)"}),e("option",{value:"open",children:"M\u1EDF c\u1EEDa (Open)"}),e("option",{value:"high",children:"Cao nh\u1EA5t (High)"}),e("option",{value:"low",children:"Th\u1EA5p nh\u1EA5t (Low)"})]})})]}),o("div",{className:"settings-group",style:{marginTop:"12px"},children:[e("label",{className:"settings-label",children:"M\xE0u \u0111\u01B0\u1EDDng ch\u1EC9 b\xE1o (Color)"}),e("div",{className:"settings-colors-grid",children:["#FFD700","#00e5ff","#FF1744","#d500f9","#00e676","#ff9100","#ffffff","#787b86"].map(t=>e("div",{className:`settings-color-dot ${Kt===t?"active":""}`,style:{backgroundColor:t},onClick:()=>qt(t)},t))}),o("div",{style:{marginTop:"10px",width:"100%"},children:[e("span",{style:{fontSize:"11px",color:"var(--text3)",display:"block",marginBottom:"4px"},children:"M\xE3 m\xE0u HEX t\xF9y ch\u1EC9nh:"}),e("input",{type:"text",className:"settings-number-input",style:{width:"120px"},value:Kt,onChange:t=>qt(t.target.value)})]})]})]}),o("div",{className:"chart-modal-footer",children:[e("button",{className:"modal-btn cancel",onClick:()=>Rt(null),children:"H\u1EE7y b\u1ECF"}),e("button",{className:"modal-btn apply",onClick:fa,children:"\xC1p d\u1EE5ng"})]})]})}),jt&&(()=>{let t=jt==="ema50"?Ct:It,a=jt==="ema50"?At:zt,n=`//@version=5
