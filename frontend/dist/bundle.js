...
`;var Dt=document.createElement("style");Dt.textContent=Ot;document.head.appendChild(Dt);var Ta=Sa(document.getElementById("root"));Ta.render(Na(pt));
