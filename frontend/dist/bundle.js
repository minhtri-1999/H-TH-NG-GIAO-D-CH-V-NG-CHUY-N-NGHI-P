...
`;var Ot=document.createElement("style");Ot.textContent=Dt;document.head.appendChild(Ot);var Ta=Sa(document.getElementById("root"));Ta.render(Na(pt));
